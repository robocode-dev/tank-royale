...
public class ScoreTrackerTest {
	...
	public void finalizeRound() {
		...
		sk.registerRamHit(1, 2, false);
		sk.registerBulletHit(2, 3, 10, false);
		sk.registerRamHit(2, 3, false);

		sk.registerBulletHit(3, 1, 10, false);
		sk.registerRamHit(3, 1, false);

		Assert.assertEquals(10 * RuleConstants.SCORE_PER_BULLET_DAMAGE + RuleConstants.RAM_DAMAGE * RuleConstants.SCORE_PER_RAM_DAMAGE, sk.getScore(1).getTotalScore(), 0.0001);
		Assert.assertEquals(10 * RuleConstants.SCORE_PER_BULLET_DAMAGE + RuleConstants.RAM_DAMAGE * RuleConstants.SCORE_PER_RAM_DAMAGE, sk.getScore(2).getTotalScore(), 0.0001);
		Assert.assertEquals(10 * RuleConstants.SCORE_PER_BULLET_DAMAGE + RuleConstants.RAM_DAMAGE * RuleConstants.SCORE_PER_RAM_DAMAGE, sk.getScore(3).getTotalScore(), 0.0001);
	}
	...
	public void registerRamHit() {
		...
		assertEquals(0, s.getBulletDamage(), 0.00001);
		assertEquals(0, s.getBulletKillBonus(), 0.00001);
		Assert.assertEquals(RuleConstants.RAM_DAMAGE * RuleConstants.SCORE_PER_RAM_DAMAGE, s.getRamDamage(), 0.00001);
		assertEquals(0, s.getRamKillBonus(), 0.00001);
		assertEquals(0, s.getSurvival(), 0.00001);
		assertEquals(0, s.getLastSurvivorBonus(), 0.00001);
		Assert.assertEquals(RuleConstants.RAM_DAMAGE * RuleConstants.SCORE_PER_RAM_DAMAGE, s.getTotalScore(), 0.00001);
		...
		assertEquals(0, s.getBulletKillBonus(), 0.00001);
		Assert.assertEquals(RuleConstants.RAM_DAMAGE * RuleConstants.SCORE_PER_RAM_DAMAGE, s.getRamDamage(), 0.00001);
		Assert.assertEquals(RuleConstants.RAM_DAMAGE * RuleConstants.BONUS_PER_RAM_KILL, s.getRamKillBonus(), 0.00001);
		Assert.assertEquals(1 * RuleConstants.SCORE_PER_SURVIVAL, s.getSurvival(), 0.00001);
		assertEquals(0, s.getLastSurvivorBonus(), 0.00001);
		Assert.assertEquals(RuleConstants.RAM_DAMAGE * (RuleConstants.SCORE_PER_RAM_DAMAGE + RuleConstants.BONUS_PER_RAM_KILL) + 1 * RuleConstants.SCORE_PER_SURVIVAL, s.getTotalScore(),
				0.00001);
		...
		Assert.assertEquals(2 * RuleConstants.SCORE_PER_SURVIVAL, s.getSurvival(), 0.00001);
		assertEquals(0, s.getLastSurvivorBonus(), 0.00001);
		Assert.assertEquals(RuleConstants.RAM_DAMAGE * (RuleConstants.SCORE_PER_RAM_DAMAGE + RuleConstants.BONUS_PER_RAM_KILL) + 2 * RuleConstants.SCORE_PER_SURVIVAL, s.getTotalScore(),
				0.00001);
		...
		Assert.assertEquals(
				RuleConstants.RAM_DAMAGE * (RuleConstants.SCORE_PER_RAM_DAMAGE + RuleConstants.BONUS_PER_RAM_KILL) + 3 * (RuleConstants.SCORE_PER_SURVIVAL + RuleConstants.BONUS_PER_LAST_SURVIVOR),
