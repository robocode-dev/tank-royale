...
import static dev.robocode.tankroyale.server.model.RuleConstants.ACCELERATION;
import static dev.robocode.tankroyale.server.model.RuleConstants.DECELERATION;
import static dev.robocode.tankroyale.server.model.RuleConstants.MAX_FORWARD_SPEED;
import static dev.robocode.tankroyale.server.model.RuleConstants.MAX_GUN_TURN_RATE;
import static dev.robocode.tankroyale.server.model.RuleConstants.MAX_RADAR_TURN_RATE;
import static dev.robocode.tankroyale.server.model.RuleConstants.MAX_BACKWARD_SPEED;
import static dev.robocode.tankroyale.server.model.RuleConstants.MAX_TURN_RATE;
