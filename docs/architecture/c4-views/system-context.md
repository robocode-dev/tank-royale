...
- **[ADR-0009: WebSocket Protocol](/docs/decisions/ADR-0009-websocket-communication-protocol.md)** — Why WebSocket was chosen
- **[ADR-0003: Cross-Platform Bot APIs](/docs/decisions/ADR-0003-cross-platform-bot-api-strategy.md)** — Multi-language support strategy
- **[ADR-0011: Real-Time Game Loop](/docs/decisions/ADR-0011-realtime-game-loop-architecture.md)** — Real-time 30 TPS tick system
