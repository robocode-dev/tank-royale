...
The external `robocode-dev/rumble-data` repository holds the implementation and focused suite for RDA-001 through RDA-004 at merged commit `26b14f512ffb12cf775f038ec53567cdefe34d9e`. Its eight-test standard-library suite covers acceptance, rejection, TwinDuel validation, compaction, moderation filtering, and dashboard references. During P-001/M-002, those tests will receive purpose tags and this criteria artifact can become active without changing the criterion meanings.
