--- id: CAP-002-design type: design status: draft links: [CAP-002] title: Design notes for CAP-002 (booter-fallback-discovery) provenance: inferred reversal-cost: low ---
