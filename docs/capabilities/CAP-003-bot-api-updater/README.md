...
Extracted from `openspec/specs/bot-api-updater/spec.md` at CH-001; the source spec's requirement prose is preserved as comments in [criteria.md](criteria.md).
