...
| [ADR-0037](/docs/decisions/ADR-0037-functional-core-bot-api-testability.md) | Functional core extraction for Bot API |
| [ADR-0038](/docs/decisions/ADR-0038-shared-cross-platform-test-definitions.md) | Shared test definitions and parity policy |
| [ADR-0039](/docs/decisions/ADR-0039-server-testability.md) | Server physics test framework |
