import {
    ...
    d as Tv,
    aK as Cv
} from "../app.CIDxU0Cd.js";
import {c as Dv} from "./createText-ca0c5216.6iCw8AHa.js";
import "./framework.CgegSSb6.js";
import "./theme.DND3-f8A.js";
...
function mr(t, e, r) {
    return e && Lv(t.prototype, e), Object.defineProperty(t, "prototype", {writable: !1}), t
}
    ...
    if (r != null) {
        ...
        try {
            if (i = (r = r.call(t)).next, e === 0) {
                ...
                u = !1
            } else for (; !(u = (a = i.call(r)).done) && (o.push(a.value), o.length !== e); u = !0) ;
        } catch (f) {
            l = !0, n = f
        } finally {
            try {
...
var kv = nt(""), df = nt({}), Nv = nt(function () {
        ...
        if (Bv !== "undefined") return e != null && e instanceof HTMLElement
    }, Lt = function (e) {
        return Fa(e) || gf(e)
    }, Fa = function (e) {
    ...
    $v = "rgb[a]?\\((" + at + "[%]?)\\s*,\\s*(" + at + "[%]?)\\s*,\\s*(" + at + "[%]?)(?:\\s*,\\s*(" + at + "))?\\)",
    Yv = "rgb[a]?\\((?:" + at + "[%]?)\\s*,\\s*(?:" + at + "[%]?)\\s*,\\s*(?:" + at + "[%]?)(?:\\s*,\\s*(?:" + at + "))?\\)",
    Hv = "hsl[a]?\\((" + at + ")\\s*,\\s*(" + at + "[%])\\s*,\\s*(" + at + "[%])(?:\\s*,\\s*(" + at + "))?\\)",
    Xv = "hsl[a]?\\((?:" + at + ")\\s*,\\s*(?:" + at + "[%])\\s*,\\s*(?:" + at + "[%])(?:\\s*,\\s*(?:" + at + "))?\\)",
    Wv = "\\#[0-9a-fA-F]{3}", Kv = "\\#[0-9a-fA-F]{6}", mf = function (e, r) {
        ...
        if (c) {
            ...
            if (n === 0) o = u = l = Math.round(i * 255); else {
                var v = i < .5 ? i * (1 + n) : i + n - i * n, h = 2 * i - v;
...
function _n() {
    if (Go) return ii;
    Go = 1;
    var t = rh(), e = typeof self == "object" && self && self.Object === Object && self,
...
function lh() {
    if (Ko) return gi;
    Ko = 1;
    var t = ih(), e = Ga(), r = za(), a = NaN, n = /^[-+]0x[0-9a-f]+$/i, i = /^0b[01]+$/i, s = /^0o[0-7]+$/i,
        o = parseInt;
...
var ch = fh(), Va = _a(ch), yi = tt ? tt.performance : null, Tf = yi && yi.now ? function () {
    return yi.now()
} : function () {
    return Date.now()
}, vh = function () {
    ...
    return vh(e)
}, Qt = Tf, Ar = 9261, Cf = 65599, Xr = 5381, Df = function (e) {
    for (var r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Ar, a = r, n; n = e.next(), !n.done;) a = a * Cf + n.value | 0;
    return a
}, Sa = function (e) {
    ...
    var a = {value: 0, done: !1}, n = 0, i = e.length, s = {
        next: function () {
...
function gh(t, e, r, a, n) {
    var i = n * Math.PI / 180, s = Math.cos(i) * (t - r) - Math.sin(i) * (e - a) + r,
        o = Math.sin(i) * (t - r) + Math.cos(i) * (e - a) + a;
    return {x: s, y: o}
}
...
function yh(t, e, r) {
    if (r === 0) return t;
    var a = (e.x1 + e.x2) / 2, n = (e.y1 + e.y2) / 2, i = e.w / e.h, s = 1 / i, o = gh(t.x, t.y, a, n, r),
        u = ph(o.x, o.y, a, n, i, s);
    return {x: u.x, y: u.y}
}

var Jo = !0, mh = console.warn != null, bh = console.trace != null, uo = Number.MAX_SAFE_INTEGER || 9007199254740991,
    Af = function () {
        return !0
    }, Sn = function () {
        return !1
        ...
        if (e !== void 0) Jo = !!e; else return Jo
    }, Ge = function (e) {
    ...
    }(), Zt = typeof Map < "u" ? Map : Ch, Dh = "undefined", Sh = function () {
        function t(e) {
            if (yr(this, t), this._obj = Object.create(null), this.size = 0, e != null) {
                var r;
        ...
        return e = {bfs: e.bfs || !e.dfs, dfs: e.dfs || !e.bfs}, function (a, n, i) {
            ...
            for (var S = function () {
                ...
                var M = v[I], N = c[I], O = N != null ? N.source() : null, k = N != null ? N.target() : null,
                    B = N == null ? void 0 : R.same(O) ? k[0] : O[0], _;
                if (_ = n(R, N, B, d++, M), _ === !0) return p = R, 1;
                if (_ === !1) return 1;
                for (var F = R.connectedEdges().filter(function (W) {
                    ...
                    $.length !== 0 && !h[H] && ($ = $[0], l.push($), e.bfs && (h[H] = !0, f.push($)), c[H] = Y, v[H] = v[I] + 1)
                }
    ...
    }, La = {breadthFirstSearch: eu({bfs: !0}), depthFirstSearch: eu({dfs: !0})};
...
var Ih = Rh(), Ua = _a(Ih), Ph = ht({
    ...
    dijkstra: function (e) {
        ...
        var a = Ph(e), n = a.root, i = a.weight, s = a.directed, o = this, u = i, l = ge(n) ? this.filter(n)[0] : n[0],
            f = {}, c = {}, v = {}, h = this.byGroup(), d = h.nodes, p = h.edges;
        ...
        for (var T = function (N, O) {
            ...
            if (v[x] = w, w !== 1 / 0) for (var C = S.neighborhood().intersect(d), D = 0; D < C.length; D++) {
                ...
                I < g(A) && (y(A, I), c[L] = {node: S, edge: R.edge})
            }
        }
        return {
    ...
    aStar: function (e) {
        ...
        for (var w = 0; d.size() > 0;) {
            if (T(), w++, E === f) {
                ...
                return {found: !0, distance: c[E], path: this.spawn(x), steps: w}
            }
            h[E] = !0;
    ...
    floydWarshall: function (e) {
        ...
        for (var R = 0; R < f; R++) for (var I = 0; I < f; I++) for (var M = I * f + R, N = 0; N < f; N++) {
            var O = I * f + N, k = R * f + N;
        ...
        var B = function (Y) {
            ...
            distance: function (Y, $) {
                ...
                if (H === W) return ee.collection();
                if (b[H * f + W] == null) return r.collection();
                var ae = r.collection(), J = H, z;
                for (ae.merge(ee); H !== W;) J = H, H = b[H * f + W], z = m[J * f + H], ae.merge(z), ae.merge(h(H));
                return ae
            }
        };
        return F
    ...
    bellmanFord: function (e) {
        var r = this, a = _h(e), n = a.weight, i = a.directed, s = a.root, o = n, u = this, l = this.cy(),
            f = this.byGroup(), c = f.edges, v = f.nodes, h = v.length, d = new Zt, p = !1, g = [];
        ...
        if (C) for (var B = [], _ = 0; _ < y; _++) {
            ...
            if (H + $ < W || !i && W + $ < H) if (p || (Ge("Graph contains a negative weight cycle for Bellman-Ford"), p = !0), e.findNegativeWeightCycles !== !1) {
                var ee = [];
    ...
    var i = {x: r.x - e.x, y: r.y - e.y}, s = Pr(e, r), o = {x: i.x / s, y: i.y / s};
    ...
    if (r.length === 1) a = n = i = s = r[0]; else if (r.length === 2) a = i = r[0], s = n = r[1]; else if (r.length === 4) {
        var o = Je(r, 4);
...
function td(t, e) {
    ...
    var r = function (x, C) {
        ...
        if (Math.abs(I) < 1e-9) return r(x, n(L, .5));
        var M = i(a(D, x), R) / I;
        return r(x, n(L, M))
    }, l = t.map(function (w) {
        return {x: w.x, y: w.y}
...
var kf = function (e, r, a, n, i, s, o) {
    var u = arguments.length > 7 && arguments[7] !== void 0 ? arguments[7] : "auto", l = u === "auto" ? vr(i, s) : u,
        f = i / 2, c = s / 2;
    l = Math.min(l, f, c);
    var v = l !== f, h = l !== c, d;
    if (v) {
        var p = a - f + l - o, g = n - c - o, y = a + f - l + o, b = g;
        if (d = or(e, r, a, n, p, g, y, b, !1), d.length > 0) return d
    }
    if (h) {
        var m = a + f + o, E = n - c + l - o, T = m, S = n + c - l + o;
        if (d = or(e, r, a, n, m, E, T, S, !1), d.length > 0) return d
    }
    if (v) {
        var w = a - f + l - o, x = n + c + o, C = a + f - l + o, D = x;
        if (d = or(e, r, a, n, w, x, C, D, !1), d.length > 0) return d
    }
    if (h) {
        var A = a - f - o, L = n - c + l - o, R = A, I = n + c - l + o;
        if (d = or(e, r, a, n, A, L, R, I, !1), d.length > 0) return d
    }
    var M;
    {
        var N = a - f + l, O = n - c + l;
    ...
    {
        var G = a - f + l, Y = n + c - l;
        if (M = wa(e, r, a, n, G, Y, l + o), M.length > 0 && M[0] <= G && M[1] >= Y) return [M[0], M[1]]
    }
    return []
    ...
    var l = 1 * a * a - 4 * a * i + 2 * a * o + 4 * i * i - 4 * i * o + o * o + n * n - 4 * n * s + 2 * n * u + 4 * s * s - 4 * s * u + u * u,
        f = 1 * 9 * a * i - 3 * a * a - 3 * a * o - 6 * i * i + 3 * i * o + 9 * n * s - 3 * n * n - 3 * n * u - 6 * s * s + 3 * s * u,
        c = 1 * 3 * a * a - 6 * a * i + a * o - a * e + 2 * i * i + 2 * i * e - o * e + 3 * n * n - 6 * n * s + n * u - n * r + 2 * s * s + 2 * s * r - u * r,
        v = 1 * a * i - a * a + a * e - i * e + n * s - n * n + n * r - s * r, h = [];
    sd(l, f, c, v, h);
    ...
    var o = [e - a, r - n], u = [i - a, s - n], l = u[0] * u[0] + u[1] * u[1], f = o[0] * o[0] + o[1] * o[1],
        c = o[0] * u[0] + o[1] * u[1], v = c * c / l;
    return c < 0 ? f : v > l ? (e - i) * (e - i) + (r - s) * (r - s) : f - v
}, St = function (e, r, a) {
    for (var n, i, s, o, u, l = 0, f = 0; f < a.length / 2; f++) if (n = a[f * 2], i = a[f * 2 + 1], f + 1 < a.length / 2 ? (s = a[(f + 1) * 2], o = a[(f + 1) * 2 + 1]) : (s = a[(f + 1 - a.length / 2) * 2], o = a[(f + 1 - a.length / 2) * 2 + 1]), !(n == e && s == e)) if (n >= e && e >= s || n <= e && e <= s) u = (e - n) / (s - n) * (o - i) + i, u > r && l++; else continue;
    return l % 2 !== 0
    ...
    var u = [a - e, n - r], l = [e - i, r - s], f = u[0] * u[0] + u[1] * u[1], c = 2 * (l[0] * u[0] + l[1] * u[1]),
        v = l[0] * l[0] + l[1] * l[1] - o * o, h = c * c - 4 * f * v;
    if (h < 0) return [];
    var d = (-c + Math.sqrt(h)) / (2 * f), p = (-c - Math.sqrt(h)) / (2 * f), g = Math.min(d, p), y = Math.max(d, p),
        b = [];
    ...
    var f = e - i, c = a - e, v = o - i, h = r - s, d = n - r, p = u - s, g = v * h - p * f, y = c * h - d * f,
        b = p * c - v * d;
    if (b !== 0) {
        var m = g / b, E = y / b, T = .001, S = 0 - T, w = 1 + T;
        return S <= m && m <= w && S <= E && E <= w ? [e + m * c, r + m * d] : l ? [e + m * c, r + m * d] : []
    } else return g === 0 || y === 0 ? Ei(e, a, o) === o ? [o, u] : Ei(e, a, i) === i ? [i, s] : Ei(i, o, a) === a ? [a, n] : [] : []
    ...
    for (var h = 0; h < v.length / 4; h++) c = or(e, r, n, i, v[h * 4], v[h * 4 + 1], v[h * 4 + 2], v[h * 4 + 3], !1), c.length !== 0 && f.push(c[0], c[1]);
    if (f.length > 2) {
    ...
    return {heightOffset: Math.min(15, .05 * r), widthOffset: Math.min(100, .25 * e), ctrlPtOffsetPct: .05}
};

function xi(t, e) {
    function r(c) {
        for (var v = [], h = 0; h < c.length; h++) {
            var d = c[h], p = c[(h + 1) % c.length], g = {x: p.x - d.x, y: p.y - d.y}, y = {x: -g.y, y: g.x},
...
var dd = ht({
    ...
    pageRank: function (e) {
        ...
        for (var L = 1 / c + g, R = 0; R < c; R++) if (p[R] === 0) for (var I = 0; I < c; I++) {
            var M = I * c + R;
            d[M] = L
        ...
        for (var G = 0; G < i; G++) {
            for (var Y = 0; Y < c; Y++) B[Y] = 0;
            for (var $ = 0; $ < c; $++) for (var H = 0; H < c; H++) {
                var W = $ * c + H;
                B[$] += d[W] * k[H]
            }
            Kh(B), _ = k, k = B, B = _;
...
var pd = ht({weight: null, directed: !1}), _s = {
...
var yd = ht({
    ...
    for (var n = e.slice(0), i = 1; i < a; i++) e = Ed(e, n, r);
    return e
}, Td = function (e, r, a) {
    ...
    for (var r = 0; r < e.length; r++) for (var a = 0; a < e.length; a++) r != a && Sd(e[r], e[a]) && e.splice(a, 1);
    return e
}, ou = function (e) {
    for (var r = this.nodes(), a = this.edges(), n = this.cy(), i = md(e), s = {}, o = 0; o < r.length; o++) s[r[o].id()] = o;
    ...
    for (var b = !0, m = 0; b && m < i.maxIterations;) b = !1, c = xd(f, u, i.expandFactor), f = Td(c, u, i.inflateFactor), Cd(f, c, l, 4) || (b = !0), m++;
    var E = Dd(f, u, r, n);
    return E = Ad(E), E
}, Ld = {markovClustering: ou, mcl: ou}, Rd = function (e) {
    return e
}, _f = function (e, r) {
    return Math.abs(r - e)
}, uu = function (e, r, a) {
    ...
    for (var s = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : Rd, o = n, u, l, f = 0; f < e; f++) u = r(f), l = a(f), o = i(o, u, l);
    return s(o)
}, ra = {
...
var Md = ht({
    ...
    if (e.length < 50) for (var n = 0; n < r; n++) {
        for (var i = e[Math.floor(Math.random() * e.length)]; Nd(i, a, n);) i = e[Math.floor(Math.random() * e.length)];
        a[n] = i
    } else for (var s = 0; s < r; s++) a[s] = e[Math.floor(Math.random() * e.length)];
    return a
}, cu = function (e, r, a) {
    for (var n = 0, i = 0; i < r.length; i++) n += Rn("manhattan", r[i], e, a, "kMedoids");
    return n
}, Bd = function (e) {
    ...
    for (var l = !0, f = 0; l && f < i.maxIterations;) {
        for (var c = 0; c < a.length; c++) n = a[c], o[n.id()] = Gf(n, u, i.distance, i.attributes, "kMeans");
        l = !1;
        for (var v = 0; v < i.k; v++) {
            var h = zf(v, a, o);
            if (h.length !== 0) {
    ...
    for (var c = !0, v = 0; c && v < i.maxIterations;) {
        for (var h = 0; h < a.length; h++) n = a[h], u[n.id()] = Gf(n, o, i.distance, i.attributes, "kMedoids");
        c = !1;
        for (var d = 0; d < o.length; d++) {
            var p = zf(d, a, u);
            if (p.length !== 0) {
                f[d] = cu(o[d], p, i.attributes);
                for (var g = 0; g < p.length; g++) l = cu(p[g], p, i.attributes), l < f[d] && (f[d] = l, o[d] = p[g], c = !0);
                s[d] = r.collection(p)
            }
        }
        v++
    ...
    for (var o, u, l, f = 2 / (i.m - 1), c = 0; c < a.length; c++) for (var v = 0; v < n.length; v++) {
        o = 0;
        for (var h = 0; h < a.length; h++) u = Rn(i.distance, n[v], a[c], i.attributes, "cmeans"), l = Rn(i.distance, n[v], a[h], i.attributes, "cmeans"), o += Math.pow(u / l, f);
        e[v][c] = 1 / o
    }
}, zd = function (e, r, a, n) {
    ...
    for (var b = !0, m = 0; b && m < n.maxIterations;) b = !1, _d(s, a, o, l, n), Gd(o, u, s, a, n), kd(o, u, n.sensitivityThreshold) || (b = !0), m++;
    return i = zd(a, o, n, r), {clusters: i, degreeOfMembership: o}
}, Vd = {kMeans: Bd, kMedoids: Fd, fuzzyCMeans: vu, fcm: vu}, Ud = ht({
    distance: "euclidean",
    linkage: "min",
    mode: "threshold",
    threshold: 1 / 0,
    ...
    dendrogramDepth: 0,
    attributes: []
}), qd = {single: "min", complete: "max"}, $d = function (e) {
    ...
    var d = r[s], p = r[n[s]], g;
    i.mode === "dendrogram" ? g = {left: d, right: p, key: d.key} : g = {
    ...
    if (!e) return "";
    if (e.left && e.right) {
        var a = Gs(e.left, r), n = Gs(e.right, r), i = r.add({group: "nodes", data: {id: a + "," + n}});
        return r.add({group: "edges", data: {source: a, target: i.id()}}), r.add({
            group: "edges",
    ...
    for (var g = hu(o, f, u, l, n); g;) g = hu(o, f, u, l, n);
    var y;
...
}, Yd = {hierarchicalClustering: du, hca: du}, Hd = ht({
    distance: "euclidean",
    preference: "median",
    damping: .8,
    maxIterations: 1e3,
    ...
    .5 <= r && r < 1 || Ye("Damping must range on [0.5, 1).  Got: ".concat(r));
    ...
    for (var r = this.cy(), a = this.nodes(), n = Xd(e), i = {}, s = 0; s < a.length; s++) i[a[s].id()] = s;
    var o, u, l, f, c, v;
    o = a.length, u = o * o, l = new Array(u);
    for (var h = 0; h < u; h++) l[h] = -1 / 0;
    for (var d = 0; d < o; d++) for (var p = 0; p < o; p++) d !== p && (l[d * o + p] = Wd(n.distance, a[d], a[p], n.attributes));
    f = Kd(l, n.preference);
    ...
    for (C = 0; C < n.maxIterations; C++) {
        for (var D = 0; D < o; D++) {
            for (var A = -1 / 0, L = -1 / 0, R = -1, I = 0, M = 0; M < o; M++) m[M] = c[D * o + M], I = v[D * o + M] + l[D * o + M], I >= A ? (L = A, A = I, R = M) : I > L && (L = I);
        ...
        if (F > 0 && (C >= n.minIterations - 1 || C == n.maxIterations - 1)) {
            for (var $ = 0, H = 0; H < o; H++) {
                T[H] = 0;
                for (var W = 0; W < n.minIterations; W++) T[H] += w[W * o + H];
                (T[H] === 0 || T[H] === n.minIterations) && $++
            }
            if ($ === o) break
        }
    }
    for (var ee = Zd(o, c, v), ae = Qd(o, l, ee), J = {}, z = 0; z < ee.length; z++) J[ee[z]] = [];
    for (var V = 0; V < a.length; V++) {
    ...
    return re
}, Jd = {affinityPropagation: pu, ap: pu}, jd = ht({root: void 0, directed: !1}), eg = {
    ...
    var e = this, r = {}, a = 0, n = 0, i = [], s = [], o = {}, u = function (v, h) {
        ...
        v === d && (n += 1), r[h] = {id: a, low: a++, cutVertex: !1};
        var p = e.getElementById(h).connectedEdges().intersection(e);
        if (p.size() === 0) i.push(e.spawn(e.getElementById(h))); else {
            var g, y, b, m;
...
}, tg = {hopcroftTarjanBiconnected: en, htbc: en, htb: en, hopcroftTarjanBiconnectedComponents: en}, tn = function () {
    var e = this, r = {}, a = 0, n = [], i = [], s = e.spawn(e), o = function (l) {
        i.push(l), r[l] = {index: a, low: a++, explored: !1};
        ...
        if (f.forEach(function (p) {
            ...
            for (var c = e.spawn(); ;) {
                var v = i.pop();
                if (c.merge(e.getElementById(v)), r[v].low = r[l].index, r[v].explored = !0, v === l) break
            }
...
}, rg = {tarjanStronglyConnected: tn, tsc: tn, tscc: tn, tarjanStronglyConnectedComponents: tn}, Vf = {};
[La, Mh, Oh, Nh, Fh, Gh, Uh, gd, Jr, jr, _s, Ld, Vd, Yd, Jd, eg, tg, rg].forEach(function (t) {
    be(Vf, t)
});/*!
...
*/
var Uf = 0, qf = 1, $f = 2, _t = function (e) {
    if (!(this instanceof _t)) return new _t(e);
    this.id = "Thenable/1.0.7", this.state = Uf, this.fulfillValue = void 0, this.rejectReason = void 0, this.onFulfilled = [], this.onRejected = [], this.proxy = {then: this.then.bind(this)}, typeof e == "function" && e.call(this, this.fulfill.bind(this), this.reject.bind(this))
};
_t.prototype = {
    fulfill: function (e) {
        return yu(this, qf, "fulfillValue", e)
    }, reject: function (e) {
        return yu(this, $f, "rejectReason", e)
    }, then: function (e, r) {
        var a = this, n = new _t;
        return a.onFulfilled.push(bu(e, n, "fulfill")), a.onRejected.push(bu(r, n, "reject")), Yf(a), n.proxy
    }
};
var yu = function (e, r, a, n) {
    return e.state === Uf && (e.state = r, e[a] = n, Yf(e)), e
}, Yf = function (e) {
    e.state === qf ? mu(e, "onFulfilled", e.fulfillValue) : e.state === $f && mu(e, "onRejected", e.rejectReason)
}, mu = function (e, r, a) {
    if (e[r].length !== 0) {
        var n = e[r];
        e[r] = [];
    ...
    return function (n) {
        if (typeof e != "function") r[a].call(r, n); else {
            var i;
            try {
                i = e(n)
            } catch (s) {
    ...
    if (typeof a == "function") {
        ...
        try {
            a.call(r, function (i) {
                n || (n = !0, i === r ? e.reject(new TypeError("circular thenable chain")) : Hf(e, i))
            }, function (i) {
                n || (n = !0, e.reject(i))
            })
        } catch (i) {
    ...
    animated: function () {
        ...
        return function (r, a) {
            ...
            for (var u = 0; u < s.length; u++) {
                var l = s[u], f = l.animated() && (r.queue === void 0 || r.queue),
                    c = l.animation(r, f ? {queue: !0} : void 0);
                c.play()
            }
            return this
        }
...
function ig() {
    if (xu) return Si;
    xu = 1;
    var t = xf(), e = Ga(), r = "[object AsyncFunction]", a = "[object Function]", n = "[object GeneratorFunction]",
        i = "[object Proxy]";
...
function lg() {
    if (Su) return Ii;
    Su = 1;
    var t = ig(), e = og(), r = Ga(), a = ug(), n = /[\\^$.*+?()[\]{}|]/g, i = /^\[object .+?Constructor\]$/,
        s = Function.prototype, o = Object.prototype, u = s.toString, l = o.hasOwnProperty,
        f = RegExp("^" + u.call(l).replace(n, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
...
function xg() {
    ...
    return i.prototype.clear = t, i.prototype.delete = e, i.prototype.get = r, i.prototype.has = a, i.prototype.set = n, Xi = i, Xi
}
...
function Gg() {
    ...
    function e(r, a, n) {
        a == "__proto__" && t ? t(r, a, {configurable: !0, enumerable: !0, value: n, writable: !0}) : r[a] = n
    }
...
function zg() {
    if (cl) return gs;
    cl = 1;
    var t = Gg(), e = Xf(), r = Object.prototype, a = r.hasOwnProperty;
...
function Xg() {
    if (pl) return ws;
    pl = 1;
    var t = Kf(), e = Hg(), r = Un(), a = za(), n = Wf(), i = mo(), s = Zf();
...
var Jg = {
    ...
    classes: function (e) {
        ...
        Ve(e) || (e = e.match(/\S+/g) || []);
        for (var a = this, n = r === void 0, i = [], s = 0, o = a.length; s < o; s++) for (var u = a[s], l = u._private.classes, f = !1, c = 0; c < e.length; c++) {
        ...
        var a = this;
        if (r == null) r = 250; else if (r === 0) return a;
...
var ze = function () {
    ...
    for (var t = {}, e, r = 0; r < Us.length; r++) e = Us[r], t[e.selector] = e.matches;
    return t
}(), ep = function (e, r) {
    return jg[e](r)
    ...
    name: "group", query: !0, regex: "(" + Me.group + ")", populate: function (e, r, a) {
        var n = Je(a, 1), i = n[0];
        r.checks.push({type: se.GROUP, value: i === "*" ? i : i + "s"})
    }
}, {
    name: "state", query: !0, regex: tp, populate: function (e, r, a) {
        var n = Je(a, 1), i = n[0];
        r.checks.push({type: se.STATE, value: i})
    }
}, {
    name: "id", query: !0, regex: "\\#(" + Me.id + ")", populate: function (e, r, a) {
        var n = Je(a, 1), i = n[0];
        r.checks.push({type: se.ID, value: Gr(i)})
    }
}, {
    name: "className", query: !0, regex: "\\.(" + Me.className + ")", populate: function (e, r, a) {
        var n = Je(a, 1), i = n[0];
        r.checks.push({type: se.CLASS, value: Gr(i)})
    }
}, {
    name: "dataExists", query: !0, regex: "\\[\\s*(" + Me.variable + ")\\s*\\]", populate: function (e, r, a) {
        var n = Je(a, 1), i = n[0];
    ...
    name: "nextQuery", separator: !0, regex: Me.separator, populate: function (e, r) {
    ...
    name: "directedEdge", separator: !0, regex: Me.directedEdge, populate: function (e, r) {
    ...
    name: "undirectedEdge", separator: !0, regex: Me.undirectedEdge, populate: function (e, r) {
        if (e.currentSubject == null) {
            var a = ze(), n = r, i = ze();
    ...
    name: "child", separator: !0, regex: Me.child, populate: function (e, r) {
        if (e.currentSubject == null) {
            ...
            return s.checks.push({
                ...
                right: u,
                subject: l
            }), l.checks = r.checks, r.checks = [{type: se.TRUE}], c.checks.push({type: se.TRUE}), u.checks.push({
                type: se.PARENT,
                parent: c,
                child: f
    ...
    name: "descendant", separator: !0, regex: Me.descendant, populate: function (e, r) {
        if (e.currentSubject == null) {
            var a = ze(), n = ze(), i = e[e.length - 1];
    ...
    name: "subject", modifier: !0, regex: Me.subject, populate: function (e, r) {
        if (e.currentSubject != null && e.currentSubject !== r) return Ge("Redefinition of subject in selector `" + e.toString() + "`"), !1;
        e.currentSubject = r;
...
var rp = function (e) {
    ...
    for (r.length = 1, a = ap(a); ;) {
        var i = rp(a);
        if (i.expr == null) return Ge("The selector `" + e + "`is invalid"), !1;
    ...
    for (var l = 0; l < r.length; l++) {
        var f = r[l];
        if (f.compoundCount > 0 && f.edgeCount > 0) return Ge("The selector `" + e + "` is invalid because it uses both a compound selector and an edge selector"), !1;
        if (f.edgeCount > 1) return Ge("The selector `" + e + "` is invalid because it uses multiple edge selectors"), !1;
...
}, sp = {parse: np, toString: ip}, Jf = function (e, r, a) {
...
var fp = function (e) {
    ...
    return !1
}, vp = {matches: cp, filter: fp}, hr = function (e) {
...
var Mt = function (e, r) {
    return function (n, i, s, o) {
        ...
        if (u == null ? f = "" : Lt(u) && u.length === 1 && (f = u.id()), l.length === 1 && f) {
            var c = l[0]._private, v = c.traversalCache = c.traversalCache || {}, h = v[r] = v[r] || [], d = Ir(f),
                p = h[d];
...
Pa = tc = {
    ...
    removeRscratch: _e.removeData({field: "rscratch", triggerEvent: !1}),
    id: function () {
        var e = this[0];
...
function Es(t) {
    return function (e) {
        var r = this;
        if (e === void 0 && (e = !0), r.length !== 0) if (r.isNode() && !r.removed()) {
...
Bt = rc = {
    ...
    positions: function (e, r) {
        if (Oe(e)) r ? this.silentPosition(e) : this.position(e); else if (He(e)) {
            var a = e, n = this.cy();
            n.startBatch();
    ...
    shift: function (e, r, a) {
        var n;
        if (Oe(e) ? (n = {x: ne(e.x) ? e.x : 0, y: ne(e.y) ? e.y : 0}, a = r) : ge(e) && ne(r) && (n = {
            x: 0,
            y: 0
        }, n[e] = r), n != null) {
            var i = this.cy();
    ...
    renderedPosition: function (e, r) {
        var a = this[0], n = this.cy(), i = n.zoom(), s = n.pan(), o = Oe(e) ? e : void 0,
            u = o !== void 0 || r !== void 0 && ge(e);
    ...
    relativePosition: function (e, r) {
        var a = this[0], n = this.cy(), i = Oe(e) ? e : void 0, s = i !== void 0 || r !== void 0 && ge(e),
...
br.renderedBoundingBox = function (t) {
    var e = this.boundingBox(t), r = this.cy(), a = r.zoom(), n = r.pan(), i = e.x1 * a + n.x, s = e.x2 * a + n.x,
        o = e.y1 * a + n.y, u = e.y2 * a + n.y;
...
br.updateCompoundBounds = function () {
    ...
    function r(s) {
        ...
        }, c = u.boundingBox({includeLabels: l, includeOverlays: !1, useCache: !1}), v = o.position;
        (c.w === 0 || c.h === 0) && (c = {
        ...
        function h(C, D, A) {
            var L = 0, R = 0, I = D + A;
            return C > 0 && I > 0 && (L = D / I * C, R = A / I * C), {biasDiff: L, biasComplementDiff: R}
        }
        ...
        var m = h(f.width.val - c.w, p, g), E = m.biasDiff, T = m.biasComplementDiff, S = h(f.height.val - c.h, y, b),
            w = S.biasDiff, x = S.biasComplementDiff;
...
var Pt = function (e) {
    ...
    if (!r.cy().headless()) {
        ...
        if (o) {
            var u = r.pstyle("text-halign"), l = r.pstyle("text-valign"), f = da(s, "labelWidth", a),
                c = da(s, "labelHeight", a), v = da(s, "labelX", a), h = da(s, "labelY", a),
                d = r.pstyle(n + "text-margin-x").pfValue, p = r.pstyle(n + "text-margin-y").pfValue, g = r.isEdge(),
                y = r.pstyle(n + "text-rotation"), b = r.pstyle("text-outline-width").pfValue,
                m = r.pstyle("text-border-width").pfValue, E = m / 2, T = r.pstyle("text-background-padding").pfValue,
                S = 2, w = c, x = f, C = x / 2, D = w / 2, A, L, R, I;
            if (g) A = v - C, L = v + C, R = h - D, I = h + D; else {
                switch (u.value) {
                    case"left":
                        A = v - x, L = v;
                        break;
            ...
            var M = d - Math.max(b, E) - T - S, N = d + Math.max(b, E) + T + S, O = p - Math.max(b, E) - T - S,
                k = p + Math.max(b, E) + T + S;
            A += M, L += N, R += O, I += k;
            ...
            if (G || Y) {
                var $ = G ? da(i.rstyle, "labelAngle", a) : y.pfValue, H = Math.cos($), W = Math.sin($),
                    ee = (A + L) / 2, ae = (R + I) / 2;
                if (!g) {
                    switch (u.value) {
                        case"left":
                ...
                var J = function (Te, we) {
                    return Te = Te - ee, we = we - ae, {x: Te * H - we * W + ee, y: Te * W + we * H + ae}
    ...
    if (!r.cy().headless()) {
        var a = r.pstyle("outline-opacity").value, n = r.pstyle("outline-width").value,
            i = r.pstyle("outline-offset").value, s = n + i;
        nc(e, r, a, s, "outside", s / 2)
    }
}, nc = function (e, r, a, n, i, s) {
    if (!(a === 0 || n <= 0 || i === "inside")) {
        var o = r.cy(), u = r.pstyle("shape").value, l = o.renderer().nodeShapes[u], f = r.position(), c = f.x, v = f.y,
            h = r.width(), d = r.height();
        if (l.hasMiterBounds) {
            i === "center" && (n /= 2);
    ...
    if (!r.cy().headless()) {
        var a = r.pstyle("border-opacity").value, n = r.pstyle("border-width").pfValue,
            i = r.pstyle("border-position").value;
        nc(e, r, a, n, i)
    }
}, yp = function (e, r) {
    var a = e._private.cy, n = a.styleEnabled(), i = a.headless(), s = Et(), o = e._private, u = e.isNode(),
        l = e.isEdge(), f, c, v, h, d, p, g = o.rstyle, y = u && n ? e.pstyle("bounds-expansion").pfValue : [0],
        b = function (Ie) {
...
br.boundingBox = function (t) {
    ...
    if (r && this.length === 1 && !a(this[0])) t === void 0 ? t = Ma : t = El(t), e = bl(this[0], t); else {
        e = Et(), t = t || Ma;
...
br.boundingBoxAt = function (t) {
    ...
    var u = Qh(this.boundingBox({useCache: !1}));
...
var bp = qa, wp = function (e, r) {
    ...
    controlPoints: {get: Tp, mult: !0},
    segmentPoints: {get: Cp, mult: !0},
    sourceEndpoint: {get: Dp},
    targetEndpoint: {get: Sp},
    midpoint: {get: Ap}
}, Lp = function (e) {
...
var gr = Xn.prototype, cc = function (e, r, a, n, i, s, o) {
    ...
    for (var n = Ve(a) ? a : a.split(/\s+/), i = 0; i < n.length; i++) {
        ...
        if (!fr(s)) {
            var o = s.match(lc);
            if (o) {
                var u = o[1], l = o[2] ? o[2] : null, f = Cl(e, {type: u, namespace: l, target: e.context});
                r(e, f)
            }
        }
    }
...
gr.on = gr.addListener = function (t, e, r, a, n) {
    return cc(this, function (i, s, o, u, l, f, c) {
        He(f) && i.listeners.push({event: s, callback: f, type: o, namespace: u, qualifier: l, conf: c})
    }, t, e, r, a, n), this
};
...
gr.removeListener = gr.off = function (t, e, r, a) {
    ...
    for (var i = this.listeners, s = function (l) {
        ...
        cc(n, function (c, v, h, d, p, g) {
            if ((f.type === h || t === "*") && (!d && f.namespace !== ".*" || f.namespace === d) && (!p || c.qualifierCompare(f.qualifier, p)) && (!g || f.callback === g)) return i.splice(l, 1), !1
        }, t, e, r, a)
...
var kp = {
    ...
    createEmitter: function () {
        for (var e = 0; e < this.length; e++) {
            ...
            a.emitter || (a.emitter = new Xn(kp, r))
        }
        return this
    }, emitter: function () {
...
var Np = {
    ...
    forEach: function (e, r) {
        if (He(e)) for (var a = this.length, n = 0; n < a; n++) {
...
var Bp = function () {
    ...
    r && (In[Symbol.iterator] = function () {
        var a = this, n = {value: void 0, done: !1}, i = 0, s = this.length;
        return vf({
            next: function () {
...
Bp();
var Fp = ht({nodeDimensionsIncludeLabels: !1}), dn = {
    layoutDimensions: function (e) {
        e = Fp(e);
        var r;
        if (!this.takesUpSpace()) r = {w: 0, h: 0}; else if (e.nodeDimensionsIncludeLabels) {
        ...
        if (r.animate) {
            ...
            if (r.fit) {
                var m = i.animation({
                    fit: {boundingBox: s.boundingBoxAt(h), padding: r.padding},
        ...
        } else n.positions(h), r.fit && i.fit(r.eles, r.padding), r.zoom != null && i.zoom(r.zoom), r.pan && i.pan(r.pan), e.one("layoutready", r.ready), e.emit({
            type: "layoutready",
            layout: e
        }), e.one("layoutstop", r.stop), e.emit({type: "layoutstop", layout: e});
        return this
...
var ct = {
    recalculateRenderedStyle: function (e) {
        ...
        } else i.applyBypass(this, e, r, n), this.emitAndNotify("style"); else if (e === void 0) {
            var u = this[0];
...
ct.takesUpSpace = Kn("takesUpSpace", Eo({ok: sa}));
...
ct.interactive = Kn("interactive", Eo({ok: _p, parentOk: Gp, edgeOkViaNode: sa}));
...
ct.visible = Kn("visible", Eo({ok: zp, edgeOkViaNode: Vp}));
ct.hidden = function () {
    var t = this[0];
...
function oa(t) {
    lr[t.field] = function () {
        ...
        value: !0
    }), lr[t.off] = Dl({event: t.off, field: t.field, ableField: t.ableField, overrideAble: t.overrideAble, value: !1})
}
...
be(pt, {
    roots: Sl({noIncomingEdges: !0}),
    leaves: Sl({noOutgoingEdges: !0}),
    outgoers: Mt(Al({outgoing: !0}), "outgoers"),
    successors: Ll({outgoing: !0}),
    incomers: Mt(Al({incoming: !0}), "incomers"),
    predecessors: Ll({})
});
be(pt, {
...
be(pt, {
    ...
    }, "target"), sources: Rl({attr: "source"}), targets: Rl({attr: "target"})
});
...
be(pt, {edgesWith: Mt(Il(), "edgesWith"), edgesTo: Mt(Il({thisIsSrc: !0}), "edgesTo")});
...
function Il(t) {
    return function (r) {
        ...
        for (var s = 0; s < r.length; s++) for (var o = r[s]._private.edges, u = 0; u < o.length; u++) {
            var l = o[u], f = l._private.data, c = this.hasElementWithId(f.source) && r.hasElementWithId(f.target),
                v = r.hasElementWithId(f.source) && this.hasElementWithId(f.target), h = c || v;
...
be(pt, {
    ...
    codirectedEdges: Mt(Pl({codirected: !0}), "codirectedEdges")
});
...
function Pl(t) {
    ...
    return t = be({}, e, t), function (a) {
        for (var n = [], i = this.edges(), s = t, o = 0; o < i.length; o++) for (var u = i[o], l = u._private, f = l.source, c = f._private.data.id, v = l.data.target, h = f._private.edges, d = 0; d < h.length; d++) {
            var p = h[d], g = p._private.data, y = g.target, b = g.source, m = y === v && b === c,
                E = c === y && v === b;
...
be(pt, {
    components: function (e) {
        ...
        var u = function () {
            ...
            var c = i[0];
            o(c, f), r.bfs({
                directed: !1, roots: c, visit: function (h) {
                    return o(h, f)
                }
...
var vt = function (e, r) {
    ...
    var i = new Zt, s = !1;
    if (!r) r = []; else if (r.length > 0 && Oe(r[0]) && !Fa(r[0])) {
        s = !0;
        for (var o = [], u = new na, l = 0, f = r.length; l < f; l++) {
            var c = r[l];
            c.data == null && (c.data = {});
            var v = c.data;
            if (v.id == null) v.id = Rf(); else if (e.hasElementWithId(v.id) || u.has(v.id)) continue;
            var h = new Gn(e, c, !1);
            o.push(h), u.add(v.id)
        }
        r = o
...
qe.restore = function () {
    ...
    for (c = 0; c < o.length; c++) {
        ...
        if (h.clearTraversalCache(), !(!e && !d.removed)) {
            if (p.id === void 0) p.id = Rf(); else if (ne(p.id)) p.id = "" + p.id; else if (fr(p.id) || !ge(p.id)) {
        ...
        d.map = new Zt, d.map.set(g, {ele: h, index: 0}), d.removed = !1, e && a.addToPool(h)
    }
    for (var A = 0; A < i.length; A++) {
        ...
        if (M || L._private.parent) {
            ...
            if (N.empty()) R.parent = void 0; else if (N[0].removed()) Ge("Node added with missing parent, reference to parent removed"), R.parent = void 0, L._private.parent = null; else {
...
qe.remove = function () {
    var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !0,
        e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !0, r = this, a = [], n = {},
        i = r._private.cy;

    function s(I) {
        for (var M = I._private.edges, N = 0; N < M.length; N++) u(M[N])
    }

    function o(I) {
        for (var M = I._private.children, N = 0; N < M.length; N++) u(M[N])
    }
...
qe.move = function (t) {
    ...
    if (t.source !== void 0 || t.target !== void 0) {
        var s = i(t.source), o = i(t.target), u = s != null && e.hasElementWithId(s),
...
[Vf, Jg, hn, ur, aa, dp, Hn, Ip, vc, hc, Np, In, dn, ct, lr, pt].forEach(function (t) {
    be(qe, t)
});
var Up = {
    add: function (e) {
        ...
        if (Lt(e)) {
            var n = e;
            if (n._private.cy === a) r = n.restore(); else {
...
function qp(t, e, r, a) {
    var n = 4, i = .001, s = 1e-7, o = 10, u = 11, l = 1 / (u - 1), f = typeof Float32Array < "u";
    ...
    function E(D, A, L) {
        var R, I, M = 0;
        do I = A + (L - A) / 2, R = g(I, t, r) - D, R > 0 ? L = I : A = I; while (Math.abs(R) > s && ++M < o);
        return I
    }
...
var $p = function () {
    ...
    function r(a, n) {
        var i = {dx: a.v, dv: t(a)}, s = e(a, n * .5, i), o = e(a, n * .5, s), u = e(a, n, o),
            l = 1 / 6 * (i.dx + 2 * (s.dx + o.dx) + u.dx), f = 1 / 6 * (i.dv + 2 * (s.dv + o.dv) + u.dv);
    ...
    ease: Ue(.25, .1, .25, 1),
    "ease-in": Ue(.42, 0, 1, 1),
    "ease-out": Ue(0, 0, .58, 1),
    "ease-in-out": Ue(.42, 0, .58, 1),
    "ease-in-sine": Ue(.47, 0, .745, .715),
    "ease-out-sine": Ue(.39, .575, .565, 1),
    "ease-in-out-sine": Ue(.445, .05, .55, .95),
    "ease-in-quad": Ue(.55, .085, .68, .53),
    "ease-out-quad": Ue(.25, .46, .45, .94),
    "ease-in-out-quad": Ue(.455, .03, .515, .955),
    "ease-in-cubic": Ue(.55, .055, .675, .19),
    "ease-out-cubic": Ue(.215, .61, .355, 1),
    "ease-in-out-cubic": Ue(.645, .045, .355, 1),
    "ease-in-quart": Ue(.895, .03, .685, .22),
    "ease-out-quart": Ue(.165, .84, .44, 1),
    "ease-in-out-quart": Ue(.77, 0, .175, 1),
    "ease-in-quint": Ue(.755, .05, .855, .06),
    "ease-out-quint": Ue(.23, 1, .32, 1),
    "ease-in-out-quint": Ue(.86, 0, .07, 1),
    "ease-in-expo": Ue(.95, .05, .795, .035),
    "ease-out-expo": Ue(.19, 1, .22, 1),
    "ease-in-out-expo": Ue(1, 0, 0, 1),
    "ease-in-circ": Ue(.6, .04, .98, .335),
    "ease-out-circ": Ue(.075, .82, .165, 1),
    "ease-in-out-circ": Ue(.785, .135, .15, .86),
...
function Vr(t, e, r, a, n) {
    ...
    if (ne(s) && ne(o)) return Ml(i, s, o, r, a);
    if (Ve(s) && Ve(o)) {
...
function Yp(t, e, r, a) {
    ...
    if (!s.easingImpl) if (o == null) s.easingImpl = gn.linear; else {
        var c;
        if (ge(o)) {
...
var Xp = {
    ...
    createEmitter: function () {
        var e = this._private;
        return e.emitter || (e.emitter = new Xn(Wp, this)), this
    }, emitter: function () {
        return this._private.emitter
    }, on: function (e, r, a) {
...
lt.applyContextStyle = function (t, e, r) {
    for (var a = this, n = t.diffPropNames, i = {}, s = a.types, o = 0; o < n.length; o++) {
        ...
        if (!l) if (f) f.bypass ? l = {name: u, deleteBypassed: !0} : l = {name: u, delete: !0}; else continue;
        if (f !== l) {
...
lt.updateStyleHints = function (t) {
    ...
    for (var I = [Ar, Xr], M = 0; M < n.length; M++) {
    ...
    if (o) {
        var G = e.styleKeys, Y = G.nodeBody, $ = G.nodeBorder, H = G.nodeOutline, W = G.backgroundImage,
            ee = G.compound, ae = G.pie, J = G.stripe, z = [Y, $, H, W, ee, ae, J].filter(function (V) {
                return V != null
            }).reduce(Qa, [Ar, Xr]);
...
lt.applyParsedProperty = function (t, e) {
    var r = this, a = e, n = t._private.style, i, s = r.types, o = r.properties[a.name].type, u = a.bypass,
        l = n[a.name], f = l && l.bypass, c = t._private, v = "mapping", h = function (Y) {
            return Y == null ? null : Y.pfValue != null ? Y.pfValue : Y.value
        }, d = function () {
            var Y = h(l), $ = h(a);
            r.checkTriggers(t, a.name, Y, $)
        };
    if (e.name === "curve-style" && t.isEdge() && (e.value !== "bezier" && t.isLoop() || e.value === "haystack" && (t.source().isParent() || t.target().isParent())) && (a = e = this.parse(e.name, "bezier", u)), a.delete) return n[a.name] = void 0, d(), !0;
    ...
    switch (a.mapped) {
        case s.mapData: {
            ...
            if (y == null) return p(), !1;
            var E;
            if (ne(y)) {
                var T = a.fieldMax - a.fieldMin;
                T === 0 ? E = 0 : E = (y - a.fieldMin) / T
            } else return Ge("Do not use continuous mappers without specifying numeric data (i.e. `" + a.field + ": " + y + "` for `" + t.id() + "` is non-numeric)"), !1;
            if (E < 0 ? E = 0 : E > 1 && (E = 1), o.color) {
                var S = a.valueMin[0], w = a.valueMax[0], x = a.valueMin[1], C = a.valueMax[1], D = a.valueMin[2],
                    A = a.valueMax[2], L = a.valueMin[3] == null ? 1 : a.valueMin[3],
                    R = a.valueMax[3] == null ? 1 : a.valueMax[3],
                    I = [Math.round(S + (w - S) * E), Math.round(x + (C - x) * E), Math.round(D + (A - D) * E), Math.round(L + (R - L) * E)];
                i = {
                    bypass: a.bypass,
                    name: a.name,
                    value: I,
        ...
        case s.data: {
            ...
            if (O != null && (i = this.parse(a.name, O, a.bypass, v)), !i) return p(), !1;
            i.mapping = a, a = i;
            break
        }
        case s.fn: {
            var _ = a.value, F = a.fnValue != null ? a.fnValue : _(t);
            if (a.prevFnValue = F, F == null) return Ge("Custom function mappers may not return null (i.e. `" + a.name + "` for ele `" + t.id() + "` is null)"), !1;
            if (i = this.parse(a.name, F, a.bypass, v), !i) return Ge("Custom function mappers may not return invalid values for the property type (i.e. `" + a.name + "` for ele `" + t.id() + "` is invalid)"), !1;
            i.mapping = Ut(a), a = i;
            break
        }
        case void 0:
...
lt.cleanElements = function (t, e) {
    for (var r = 0; r < t.length; r++) {
        var a = t[r];
        if (this.clearStyleHints(a), a.dirtyCompoundBoundsCache(), a.dirtyBoundingBoxCache(), !e) a._private.style = {}; else for (var n = a._private.style, i = Object.keys(n), s = 0; s < i.length; s++) {
            var o = i[s], u = n[o];
...
lt.updateTransitions = function (t, e) {
    var r = this, a = t._private, n = t.pstyle("transition-property").value,
        i = t.pstyle("transition-duration").pfValue, s = t.pstyle("transition-delay").pfValue;
    if (n.length > 0 && i > 0) {
...
$a.overrideBypass = function (t, e, r) {
    ...
    for (var a = 0; a < t.length; a++) {
        var n = t[a], i = n._private.style[e], s = this.properties[e].type, o = s.color, u = s.mutiple,
...
$a.removeBypasses = function (t, e, r) {
    for (var a = !0, n = 0; n < t.length; n++) {
        for (var i = t[n], s = {}, o = 0; o < e.length; o++) {
            ...
            if (!(!f || !f.bypass)) {
                var c = "", v = this.parse(u, c, !0), h = s[l.name] = {prev: f};
...
qt.getNonDefaultPropertiesHash = function (t, e, r) {
    ...
    for (u = 0; u < e.length; u++) if (n = e[u], i = t.pstyle(n, !1), i != null) if (i.pfValue != null) a[0] = Sa(o, a[0]), a[1] = Aa(o, a[1]); else for (s = i.strValue, l = 0; l < s.length; l++) o = s.charCodeAt(l), a[0] = Sa(o, a[0]), a[1] = Aa(o, a[1]);
    return a
};
...
(function () {
    ...
    Qe.types = {
        ...
        boundsExpansion: {
            number: !0, multiple: !0, min: 0, validate: function (V) {
                var q = V.length;
                return q === 1 || q === 2 || q === 4
            }
        }
    ...
    var u = {
        ...
        c = [{name: "source-label", type: l.text, triggersBounds: u.any}, {
        ...
        v = [{name: "target-label", type: l.text, triggersBounds: u.any}, {
        ...
        h = [{name: "font-family", type: l.fontFamily, triggersBounds: u.any}, {
            name: "font-style",
            type: l.fontStyle,
            triggersBounds: u.any
            ...
            triggersBounds: u.any
        }], d = [{name: "text-valign", type: l.valign, triggersBounds: u.any}, {
            name: "text-halign",
            type: l.halign,
            triggersBounds: u.any
        }, {name: "color", type: l.color}, {name: "text-outline-color", type: l.color}, {
            ...
            type: l.bool,
            triggersBounds: u.any
        }], p = [{name: "events", type: l.bool, triggersZOrder: u.any}, {
            name: "text-events",
            type: l.bool,
            triggersZOrder: u.any
        }, {name: "box-selection", type: l.boxSelection, triggersZOrder: u.any}], g = [{
            name: "display",
            type: l.display,
            triggersZOrder: u.any,
            triggersBounds: u.any,
        ...
        y = [{name: "overlay-padding", type: l.size, triggersBounds: u.any}, {
            name: "overlay-color",
            type: l.color
        ...
        b = [{name: "underlay-padding", type: l.size, triggersBounds: u.any}, {
            name: "underlay-color",
            type: l.color
        ...
        m = [{name: "transition-property", type: l.propList}, {
            name: "transition-duration",
            type: l.time
        }, {name: "transition-delay", type: l.time}, {name: "transition-timing-function", type: l.easing}],
        E = function (V, q) {
            return q.value === "label" ? -V.poolIndex() : q.pfValue
        }, T = [{name: "height", type: l.nodeSize, triggersBounds: u.any, hashOverride: E}, {
            name: "width",
            type: l.nodeSize,
            triggersBounds: u.any,
            hashOverride: E
        ...
        S = [{name: "border-color", type: l.color}, {
            name: "border-opacity",
            type: l.zeroOneNumber
        }, {name: "border-width", type: l.size, triggersBounds: u.any}, {
            name: "border-style",
            type: l.borderStyle
        }, {name: "border-cap", type: l.lineCap}, {name: "border-join", type: l.lineJoin}, {
            name: "border-dash-pattern",
            type: l.numbers
        }, {name: "border-dash-offset", type: l.number}, {name: "border-position", type: l.linePosition}],
        w = [{name: "outline-color", type: l.color}, {
        ...
        x = [{name: "background-image", type: l.urls}, {
            ...
            type: l.bgWH
        }, {name: "background-offset-x", type: l.bgPos}, {name: "background-offset-y", type: l.bgPos}],
        C = [{name: "position", type: l.position, triggersBounds: u.any}, {
        ...
        D = [{name: "line-style", type: l.lineStyle}, {name: "line-color", type: l.color}, {
            name: "line-fill",
            type: l.fill
            ...
            triggersBoundsOfParallelEdges: function (V, q) {
                return V === q ? !1 : V === "bezier" || q === "bezier"
            }
        ...
        A = [{name: "ghost", type: l.bool, triggersBounds: u.any}, {
            name: "ghost-offset-x",
            type: l.bidirectionalSize,
            triggersBounds: u.any
            ...
            name: "ghost-opacity",
            type: l.zeroOneNumber
        }], L = [{name: "selection-box-color", type: l.color}, {
            ...
            type: l.color
        }, {name: "outside-texture-bg-opacity", type: l.zeroOneNumber}], R = [];
    Qe.pieBackgroundN = 16, R.push({name: "pie-size", type: l.sizeMaybePercent}), R.push({
        name: "pie-hole",
        type: l.sizeMaybePercent
    }), R.push({name: "pie-start-angle", type: l.angle});
    for (var I = 1; I <= Qe.pieBackgroundN; I++) R.push({
        name: "pie-" + I + "-background-color",
        type: l.color
    }), R.push({
        name: "pie-" + I + "-background-size",
        type: l.percent
    }), R.push({name: "pie-" + I + "-background-opacity", type: l.zeroOneNumber});
    var M = [];
    Qe.stripeBackgroundN = 16, M.push({
        name: "stripe-size",
        type: l.sizeMaybePercent
    }), M.push({name: "stripe-direction", type: l.axisDirectionPrimary});
    for (var N = 1; N <= Qe.stripeBackgroundN; N++) M.push({
        name: "stripe-" + N + "-background-color",
        type: l.color
    }), M.push({
        name: "stripe-" + N + "-background-size",
        type: l.percent
    }), M.push({name: "stripe-" + N + "-background-opacity", type: l.zeroOneNumber});
    var O = [], k = Qe.arrowPrefixes = ["source", "mid-source", "target", "mid-target"];
    [{name: "arrow-shape", type: l.arrowShape, triggersBounds: u.any}, {
        name: "arrow-color",
        type: l.color
    }, {name: "arrow-fill", type: l.arrowFill}, {name: "arrow-width", type: l.arrowWidth}].forEach(function (z) {
        k.forEach(function (V) {
            var q = V + "-" + z.name, Z = z.type, re = z.triggersBounds;
            O.push({name: q, type: Z, triggersBounds: re})
        })
    }, {});
    var B = Qe.properties = [].concat(p, m, g, y, b, A, d, h, f, c, v, T, S, w, x, R, M, C, D, O, L),
        _ = Qe.propertyGroups = {
            behavior: p,
            transition: m,
            visibility: g,
    ...
    var Y = Qe.aliases = [{name: "content", pointsTo: "label"}, {
    ...
    for (var W = 0; W < Y.length; W++) {
        var ee = Y[W], ae = B[ee.pointsTo], J = {name: ee.name, alias: !0, pointsTo: ae};
...
Qe.getDefaultProperties = function () {
    ...
    for (var e = be({
        ...
        name: "arrow-fill",
        value: "filled"
    }, {name: "arrow-width", value: 1}].reduce(function (u, l) {
...
Qn.parse = function (t, e, r, a) {
    var n = this;
    if (He(e)) return n.parseImplWarn(t, e, r, a);
    var i = a === "mapping" || a === !0 || a === !1 || a == null ? "dontcare" : a, s = r ? "t" : "f", o = "" + e,
        u = Sf(t, o, s, i), l = n.propCache = n.propCache || [], f;
...
Qn.parseImpl = function (t, e, r, a) {
    ...
    var l = i.type;
    if (!l) return null;
    if (r && (e === "" || e === null)) return {name: t, value: e, bypass: !0, deleteBypass: !0};
    if (He(e)) return {name: t, value: e, strValue: "fn", mapped: o.fn, bypass: r};
    var f, c;
    if (!(!u || a || e.length < 7 || e[1] !== "a")) {
        if (e.length >= 7 && e[0] === "d" && (f = new RegExp(o.data.regex).exec(e))) {
            ...
            if (l.color) {
                var g = d.value, y = p.value,
                    b = g[0] === y[0] && g[1] === y[1] && g[2] === y[2] && (g[3] === y[3] || (g[3] == null || g[3] === 1) && (y[3] == null || y[3] === 1));
                if (b) return !1
            }
            return {
                name: t,
    ...
    if (l.multiple && a !== "multiple") {
        ...
        return l.validate && !l.validate(E, T) ? null : l.singleEnum && x ? E.length === 1 && ge(E[0]) ? {
            ...
            strValue: E[0],
            bypass: r
        } : null : {name: t, value: E, pfValue: S, strValue: w, bypass: r, units: T}
    }
    var A = function () {
    ...
    if (l.number) {
        ...
        if (l.integer && !_v(e) || l.min !== void 0 && (e < l.min || l.strictMin && e === l.min) || l.max !== void 0 && (e > l.max || l.strictMax && e === l.max)) return null;
...
[lt, $a, xo, qt, Zn, To, Qe, Qn].forEach(function (t) {
    be(yt, t)
});
ut.types = yt.types;
...
var Jp = {
    ...
    autolock: function (e) {
        if (e !== void 0) this._private.autolock = !!e; else return this._private.autolock;
        return this
    }, autoungrabify: function (e) {
        if (e !== void 0) this._private.autoungrabify = !!e; else return this._private.autoungrabify;
        return this
    }, autounselectify: function (e) {
        if (e !== void 0) this._private.autounselectify = !!e; else return this._private.autounselectify;
        return this
    }, selectionType: function (e) {
        var r = this._private;
        if (r.selectionType == null && (r.selectionType = jp), e !== void 0) (e === "additive" || e === "single") && (r.selectionType = e); else return r.selectionType;
        return this
    }, panningEnabled: function (e) {
        if (e !== void 0) this._private.panningEnabled = !!e; else return this._private.panningEnabled;
        return this
    }, userPanningEnabled: function (e) {
        if (e !== void 0) this._private.userPanningEnabled = !!e; else return this._private.userPanningEnabled;
        return this
    }, zoomingEnabled: function (e) {
        if (e !== void 0) this._private.zoomingEnabled = !!e; else return this._private.zoomingEnabled;
        return this
    }, userZoomingEnabled: function (e) {
        if (e !== void 0) this._private.userZoomingEnabled = !!e; else return this._private.userZoomingEnabled;
        return this
    }, boxSelectionEnabled: function (e) {
        if (e !== void 0) this._private.boxSelectionEnabled = !!e; else return this._private.boxSelectionEnabled;
        return this
    }, pan: function () {
        ...
        if (r.zoomingEnabled || (o = !0), ne(e) ? s = e : Oe(e) && (s = e.level, e.position != null ? i = zn(e.position, n, a) : e.renderedPosition != null && (i = e.renderedPosition), i != null && !r.panningEnabled && (o = !0)), s = s > r.maxZoom ? r.maxZoom : s, s = s < r.minZoom ? r.minZoom : s, o || !ne(s) || s === n || i != null && (!ne(i.x) || !ne(i.y))) return null;
        if (i != null) {
            var u = a, l = n, f = s, c = {x: -f / l * (i.x - u.x) + i.x, y: -f / l * (i.y - u.y) + i.y};
            return {zoomed: !0, panned: !0, zoom: f, pan: c}
        ...
        if (!e) return this;
        if (ne(e.zoom) || (a = !1), Oe(e.pan) || (n = !1), !a && !n) return this;
        if (a) {
            var u = e.zoom;
        ...
        var e = this._private.pan, r = this._private.zoom, a = this.renderedExtent(),
            n = {x1: (a.x1 - e.x) / r, x2: (a.x2 - e.x) / r, y1: (a.y1 - e.y) / r, y2: (a.y2 - e.y) / r};
        ...
        if (e) this._private.multiClickDebounceTime = e; else return this._private.multiClickDebounceTime;
        return this
    }
};
Or.centre = Or.center;
...
var ka = function (e) {
    ...
    var u = function (d, p, g) {
        ...
        pan: {x: Oe(o.pan) && ne(o.pan.x) ? o.pan.x : 0, y: Oe(o.pan) && ne(o.pan.y) ? o.pan.y : 0},
        animation: {current: [], queue: []},
        hasCompoundNodes: !1,
...
be(Pn, {
    instanceString: function () {
        ...
        if (e != null) {
            ...
            return !Cn(e) && Cn(e[0]) && (e = e[0]), r.stopAnimationLoop(), r.destroyRenderer(), a.container = e, a.styleEnabled = !0, r.invalidateSize(), r.initRenderer(be({}, n, n.renderer, {name: n.renderer.name === "null" ? "canvas" : n.renderer.name})), r.startAnimationLoop(), r.style(n.style), r.emit("mount"), r
        }
    }, unmount: function () {
        var e = this;
            ...
            if (r.startBatch(), e.elements) {
                var s = {}, o = function (E, T) {
                    for (var S = [], w = [], x = 0; x < E.length; x++) {
                        ...
                        s[D] = !0, A.length !== 0 ? w.push({ele: A, json: C}) : (T && (C.group = T), S.push(C))
                    }
                    r.add(S);
                ...
                if (Ve(e.elements)) o(e.elements); else for (var u = ["nodes", "edges"], l = 0; l < u.length; l++) {
...
[Up, Xp, pc, $s, pn, Kp, Ys, yn, Jp, Or, Oa].forEach(function (t) {
    be(Pn, t)
});
var ey = {
    fit: !0,
...
}, ty = {maximal: !1, acyclic: !1}, Ur = function (e) {
...
yc.prototype.run = function () {
    var t = this.options, e = t.cy, r = t.eles, a = r.nodes().filter(function (ye) {
        ...
        }), n = r, i = t.directed, s = t.acyclic || t.maximal || t.maximalAdjustments > 0, o = !!t.boundingBox,
        u = Et(o ? t.boundingBox : structuredClone(e.extent())), l;
    if (Lt(t.roots)) l = t.roots; else if (Ve(t.roots)) {
        for (var f = [], c = 0; c < t.roots.length; c++) {
            var v = t.roots[c], h = e.getElementById(v);
            f.push(h)
        }
        l = e.collection(f)
    } else if (ge(t.roots)) l = e.$(t.roots); else if (i) l = a.roots(); else {
        var d = r.components();
        l = e.collection();
        for (var p = function () {
    ...
    var y = [], b = {}, m = function (ie, he) {
        y[he] == null && (y[he] = []);
        var de = y[he].length;
        y[he].push(ie), Nl(ie, {index: de, depth: he})
    }, E = function (ie, he) {
        var de = Ur(ie), xe = de.depth, pe = de.index;
        y[xe][pe] = null, ie.isChildless() && m(ie, he)
    };
    n.bfs({
        roots: l, directed: t.directed, visit: function (ie, he, de, xe, pe) {
    ...
    if (i && s) {
        ...
        for (a.forEach(function (ye) {
            ...
            var I = R(), M = C(I, A);
            if (M) I.outgoers().filter(function (ye) {
                return ye.isNode() && r.has(ye)
            }).forEach(L); else if (M === null) {
    ...
    for (var H = y.length, W = 0; W < H; W++) y[W].sort($), x(W);
    for (var ee = [], ae = 0; ae < T.length; ae++) ee.push(T[ae]);
    var J = function () {
        for (var ie = 0; ie < H; ie++) x(ie)
    };
    ee.length && (y.unshift(ee), H = y.length, J());
    for (var z = 0, V = 0; V < H; V++) z = Math.max(y[V].length, z);
    var q = {x: u.x1 + u.w / 2, y: u.y1 + u.h / 2}, Z = a.reduce(function (ye, ie) {
        ...
        re = Math.max(H === 1 ? 0 : o ? (u.h - t.padding * 2 - Z.h) / (H - 1) : (u.h - t.padding * 2 - Z.h) / (H + 1), N),
        ve = y.reduce(function (ye, ie) {
            ...
            if (t.circle) {
                ...
                pe = Math.max(pe, N);
                var De = pe * de + pe - (H > 0 && y[0].length <= 3 ? pe / 2 : 0), Pe = 2 * Math.PI / y[de].length * xe;
                return de === 0 && y[0].length === 1 && (De = 1), {x: q.x + De * Math.cos(Pe), y: q.y + De * Math.sin(Pe)}
            } else {
                var Ne = y[de].length,
                    Be = Math.max(Ne === 1 ? 0 : o ? (u.w - t.padding * 2 - Z.w) / ((t.grid ? ve : Ne) - 1) : (u.w - t.padding * 2 - Z.w) / ((t.grid ? ve : Ne) + 1), N),
                    Fe = {x: q.x + (xe + 1 - (Ne + 1) / 2) * Be, y: q.y + (de + 1 - (H + 1) / 2) * re};
                return Fe
            }
...
mc.prototype.run = function () {
    var t = this.options, e = t, r = t.cy, a = e.eles,
        n = e.counterclockwise !== void 0 ? !e.counterclockwise : e.clockwise, i = a.nodes().not(":parent");
    ...
    var E = function (S, w) {
        var x = e.startAngle + w * l * (n ? 1 : -1), C = f * Math.cos(x), D = f * Math.sin(x),
            A = {x: o.x + C, y: o.y + D};
        return A
    };
...
bc.prototype.run = function () {
    for (var t = this.options, e = t, r = e.counterclockwise !== void 0 ? !e.counterclockwise : e.clockwise, a = t.cy, n = e.eles, i = n.nodes().not(":parent"), s = Et(e.boundingBox ? e.boundingBox : {
        ...
        w: a.width(),
        h: a.height()
    }), o = {x: s.x1 + s.w / 2, y: s.y1 + s.h / 2}, u = [], l = 0, f = 0; f < i.length; f++) {
        var c = i[f], v = void 0;
    ...
    for (var D = 0, A = 0; A < y.length; A++) {
        var L = y[A], R = e.sweep === void 0 ? 2 * Math.PI - 2 * Math.PI / L.length : e.sweep,
            I = L.dTheta = R / Math.max(1, L.length - 1);
    ...
    for (var H = {}, W = 0; W < y.length; W++) for (var ee = y[W], ae = ee.dTheta, J = ee.r, z = 0; z < ee.length; z++) {
        var V = ee[z], q = e.startAngle + (r ? 1 : -1) * ae * z,
            Z = {x: o.x + J * Math.cos(q), y: o.y + J * Math.sin(q)};
        H[V.node.id()] = Z
    }
...
var iy = function (e, r, a) {
    for (var n = a.eles.edges(), i = a.eles.nodes(), s = Et(a.boundingBox ? a.boundingBox : {
        ...
        clientHeight: s.h,
        boundingBox: s
    }, u = a.eles.components(), l = {}, f = 0; f < u.length; f++) for (var c = u[f], v = 0; v < c.length; v++) {
        var h = c[v];
        l[h.id()] = f
    }
    ...
    for (var f = 0; f < o.edgeSize; f++) {
        ...
        var R = He(a.idealEdgeLength) ? a.idealEdgeLength(A) : a.idealEdgeLength,
            I = He(a.edgeElasticity) ? a.edgeElasticity(A) : a.edgeElasticity, M = o.idToIndex[L.sourceId],
            N = o.idToIndex[L.targetId], O = o.indexToGraph[M], k = o.indexToGraph[N];
        if (O != k) {
            for (var B = sy(L.sourceId, L.targetId, o), _ = o.graphSet[B], F = 0, g = o.layoutNodes[M]; _.indexOf(g.id) === -1;) g = o.layoutNodes[o.idToIndex[g.parentId]], F++;
    ...
    return r.boundingBox && (a.forEach(function (s) {
        ...
        if (r.boundingBox) {
            var l = i.w === 0 ? .5 : (u.positionX - i.x1) / i.w, f = i.h === 0 ? .5 : (u.positionY - i.y1) / i.h;
    ...
    if (!(i !== s && !a.isCompound)) {
        ...
        var f = hy(e, r, o, u);
        if (f > 0) var c = n.nodeOverlap * f, v = Math.sqrt(o * o + u * u), h = c * o / v,
            d = c * u / v; else var p = Mn(e, o, u), g = Mn(r, -1 * o, -1 * u), y = g.x - p.x, b = g.y - p.y,
            m = y * y + b * b, v = Math.sqrt(m), c = (e.nodeRepulsion + r.nodeRepulsion) / m, h = c * y / v,
            d = c * b / v;
        e.isLocked || (e.offsetX -= h, e.offsetY -= d), r.isLocked || (r.offsetX += h, r.offsetY += d)
    }
}, hy = function (e, r, a, n) {
    if (a > 0) var i = e.maxX - r.minX; else var i = r.maxX - e.minX;
    if (n > 0) var s = e.maxY - r.minY; else var s = r.maxY - e.minY;
    ...
    for (var a = 0; a < e.edgeSize; a++) {
        var n = e.layoutEdges[a], i = e.idToIndex[n.sourceId], s = e.layoutNodes[i], o = e.idToIndex[n.targetId],
            u = e.layoutNodes[o], l = u.positionX - s.positionX, f = u.positionY - s.positionY;
        if (!(l === 0 && f === 0)) {
            var c = Mn(s, l, f), v = Mn(u, -1 * l, -1 * f), h = v.x - c.x, d = v.y - c.y, p = Math.sqrt(h * h + d * d),
                g = Math.pow(n.idealLength - p, 2) / n.elasticity;
            if (p !== 0) var y = g * h / p, b = g * d / p; else var y = 0, b = 0;
    ...
    if (r.gravity !== 0) for (var a = 1, n = 0; n < e.graphSet.length; n++) {
        ...
        if (n === 0) var o = e.clientHeight / 2, u = e.clientWidth / 2; else var l = e.layoutNodes[e.idToIndex[i[0]]],
            f = e.layoutNodes[e.idToIndex[l.parentId]], o = f.positionX, u = f.positionY;
        for (var c = 0; c < s; c++) {
    ...
    if (n > a) var i = {x: a * e / n, y: a * r / n}; else var i = {x: e, y: r};
    return i
}, xc = function (e, r) {
    var a = e.parentId;
    if (a != null) {
        var n = r.layoutNodes[r.idToIndex[a]], i = !1;
        if ((n.maxX == null || e.maxX + n.padRight > n.maxX) && (n.maxX = e.maxX + n.padRight, i = !0), (n.minX == null || e.minX - n.padLeft < n.minX) && (n.minX = e.minX - n.padLeft, i = !0), (n.maxY == null || e.maxY + n.padBottom > n.maxY) && (n.maxY = e.maxY + n.padBottom, i = !0), (n.minY == null || e.minY - n.padTop < n.minY) && (n.minY = e.minY - n.padTop, i = !0), i) return xc(n, r)
    }
}, Fl = function (e, r) {
...
Tc.prototype.run = function () {
    ...
    if (i.h === 0 || i.w === 0) a.nodes().layoutPositions(this, e, function (Y) {
        ...
        var s = n.size(), o = Math.sqrt(s * i.h / i.w), u = Math.round(o), l = Math.round(i.w / i.h * o),
            f = function ($) {
                if ($ == null) return Math.min(u, l);
                var H = Math.min(u, l);
                H == u ? u = $ : l = $
            }, c = function ($) {
                if ($ == null) return Math.max(u, l);
                var H = Math.max(u, l);
                H == u ? u = $ : l = $
            }, v = e.rows, h = e.cols != null ? e.cols : e.columns;
        if (v != null && h != null) u = v, l = h; else if (v != null && h == null) u = v, l = Math.ceil(s / u); else if (v == null && h != null) l = h, u = Math.ceil(s / l); else if (l * u > s) {
            var d = f(), p = c();
        ...
        for (var A = {}, L = function ($, H) {
            ...
            if (_ && (_.row !== void 0 || _.col !== void 0)) {
                ...
                if (F.col === void 0) for (F.col = 0; L(F.row, F.col);) F.col++; else if (F.row === void 0) for (F.row = 0; L(F.row, F.col);) F.row++;
                O[B.id()] = F, R(F.row, F.col)
            }
        }
        var G = function ($, H) {
            var W, ee;
            if ($.locked() || $.isParent()) return !1;
            var ae = O[$.id()];
            if (ae) W = ae.col * b + b / 2 + i.x1, ee = ae.row * m + m / 2 + i.y1; else {
                for (; L(I, M);) N();
...
Cc.prototype.run = function () {
    ...
    function n(i) {
        if (t.positions == null) return qh(i.position());
...
Dc.prototype.run = function () {
    var t = this.options, e = t.cy, r = t.eles,
        a = Et(t.boundingBox ? t.boundingBox : {x1: 0, y1: 0, w: e.width(), h: e.height()}), n = function (s, o) {
            return {x: a.x1 + Math.round(Math.random() * a.w), y: a.y1 + Math.round(Math.random() * a.h)}
        };
    return r.nodes().layoutPositions(this, t, n), this
};
var Ty = [{name: "breadthfirst", impl: yc}, {name: "circle", impl: mc}, {name: "concentric", impl: bc}, {
    name: "cose",
    impl: Jn
}, {name: "grid", impl: Tc}, {name: "null", impl: Co}, {name: "preset", impl: Cc}, {name: "random", impl: Dc}];
...
Sc.prototype = {
    recalculateRenderedStyle: _l, notify: function () {
        this.notifications++
    }, init: _l, isHeadless: function () {
        return !0
    }, png: Gl, jpg: Gl
};
var Do = {};
Do.arrowShapeWidth = .3;
Do.registerArrowShapes = function () {
    var t = this.arrowShapes = {}, e = this, r = function (l, f, c, v, h, d, p) {
        var g = h.x - c / 2 - p, y = h.x + c / 2 + p, b = h.y - c / 2 - p, m = h.y + c / 2 + p,
            E = g <= l && l <= y && b <= f && f <= m;
        return E
    }, a = function (l, f, c, v, h) {
        var d = l * Math.cos(v) - f * Math.sin(v), p = l * Math.sin(v) + f * Math.cos(v), g = d * c, y = p * c,
            b = g + h.x, m = y + h.y;
        return {x: b, y: m}
    }, n = function (l, f, c, v) {
    ...
    o("none", {
        ...
        collide: function (l, f, c, v, h, d, p) {
            var g = i(n(this.points, c + 2 * p, v, h)), y = i(n(this.pointsTee, c + 2 * p, v, h)),
                b = St(l, f, g) || St(l, f, y);
            return b
        },
        draw: function (l, f, c, v, h) {
        ...
        collide: function (l, f, c, v, h, d, p) {
            var g = i(n(this.points, c + 2 * p, v, h)), y = i(n(this.crossLinePts(c, d), c + 2 * p, v, h)),
                b = St(l, f, g) || St(l, f, y);
            return b
        },
        draw: function (l, f, c, v, h) {
        ...
        points: [-.15, -.3, 0, 0, .15, -.3, 0, -.15], gap: function (l) {
            return s(l) * .525
        }
    }), o("circle", {
        radius: .15, collide: function (l, f, c, v, h, d, p) {
            var g = h, y = Math.pow(g.x - l, 2) + Math.pow(g.y - f, 2) <= Math.pow((c + 2 * p) * this.radius, 2);
            return y
        }, draw: function (l, f, c, v, h) {
        ...
        points: [-.15, 0, -.15, -.1, .15, -.1, .15, 0], spacing: function (l) {
            return 1
        }, gap: function (l) {
            return 1
        }
        ...
        points: [0, 0, -.15, -.15, -.1, -.2, 0, -.1, .1, -.2, .15, -.15], gap: function (l) {
            return .95 * l.pstyle("width").pfValue * l.pstyle("arrow-scale").value
        }
    })
};
var Br = {};
Br.projectIntoViewport = function (t, e) {
    var r = this.cy, a = this.findContainerClientCoords(), n = a[0], i = a[1], s = a[4], o = r.pan(), u = r.zoom(),
        l = ((t - n) / s - o.x) / u, f = ((e - i) / s - o.y) / u;
    return [l, f]
};
Br.findContainerClientCoords = function () {
    ...
    var t = this.container, e = t.getBoundingClientRect(), r = this.cy.window().getComputedStyle(t), a = function (y) {
        ...
        }, s = t.clientWidth, o = t.clientHeight, u = n.left + n.right, l = n.top + n.bottom, f = i.left + i.right,
        c = e.width / (s + f), v = s - u, h = o - l, d = e.left + n.left + i.left, p = e.top + n.top + i.top;
...
Br.findNearestElements = function (t, e, r, a) {
    var n = this, i = this, s = i.getCachedZSortedEles(), o = [], u = i.cy.zoom(), l = i.cy.hasCompoundNodes(),
        f = (a ? 24 : 8) / u, c = (a ? 8 : 2) / u, v = (a ? 8 : 2) / u, h = 1 / 0, d, p;
    r && (s = s.interactive);
    ...
    function y(w) {
        var x = w.outerWidth() + 2 * c, C = w.outerHeight() + 2 * c, D = x / 2, A = C / 2, L = w.position(),
            R = w.pstyle("corner-radius").value === "auto" ? "auto" : w.pstyle("corner-radius").pfValue,
            I = w._private.rscratch;
        if (L.x - D <= t && t <= L.x + D && L.y - A <= e && e <= L.y + A) {
            var M = i.nodeShapes[n.getNodeShape(w)];
            if (M.checkPoint(t, e, 0, x, C, L.x, L.y, R, I)) return g(w, 0), !0
        }
    }

    function b(w) {
        var x = w._private, C = x.rscratch, D = w.pstyle("width").pfValue, A = w.pstyle("arrow-scale").value,
            L = D / 2 + f, R = L * L, I = L * 2, k = x.source, B = x.target, M;
        if (C.edgeType === "segments" || C.edgeType === "straight" || C.edgeType === "haystack") {
            for (var N = C.allpts, O = 0; O + 3 < N.length; O += 2) if (ad(t, e, N[O], N[O + 1], N[O + 2], N[O + 3], I) && R > (M = ud(t, e, N[O], N[O + 1], N[O + 2], N[O + 3]))) return g(w, M), !0
        } else if (C.edgeType === "bezier" || C.edgeType === "multibezier" || C.edgeType === "self" || C.edgeType === "compound") {
            for (var N = C.allpts, O = 0; O + 5 < C.allpts.length; O += 4) if (nd(t, e, N[O], N[O + 1], N[O + 2], N[O + 3], N[O + 4], N[O + 5], I) && R > (M = od(t, e, N[O], N[O + 1], N[O + 2], N[O + 3], N[O + 4], N[O + 5]))) return g(w, M), !0
        }
        ...
        }, {name: "target", x: C.arrowEndX, y: C.arrowEndY, angle: C.tgtArrowAngle}, {
            name: "mid-source",
            x: C.midX,
            y: C.midY,
            angle: C.midsrcArrowAngle
        }, {name: "mid-target", x: C.midX, y: C.midY, angle: C.midtgtArrowAngle}], O = 0; O < F.length; O++) {
            var G = F[O], Y = i.arrowShapes[w.pstyle(G.name + "-arrow-shape").value], $ = w.pstyle("width").pfValue;
            if (Y.roughCollide(t, e, _, G.angle, {x: G.x, y: G.y}, $, f) && Y.collide(t, e, _, G.angle, {
                x: G.x,
                y: G.y
            }, $, f)) return g(w), !0
        }
    ...
    function E(w, x) {
        ...
        var L = C.labelBounds[x || "main"], R = w.pstyle(A + "label").value,
            I = w.pstyle("text-events").strValue === "yes";
        if (!(!I || !R)) {
            var M = m(C.rscratch, "labelX", x), N = m(C.rscratch, "labelY", x), O = m(C.rscratch, "labelAngle", x),
                k = w.pstyle(A + "text-margin-x").pfValue, B = w.pstyle(A + "text-margin-y").pfValue, _ = L.x1 - D - k,
                F = L.x2 + D - k, G = L.y1 - D - B, Y = L.y2 + D - B;
            if (O) {
                var $ = Math.cos(O), H = Math.sin(O), W = function (Z, re) {
                        return Z = Z - M, re = re - N, {x: Z * $ - re * H + M, y: Z * H + re * $ + N}
                    }, ee = W(_, G), ae = W(_, Y), J = W(F, G), z = W(F, Y),
                    V = [ee.x + k, ee.y + B, J.x + k, J.y + B, z.x + k, z.y + B, ae.x + k, ae.y + B];
                if (St(t, e, V)) return g(w), !0
            } else if (sr(L, t, e)) return g(w), !0
        }
    }
...
Br.getAllInBox = function (t, e, r, a) {
    var n = this.getCachedZSortedEles().interactive, i = this.cy.zoom(), s = 2 / i, o = [], u = Math.min(t, r),
        l = Math.max(t, r), f = Math.min(e, a), c = Math.max(e, a);
    t = u, r = l, e = f, a = c;
    var v = Et({x1: t, y1: e, x2: r, y2: a}),
        h = [{x: v.x1, y: v.y1}, {x: v.x2, y: v.y1}, {x: v.x2, y: v.y2}, {x: v.x1, y: v.y2}],
    ...
    function g(Z, re) {
        ...
        if (!we) return null;
        var ye = p(ve.rscratch, "labelX", re), ie = p(ve.rscratch, "labelY", re), he = p(ve.rscratch, "labelAngle", re),
            de = Z.pstyle(Te + "text-margin-x").pfValue, xe = Z.pstyle(Te + "text-margin-y").pfValue,
            pe = we.x1 - Ie - de, De = we.x2 + Ie - de, Pe = we.y1 - Ie - xe, Ne = we.y2 + Ie - xe;
        if (he) {
            var Be = Math.cos(he), Fe = Math.sin(he), Ee = function (Q, P) {
                return Q = Q - ye, P = P - ie, {x: Q * Be - P * Fe + ye, y: Q * Fe + P * Be + ie}
            };
            return [Ee(pe, Pe), Ee(De, Pe), Ee(De, Ne), Ee(pe, Ne)]
        } else return [{x: pe, y: Pe}, {x: De, y: Pe}, {x: De, y: Ne}, {x: pe, y: Ne}]
    }
    ...
    for (var b = 0; b < n.length; b++) {
        var m = n[b];
        if (m.isNode()) {
            var E = m, T = E.pstyle("text-events").strValue === "yes", S = E.pstyle("box-selection").strValue,
                w = E.pstyle("box-select-labels").strValue === "yes";
            if (S === "none") continue;
            var x = (S === "overlap" || w) && T,
                C = E.boundingBox({includeNodes: !0, includeEdges: !1, includeLabels: x});
            if (S === "contain") {
                var D = !1;
                if (w && T) {
                    var A = g(E);
                ...
                }), R = [{x: L.x1, y: L.y1}, {x: L.x2, y: L.y1}, {x: L.x2, y: L.y2}, {x: L.x1, y: L.y2}];
                if (xi(R, h)) o.push(E); else {
                    var I = g(E);
                    I && xi(I, h) && o.push(E)
                }
            }
            ...
            if (k === "contain") {
                ...
                if (O.edgeType === "bezier" || O.edgeType === "multibezier" || O.edgeType === "self" || O.edgeType === "compound" || O.edgeType === "segments" || O.edgeType === "haystack") {
                    for (var B = N.rstyle.bezierPts || N.rstyle.linePts || N.rstyle.haystackPts, _ = !0, F = 0; F < B.length; F++) if (!nu(v, B[F])) {
                        _ = !1;
                        break
                    }
                    _ && o.push(M)
                ...
                var G = !1;
                if (O.startX != null && O.startY != null && O.endX != null && O.endY != null && (sr(v, O.startX, O.startY) || sr(v, O.endX, O.endY))) o.push(M), G = !0; else if (!G && O.edgeType === "haystack") {
                    for (var Y = N.rstyle.haystackPts, $ = 0; $ < Y.length; $++) if (nu(v, Y[$])) {
                        o.push(M), G = !0;
                        break
                    }
                }
                if (!G) {
                    ...
                    if ((!H || H.length < 2) && O.edgeType === "straight" && O.startX != null && O.startY != null && O.endX != null && O.endY != null && (H = [{
                        x: O.startX,
                        y: O.startY
                    }, {x: O.endX, y: O.endY}]), !H || H.length < 2) continue;
...
On.calculateArrowAngles = function (t) {
    var e = t._private.rscratch, r = e.edgeType === "haystack", a = e.edgeType === "bezier",
        n = e.edgeType === "multibezier", i = e.edgeType === "segments", s = e.edgeType === "compound",
        o = e.edgeType === "self", u, l, f, c, v, h, y, b;
    if (r ? (f = e.haystackPts[0], c = e.haystackPts[1], v = e.haystackPts[2], h = e.haystackPts[3]) : (f = e.arrowStartX, c = e.arrowStartY, v = e.arrowEndX, h = e.arrowEndY), y = e.midX, b = e.midY, i) u = f - e.segpts[0], l = c - e.segpts[1]; else if (n || s || o || a) {
        var d = e.allpts, p = ot(d[0], d[2], d[4], .1), g = ot(d[1], d[3], d[5], .1);
        u = f - p, l = c - g
    } else u = f - y, l = c - b;
    ...
    if (r && (y = (f + v) / 2, b = (c + h) / 2), u = v - f, l = h - c, i) {
        ...
        } else if (e.isRound) u = e.midVector[1], l = -e.midVector[0]; else {
        ...
        if (T.length / 2 % 2 === 0) {
            ...
            S = ot(d[D], d[A], d[L], .4999), w = ot(d[D + 1], d[A + 1], d[L + 1], .4999), x = ot(d[D], d[A], d[L], .5), C = ot(d[D + 1], d[A + 1], d[L + 1], .5)
        }
        u = x - S, l = C - w
    }
    ...
    if (e.midsrcArrowAngle = Ja(u, l), i) u = v - e.segpts[e.segpts.length - 2], l = h - e.segpts[e.segpts.length - 1]; else if (n || s || o || a) {
        var d = e.allpts, I = d.length, p = ot(d[I - 6], d[I - 4], d[I - 2], .9),
            g = ot(d[I - 5], d[I - 3], d[I - 1], .9);
        u = v - p, l = h - g
    } else u = v - y, l = h - b;
...
var Hs, Xs, Vt = {}, It = {}, zl, Vl, Lr, mn, Wt, Tr, Sr, Gt, qr, on, Ac, Lc, Ws, Ks, Ul, ql = function (e, r, a) {
...
var Na = .01, Sy = Math.sqrt(2 * Na), mt = {};
mt.findMidptPtsEtc = function (t, e) {
    var r = e.posPts, a = e.intersectionPts, n = e.vectorNormInverse, i, s = t.pstyle("source-endpoint"),
        o = t.pstyle("target-endpoint"), u = s.units != null && o.units != null, l = function (T, S, w, x) {
    ...
    switch (f) {
        ...
        case"endpoints": {
            if (u) {
                var c = this.manualEndptToPx(t.source()[0], s), v = Je(c, 2), h = v[0], d = v[1],
                    p = this.manualEndptToPx(t.target()[0], o), g = Je(p, 2), y = g[0], b = g[1],
                    m = {x1: h, y1: d, x2: y, y2: b};
                n = l(h, d, y, b), i = m
...
mt.findHaystackPoints = function (t) {
    for (var e = 0; e < t.length; e++) {
        ...
        if (!n.haystack) {
            ...
            n.source = {x: Math.cos(i), y: Math.sin(i)}, i = Math.random() * 2 * Math.PI, n.target = {
                x: Math.cos(i),
                y: Math.sin(i)
            }
        }
        var s = a.source, o = a.target, u = s.position(), l = o.position(), f = s.width(), c = o.width(),
            v = s.height(), h = o.height(), d = r.pstyle("haystack-radius").value, p = d / 2;
...
mt.findSegmentsPoints = function (t, e) {
    var r = t._private.rscratch, a = t.pstyle("segment-weights"), n = t.pstyle("segment-distances"),
        i = t.pstyle("segment-radii"), s = t.pstyle("radius-type"), o = Math.min(a.pfValue.length, n.pfValue.length),
        u = i.pfValue[i.pfValue.length - 1], l = s.pfValue[s.pfValue.length - 1];
    r.edgeType = "segments", r.segpts = [], r.radii = [], r.isArcRadius = [];
    for (var f = 0; f < o; f++) {
        var c = a.pfValue[f], v = n.pfValue[f], h = 1 - c, d = c, p = this.findMidptPtsEtc(t, e), g = p.midptPts,
            y = p.vectorNormInverse, b = {x: g.x1 * h + g.x2 * d, y: g.y1 * h + g.y2 * d};
...
mt.findLoopPoints = function (t, e, r, a) {
    var n = t._private.rscratch, i = e.dirCounts, s = e.srcPos, o = t.pstyle("control-point-distances"),
        u = o ? o.pfValue[0] : void 0, l = t.pstyle("loop-direction").pfValue, f = t.pstyle("loop-sweep").pfValue,
        c = t.pstyle("control-point-step-size").pfValue;
    n.edgeType = "self";
    var v = r, h = c;
    a && (v = 0, h = u);
...
mt.findCompoundLoopPoints = function (t, e, r, a) {
    ...
    n.edgeType = "compound";
    var i = e.srcPos, s = e.tgtPos, o = e.srcW, u = e.srcH, l = e.tgtW, f = e.tgtH,
        c = t.pstyle("control-point-step-size").pfValue, v = t.pstyle("control-point-distances"),
        h = v ? v.pfValue[0] : void 0, d = r, p = c;
    a && (d = 0, p = h);
    var g = 50, y = {x: i.x - o / 2, y: i.y - u / 2}, b = {x: s.x - l / 2, y: s.y - f / 2},
        m = {x: Math.min(y.x, b.x), y: Math.min(y.y, b.y)}, E = .5, T = Math.max(E, Math.log(o * Na)),
        S = Math.max(E, Math.log(l * Na));
...
mt.findBezierPoints = function (t, e, r, a, n) {
    var i = t._private.rscratch, s = t.pstyle("control-point-step-size").pfValue,
        o = t.pstyle("control-point-distances"), u = t.pstyle("control-point-weights"),
        l = o && u ? Math.min(o.value.length, u.value.length) : 1, f = o ? o.pfValue[0] : void 0, c = u.value[0], v = a;
    i.edgeType = v ? "multibezier" : "bezier", i.ctrlpts = [];
    for (var h = 0; h < l; h++) {
        var d = (.5 - e.eles.length / 2 + r) * s * (n ? -1 : 1), p = void 0, g = vo(d);
        v && (f = o ? o.pfValue[h] : s, c = u.value[h]), a ? p = f : p = f !== void 0 ? g * f : void 0;
        var y = p !== void 0 ? p : d, b = 1 - c, m = c, E = this.findMidptPtsEtc(t, e), T = E.midptPts,
            S = E.vectorNormInverse, w = {x: T.x1 * b + T.x2 * m, y: T.y1 * b + T.y2 * m};
...
mt.findTaxiPoints = function (t, e) {
    ...
    r.edgeType = "segments";
    var a = "vertical", n = "horizontal", i = "leftward", s = "rightward", o = "downward", u = "upward", l = "auto",
        f = e.posPts, c = e.srcW, v = e.srcH, h = e.tgtW, d = e.tgtH, p = t.pstyle("edge-distances").value,
        g = p !== "node-position", y = t.pstyle("taxi-direction").value, b = y, m = t.pstyle("taxi-turn"),
        E = m.units === "%", T = m.pfValue, S = T < 0, w = t.pstyle("taxi-turn-min-distance").pfValue,
        x = g ? (c + h) / 2 : 0, C = g ? (v + d) / 2 : 0, D = f.x2 - f.x1, A = f.y2 - f.y1, L = function (P, U) {
...
mt.tryToCorrectInvalidPoints = function (t, e) {
    ...
    if (r.edgeType === "bezier") {
        var a = e.srcPos, n = e.tgtPos, i = e.srcW, s = e.srcH, o = e.tgtW, u = e.tgtH, l = e.srcShape, f = e.tgtShape,
            c = e.srcCornerRadius, v = e.tgtCornerRadius, h = e.srcRs, d = e.tgtRs, p = !ne(r.startX) || !ne(r.startY),
            g = !ne(r.arrowStartX) || !ne(r.arrowStartY), y = !ne(r.endX) || !ne(r.endY),
            b = !ne(r.arrowEndX) || !ne(r.arrowEndY), m = 3,
            E = this.getArrowWidth(t.pstyle("width").pfValue, t.pstyle("arrow-scale").value) * this.arrowShapeWidth,
            T = m * E, S = Pr({x: r.ctrlpts[0], y: r.ctrlpts[1]}, {x: r.startX, y: r.startY}), w = S < T,
            x = Pr({x: r.ctrlpts[0], y: r.ctrlpts[1]}, {x: r.endX, y: r.endY}), C = x < T, D = !1;
        if (p || g || w) {
            D = !0;
            var A = {x: r.ctrlpts[0] - a.x, y: r.ctrlpts[1] - a.y}, L = Math.sqrt(A.x * A.x + A.y * A.y),
                R = {x: A.x / L, y: A.y / L}, I = Math.max(i, s),
                M = {x: r.ctrlpts[0] + R.x * 2 * I, y: r.ctrlpts[1] + R.y * 2 * I},
        ...
        if (y || b || C) {
            D = !0;
            var O = {x: r.ctrlpts[0] - n.x, y: r.ctrlpts[1] - n.y}, k = Math.sqrt(O.x * O.x + O.y * O.y),
                B = {x: O.x / k, y: O.y / k}, _ = Math.max(i, s),
                F = {x: r.ctrlpts[0] + B.x * 2 * _, y: r.ctrlpts[1] + B.y * 2 * _},
...
mt.storeAllpts = function (t) {
    ...
    if (e.edgeType === "multibezier" || e.edgeType === "bezier" || e.edgeType === "self" || e.edgeType === "compound") {
        ...
        var a, n;
        e.ctrlpts.length / 2 % 2 === 0 ? (a = e.allpts.length / 2 - 1, e.midX = e.allpts[a], e.midY = e.allpts[a + 1]) : (a = e.allpts.length / 2 - 3, n = .5, e.midX = ot(e.allpts[a], e.allpts[a + 2], e.allpts[a + 4], n), e.midY = ot(e.allpts[a + 1], e.allpts[a + 3], e.allpts[a + 5], n))
    } else if (e.edgeType === "straight") e.allpts = [e.startX, e.startY, e.endX, e.endY], e.midX = (e.startX + e.endX + e.arrowStartX + e.arrowEndX) / 4, e.midY = (e.startY + e.endY + e.arrowStartY + e.arrowEndY) / 4; else if (e.edgeType === "segments") {
        if (e.allpts = [], e.allpts.push(e.startX, e.startY), e.allpts.push.apply(e.allpts, e.segpts), e.allpts.push(e.endX, e.endY), e.isRound) {
            ...
            for (var i = 2; i + 3 < e.allpts.length; i += 2) {
                ...
                e.roundCorners.push(So({x: e.allpts[i - 2], y: e.allpts[i - 1]}, {
                    x: e.allpts[i],
                    y: e.allpts[i + 1],
                    radius: s
                }, {x: e.allpts[i + 2], y: e.allpts[i + 3]}, s, o))
            }
        }
        if (e.segpts.length % 4 === 0) {
            ...
            if (!e.isRound) e.midX = e.segpts[f], e.midY = e.segpts[f + 1]; else {
    ...
    if (!(!t || t.length === 0)) {
        for (var r = this, a = r.cy, n = a.hasCompoundNodes(), i = new Zt, s = function (C, D) {
            ...
            if (!(f.removed() || !f.takesUpSpace())) {
                ...
                var h = v === "unbundled-bezier" || ir(v, "segments") || v === "straight" || v === "straight-triangle" || ir(v, "taxi"),
                    d = v === "unbundled-bezier" || v === "bezier", p = c.source, g = c.target, y = p.poolIndex(),
                    b = g.poolIndex(), m = [y, b].sort(), E = s(m, h), T = i.get(E);
                T == null && (T = {eles: []}, o.push({
                    pairId: m,
                    edgeIsUnbundled: h
        ...
        for (var S = function () {
            ...
            var _ = R.srcPos = O.position(), F = R.tgtPos = k.position(), G = R.srcW = O.outerWidth(),
                Y = R.srcH = O.outerHeight(), $ = R.tgtW = k.outerWidth(), H = R.tgtH = k.outerHeight(),
                W = R.srcShape = r.nodeShapes[e.getNodeShape(O)], ee = R.tgtShape = r.nodeShapes[e.getNodeShape(k)],
                ae = R.srcCornerRadius = O.pstyle("corner-radius").value === "auto" ? "auto" : O.pstyle("corner-radius").pfValue,
                J = R.tgtCornerRadius = k.pstyle("corner-radius").value === "auto" ? "auto" : k.pstyle("corner-radius").pfValue,
                z = R.tgtRs = k._private.rscratch, V = R.srcRs = O._private.rscratch;
            R.dirCounts = {
                north: 0,
                west: 0,
                south: 0,
            ...
            for (var q = 0; q < R.eles.length; q++) {
                var Z = R.eles[q], re = Z[0]._private.rscratch, ve = Z.pstyle("curve-style").value,
                    Ie = ve === "unbundled-bezier" || ir(ve, "segments") || ir(ve, "taxi"), Te = !O.same(Z.source());
                if (!R.calculatedIntersection && O !== k && (R.hasBezier || R.hasUnbundled)) {
                    R.calculatedIntersection = !0;
                    var we = W.intersectLine(_.x, _.y, G, Y, F.x, F.y, 0, ae, V), ye = R.srcIntn = we,
                        ie = ee.intersectLine(F.x, F.y, $, H, _.x, _.y, 0, J, z), he = R.tgtIntn = ie,
                        de = R.intersectionPts = {x1: we[0], x2: ie[0], y1: we[1], y2: ie[1]},
                        xe = R.posPts = {x1: _.x, x2: F.x, y1: _.y, y2: F.y}, pe = ie[1] - we[1], De = ie[0] - we[0],
                        Pe = Math.sqrt(De * De + pe * pe);
                    ne(Pe) && Pe >= Sy || (Pe = Math.sqrt(Math.max(De * De, Na) + Math.max(pe * pe, Na)));
                    var Ne = R.vector = {x: De, y: pe}, Be = R.vectorNorm = {x: Ne.x / Pe, y: Ne.y / Pe},
                        Fe = {x: -Be.y, y: Be.x};
                    R.nodesOverlap = !ne(Pe) || ee.checkPoint(we[0], we[1], 0, $, H, F.x, F.y, J, z) || W.checkPoint(ie[0], ie[1], 0, G, Y, _.x, _.y, ae, V), R.vectorNormInverse = Fe, I = {
                        ...
                        intersectionPts: {x1: de.x2, y1: de.y2, x2: de.x1, y2: de.y1},
                        vector: {x: -Ne.x, y: -Ne.y},
                        vectorNorm: {x: -Be.x, y: -Be.y},
                        vectorNormInverse: {x: -Fe.x, y: -Fe.y}
                    }
                }
                var Ee = Te ? I : R;
...
mt.getSegmentPoints = function (t) {
    ...
    var r = e.edgeType;
    if (r === "segments") return Ic(e.segpts)
};
mt.getControlPoints = function (t) {
    var e = t[0]._private.rscratch;
    this.recalculateRenderedStyle(t);
    var r = e.edgeType;
    if (r === "bezier" || r === "multibezier" || r === "self" || r === "compound") return Ic(e.ctrlpts)
};
...
Ya.findEndpoints = function (t) {
    var e, r, a, n, i = this, s, o = t.source()[0], u = t.target()[0], l = o.position(), f = u.position(),
        c = t.pstyle("target-arrow-shape").value, v = t.pstyle("source-arrow-shape").value,
        h = t.pstyle("target-distance-from-node").pfValue, d = t.pstyle("source-distance-from-node").pfValue,
        p = o._private.rscratch, g = u._private.rscratch, y = t.pstyle("curve-style").value, b = t._private.rscratch,
        m = b.edgeType, E = ir(y, "taxi"), T = m === "self" || m === "compound",
        S = m === "bezier" || m === "multibezier" || T, w = m !== "bezier", x = m === "straight" || m === "segments",
        C = m === "segments", D = S || w || x, A = T || E, L = t.pstyle("source-endpoint"),
        R = A ? "outside-to-node" : L.value,
        I = o.pstyle("corner-radius").value === "auto" ? "auto" : o.pstyle("corner-radius").pfValue,
        M = t.pstyle("target-endpoint"), N = A ? "outside-to-node" : M.value,
        O = u.pstyle("corner-radius").value === "auto" ? "auto" : u.pstyle("corner-radius").pfValue;
    b.srcManEndpt = L, b.tgtManEndpt = M;
    var k, B, _, F,
        G = (e = (M == null || (r = M.pfValue) === null || r === void 0 ? void 0 : r.length) === 2 ? M.pfValue : null) !== null && e !== void 0 ? e : [0, 0],
        Y = (a = (L == null || (n = L.pfValue) === null || n === void 0 ? void 0 : n.length) === 2 ? L.pfValue : null) !== null && a !== void 0 ? a : [0, 0];
    if (S) {
        var $ = [b.ctrlpts[0], b.ctrlpts[1]],
            H = w ? [b.ctrlpts[b.ctrlpts.length - 2], b.ctrlpts[b.ctrlpts.length - 1]] : $;
        k = H, B = $
    } else if (x) {
        var W = C ? b.segpts.slice(0, 2) : [f.x + G[0], f.y + G[1]],
            ee = C ? b.segpts.slice(b.segpts.length - 2) : [l.x + Y[0], l.y + Y[1]];
        k = ee, B = W
    }
    if (N === "inside-to-node") s = [f.x, f.y]; else if (M.units) s = this.manualEndptToPx(u, M); else if (N === "outside-to-line") s = b.tgtIntn; else if (N === "outside-to-node" || N === "outside-to-node-or-label" ? _ = k : (N === "outside-to-line" || N === "outside-to-line-or-label") && (_ = [l.x, l.y]), s = i.nodeShapes[this.getNodeShape(u)].intersectLine(f.x, f.y, u.outerWidth(), u.outerHeight(), _[0], _[1], 0, O, g), N === "outside-to-node-or-label" || N === "outside-to-line-or-label") {
        var ae = u._private.rscratch, J = ae.labelWidth, z = ae.labelHeight, V = ae.labelX, q = ae.labelY, Z = J / 2,
            re = z / 2, ve = u.pstyle("text-valign").value;
...
Ao.storeEdgeProjections = function (t) {
    ...
    if (e.rstyle.bezierPts = null, e.rstyle.linePts = null, e.rstyle.haystackPts = null, a === "multibezier" || a === "bezier" || a === "self" || a === "compound") {
        e.rstyle.bezierPts = [];
        for (var n = 0; n + 5 < r.allpts.length; n += 4) Ay(this, t, r.allpts.slice(n, n + 6))
...
$t.recalculateNodeLabelProjection = function (t) {
    ...
    if (!fr(e)) {
        var r, a, n = t._private, i = t.width(), s = t.height(), o = t.padding(), u = t.position(),
            l = t.pstyle("text-halign").strValue, f = t.pstyle("text-valign").strValue, c = n.rscratch, v = n.rstyle;
        switch (l) {
            case"left":
                r = u.x - i / 2 - o;
                break;
...
var Pc = function (e, r) {
    ...
    var i = Ra(0, n - .001, 1), s = Ra(0, n + .001, 1), o = Qr(e, r, a, i), u = Qr(e, r, a, s);
    return Mc(o, u)
};
    ...
    if (i.mid || i.source || i.target) {
        ...
        var u = function () {
            ...
            for (var c = [], v = 0; v + 5 < a.allpts.length; v += 4) {
                var h = {x: a.allpts[v], y: a.allpts[v + 1]}, d = {x: a.allpts[v + 2], y: a.allpts[v + 3]},
                    p = {x: a.allpts[v + 4], y: a.allpts[v + 5]};
            ...
            function b(w, x, C, D, A) {
                var L = Pr(x, C), R = w.segments[w.segments.length - 1],
                    I = {p0: x, p1: C, t0: D, t1: A, startDist: R ? R.startDist + R.length : 0, length: L};
                ...
                switch (a.edgeType) {
                    ...
                    case"multibezier": {
                        for (var p = u(), g, y = 0, b = 0, m = 0; m < p.length; m++) {
                            for (var E = p[h ? m : p.length - 1 - m], T = 0; T < E.segments.length; T++) {
                                var S = E.segments[h ? T : E.segments.length - 1 - T],
                                    w = m === p.length - 1 && T === E.segments.length - 1;
                        ...
                        var x = g.cp, C = g.segment, D = (d - y) / C.length, A = C.t1 - C.t0,
                            L = h ? C.t0 + A * D : C.t1 - A * D;
                    ...
                    case"haystack": {
                        for (var R = 0, I, M, N, O, k = a.allpts.length, B = 0; B + 3 < k && (h ? (N = {
                            x: a.allpts[B],
                            y: a.allpts[B + 1]
                        }, O = {x: a.allpts[B + 2], y: a.allpts[B + 3]}) : (N = {
                            x: a.allpts[k - 2 - B],
                            y: a.allpts[k - 1 - B]
                        }, O = {
                            x: a.allpts[k - 4 - B],
...
$t.applyPrefixedLabelDimensions = function (t, e) {
    ...
    if (Dt(r.rscratch, "prefixedLabelDimsKey", e) !== n) {
        ...
        var i = this.calculateLabelDimensions(t, a), s = t.pstyle("line-height").pfValue,
            o = t.pstyle("text-wrap").strValue, u = Dt(r.rscratch, "labelWrapCachedLines", e) || [],
            l = o !== "wrap" ? 1 : Math.max(u.length, 1), f = i.height / l, c = f * s, v = i.width,
            h = i.height + (l - 1) * (s - 1) * f;
...
$t.getLabelText = function (t, e) {
    var r = t._private, a = e ? e + "-" : "", n = t.pstyle(a + "label").strValue, i = t.pstyle("text-transform").value,
        s = function (Y, $) {
...
$t.getLabelJustification = function (t) {
    ...
    if (e === "auto") if (t.isNode()) switch (r) {
        ...
        default:
            return "center"
    } else return "center"; else return e
};
$t.calculateLabelDimensions = function (t, e) {
    var r = this, a = r.cy.window(), n = a.document, i = 0, s = t.pstyle("font-style").strValue,
        o = t.pstyle("font-size").pfValue, u = t.pstyle("font-family").strValue, l = t.pstyle("font-weight").strValue,
        f = this.labelCalcCanvas, c = this.labelCalcCanvasContext;
    if (!f) {
...
$t.calculateLabelAngle = function (t, e) {
    var r = t._private, a = r.rscratch, n = t.isEdge(), i = e ? e + "-" : "", s = t.pstyle(i + "text-rotation"),
        o = s.strValue;
...
Oc.getNodeShape = function (t) {
    ...
    if (r === "cutrectangle" && (t.width() < $l || t.height() < $l)) return Yl || (Ge("The `cutrectangle` node shape can not be used at small sizes so `rectangle` is used instead"), Yl = !0), "rectangle";
...
var kc = {};
[Br, On, mt, Ya, Ao, $t, Oc, jn, ei].forEach(function (t) {
    be(kc, t)
});
var Nc = {};
...
ua.binder = function (t) {
    ...
    var s = function (u, l, f) {
        ...
        return a && e.supportsPassiveEvents && (c[2] = {
            ...
            passive: !1,
            once: !1
        }), e.bindings.push({target: t, args: c}), (t.addEventListener || t.on).apply(t, c), this
    };
...
ua.load = function () {
    var t = this, e = t.cy.window(), r = function (P) {
        ...
        for (var j = 0; j < U.length; j++) {
            var oe = U[j];
            P.emit({originalEvent: X, type: oe, position: K})
        }
    }, i = function (P) {
        return P.shiftKey || P.metaKey || P.ctrlKey
    }, s = function (P, U) {
        var X = !0;
        if (t.cy.hasCompoundNodes() && P && P.pannable()) for (var K = 0; U && K < U.length; K++) {
            var P = U[K];
        ...
        var X = U.addToList, K = X.has(P);
        !K && P.grabbable() && !P.locked() && (X.merge(P), o(P))
    }, d = function (P, U) {
        ...
        if (!(U.inDragLayer == null && U.addToList == null) && P.cy().hasCompoundNodes()) {
            var X = P.ancestors().orphans();
            if (!X.same(P)) {
                var K = X.descendants().spawnSelf().merge(X).unmerge(P).unmerge(P.descendants()),
                    j = K.connectedEdges();
    ...
    }), t.container.parentNode && t.removeObserver.observe(t.container.parentNode, {childList: !0})) : t.registerBinding(t.container, "DOMNodeRemoved", function (Q) {
        t.destroy()
    });
    var S = Va(function () {
        t.cy.resize()
    }, 100);
    E && (t.styleObserver = new MutationObserver(S), t.styleObserver.observe(t.container, {attributes: !0})), t.registerBinding(e, "resize", S), T && (t.resizeObserver = new ResizeObserver(S), t.resizeObserver.observe(t.container));
    var w = function (P, U) {
        for (; P != null;) U(P), P = P.parentNode
    }, x = function () {
    ...
    var C = function () {
        ...
        for (var U = t.findContainerClientCoords(), X = U[0], K = U[1], j = U[2], oe = U[3], te = P.touches ? P.touches : [P], fe = !1, le = 0; le < te.length; le++) {
            var me = te[le];
    ...
    t.registerBinding(t.container, "mousedown", function (P) {
        if (D(P) && !(t.hoverData.which === 1 && P.which !== 1)) {
            ...
            var U = t.cy, X = [P.clientX, P.clientY], K = t.projectIntoViewport(X[0], X[1]), j = t.selection,
                oe = t.findNearestElements(K[0], K[1], !0, !1), te = oe[0], fe = t.dragData.possibleDragElements;
            t.hoverData.mdownPos = K, t.hoverData.mdownGPos = X;
            var le = function (Le) {
                return {originalEvent: P, type: Le, position: {x: K[0], y: K[1]}}
            }, me = function () {
            ...
            if (P.which == 3) {
                ...
                var Ae = {originalEvent: P, type: "cxttapstart", position: {x: K[0], y: K[1]}};
                te ? (te.activate(), te.emit(Ae), t.hoverData.down = te) : U.emit(Ae), t.hoverData.downTime = new Date().getTime(), t.hoverData.cxtDragged = !1
            } else if (P.which == 1) {
                te && te.activate();
                {
                    if (te != null && t.nodeIsGrabbable(te)) {
                        ...
                        if (c(te), !te.selected()) fe = t.dragData.possibleDragElements = U.collection(), g(te, {addToList: fe}), te.emit(le("grabon")).emit(le("grab")); else {
                    ...
                    t.hoverData.down = te, t.hoverData.downs = oe, t.hoverData.downTime = new Date().getTime()
                }
    ...
    t.registerBinding([e, A], "mousemove", function (P) {
        ...
        if (!(!U && !D(P))) {
            var X = !1, K = t.cy, j = K.zoom(), oe = [P.clientX, P.clientY], te = t.projectIntoViewport(oe[0], oe[1]),
                fe = t.hoverData.mdownPos, le = t.hoverData.mdownGPos, me = t.selection, Ae = null;
            !t.hoverData.draggingEles && !t.hoverData.dragging && !t.hoverData.selecting && (Ae = t.findNearestElement(te[0], te[1], !0, !1));
            var Ce = t.hoverData.last, ce = t.hoverData.down, Re = [te[0] - me[2], te[1] - me[3]],
                Le = t.dragData.possibleDragElements, je;
            if (le) {
            ...
            X = !0, n(Ae, ["mousemove", "vmousemove", "tapdrag"], P, {x: te[0], y: te[1]});
            var Ze = function (Rt) {
                return {originalEvent: P, type: Rt, position: {x: te[0], y: te[1]}}
            }, Ht = function () {
            ...
            if (t.hoverData.which === 3) {
                ...
                if (X = !0, K.panningEnabled() && K.userPanningEnabled()) {
                    ...
                    if (t.hoverData.justStartedPan) {
                        ...
                        _r = {x: (te[0] - Wa[0]) * j, y: (te[1] - Wa[1]) * j}, t.hoverData.justStartedPan = !1
                ...
                if (je) {
                    if (!t.hoverData.dragging && K.boxSelectionEnabled() && (ft || !K.panningEnabled() || !K.userPanningEnabled())) Ht(); else if (!t.hoverData.selecting && K.panningEnabled() && K.userPanningEnabled()) {
                ...
                if (ce && ce.pannable() && ce.active() && ce.unactivate(), (!ce || !ce.grabbed()) && Ae != Ce && (Ce && n(Ce, ["mouseout", "tapdragout"], P, {
                    ...
                    x: te[0],
                    y: te[1]
                }), t.hoverData.last = Ae), ce) if (je) {
                    if (K.boxSelectionEnabled() && ft) ce && ce.grabbed() && (y(Le), ce.emit(Ze("freeon")), Le.emit(Ze("free")), t.dragData.didDrag && (ce.emit(Ze("dragfreeon")), Le.emit(Ze("dragfree")))), Ht(); else if (ce && ce.grabbed() && t.nodeIsDraggable(ce)) {
                        var Tt = !t.dragData.didDrag;
                        Tt && t.redrawHint("eles", !0), t.dragData.didDrag = !0, t.hoverData.draggingEles || p(Le, {inDragLayer: !0});
                        var gt = {x: 0, y: 0};
            ...
            if (me[2] = te[0], me[3] = te[1], X) return P.stopPropagation && P.stopPropagation(), P.preventDefault && P.preventDefault(), !1
        }
    }, !1);
    var L, R, I;
    t.registerBinding(e, "mouseup", function (P) {
        if (!(t.hoverData.which === 1 && P.which !== 1 && t.hoverData.capture)) {
            ...
            if (U) {
                ...
                var X = t.cy, K = t.projectIntoViewport(P.clientX, P.clientY), j = t.selection,
                    oe = t.findNearestElement(K[0], K[1], !0, !1), te = t.dragData.possibleDragElements,
                    fe = t.hoverData.down, le = i(P);
                ...
                var me = function (Xe) {
                    return {originalEvent: P, type: Xe, position: {x: K[0], y: K[1]}}
                };
                if (t.hoverData.which === 3) {
                    var Ae = me("cxttapend");
                    ...
                    if (n(oe, ["mouseup", "tapend", "vmouseup"], P, {
                        x: K[0],
                        y: K[1]
                    }), !t.dragData.didDrag && !t.hoverData.dragged && !t.hoverData.selecting && !t.hoverData.isOverThresholdDrag && (n(fe, ["click", "tap", "vclick"], P, {
                        x: K[0],
                        y: K[1]
                    }), R = !1, P.timeStamp - I <= X.multiClickDebounceTime() ? (L && clearTimeout(L), R = !0, I = null, n(fe, ["dblclick", "dbltap", "vdblclick"], P, {
                        x: K[0],
                        y: K[1]
                    })) : (L = setTimeout(function () {
                        R || n(fe, ["oneclick", "onetap", "voneclick"], P, {x: K[0], y: K[1]})
                    }, X.multiClickDebounceTime()), I = P.timeStamp)), fe == null && !t.dragData.didDrag && !t.hoverData.selecting && !t.hoverData.dragged && !i(P) && (X.$(r).unselect(["tapunselect"]), te.length > 0 && t.redrawHint("eles", !0), t.dragData.possibleDragElements = te = X.collection()), oe == fe && !t.dragData.didDrag && !t.hoverData.selecting && oe != null && oe._private.selectable && (t.hoverData.dragging || (X.selectionType() === "additive" || le ? oe.selected() ? oe.unselect(["tapunselect"]) : oe.select(["tapselect"]) : le || (X.$(r).unmerge(oe).unselect(["tapunselect"]), oe.select(["tapselect"]))), t.redrawHint("eles", !0)), t.hoverData.selecting) {
    ...
    var M = [], N = 4, O, k = 1e5, B = function (P, U) {
        for (var X = 0; X < P.length; X++) if (P[X] % U !== 0) return !1;
        return !0
    }, _ = function (P) {
        for (var U = Math.abs(P[0]), X = 1; X < P.length; X++) if (Math.abs(P[X]) !== U) return !1;
        return !0
    }, F = function (P) {
        var U = !1, X = P.deltaY;
        if (X == null && (P.wheelDeltaY != null ? X = P.wheelDeltaY / 4 : P.wheelDelta != null && (X = P.wheelDelta / 4)), X !== 0) {
            ...
            } else M.push(X), U = !0; else O && (k = Math.min(Math.abs(X), k));
            if (!t.scrollingPage) {
                var te = t.cy, fe = te.zoom(), le = te.pan(), me = t.projectIntoViewport(P.clientX, P.clientY),
                    Ae = [me[0] * fe + le.x, me[1] * fe + le.y];
                ...
                if (te.panningEnabled() && te.userPanningEnabled() && te.zoomingEnabled() && te.userZoomingEnabled()) {
                    ...
                    P.type === "gesturechange" && (Re = t.gestureStartZoom * P.scale), te.zoom({
                        level: Re,
                        renderedPosition: {x: Ae[0], y: Ae[1]}
                    }), te.emit({
    ...
    t.registerBinding(t.container, "wheel", F, !0), t.registerBinding(e, "scroll", function (P) {
        ...
        t.cy.emit({originalEvent: P, type: "mouseout", position: {x: U[0], y: U[1]}})
    }, !1), t.registerBinding(t.container, "mouseover", function (P) {
        var U = t.projectIntoViewport(P.clientX, P.clientY);
        t.cy.emit({originalEvent: P, type: "mouseover", position: {x: U[0], y: U[1]}})
    }, !1);
    var G, Y, $, H, W, ee, ae, J, z, V, q, Z, re, ve = function (P, U, X, K) {
        return Math.sqrt((X - P) * (X - P) + (K - U) * (K - U))
    }, Ie = function (P, U, X, K) {
        return (X - P) * (X - P) + (K - U) * (K - U)
    }, Te;
    t.registerBinding(t.container, "touchstart", Te = function (P) {
        if (t.hasTouchStarted = !0, !!D(P)) {
            ...
            var oe = function (ft) {
                return {originalEvent: P, type: ft, position: {x: X[0], y: X[1]}}
            };
            if (P.touches[1]) {
                t.touchData.singleTouchMoved = !0, y(t.dragData.touchDragEles);
                var te = t.findContainerClientCoords();
                z = te[0], V = te[1], q = te[2], Z = te[3], G = P.touches[0].clientX - z, Y = P.touches[0].clientY - V, $ = P.touches[1].clientX - z, H = P.touches[1].clientY - V, re = 0 <= G && G <= q && 0 <= $ && $ <= q && 0 <= Y && Y <= Z && 0 <= H && H <= Z;
                var fe = U.pan(), le = U.zoom();
                W = ve(G, Y, $, H), ee = Ie(G, Y, $, H), ae = [(G + $) / 2, (Y + H) / 2], J = [(ae[0] - fe.x) / le, (ae[1] - fe.y) / le];
                var me = 200, Ae = me * me;
            ...
            if (P.touches[2]) U.boxSelectionEnabled() && P.preventDefault(); else if (!P.touches[1]) {
                if (P.touches[0]) {
                    ...
                    if (Le != null && (Le.activate(), t.touchData.start = Le, t.touchData.starts = Re, t.nodeIsGrabbable(Le))) {
                        ...
                        }), p(Xe, {addToList: je})) : g(Le, {addToList: je}), c(Le), Le.emit(oe("grabon")), Xe ? Xe.forEach(function (et) {
                            et.emit(oe("grab"))
                        }) : Le.emit(oe("grab"))
                    }
            ...
            if (P.touches.length >= 1) {
                for (var bt = t.touchData.startPosition = [null, null, null, null, null, null], Ke = 0; Ke < X.length; Ke++) bt[Ke] = K[Ke] = X[Ke];
                var st = P.touches[0];
    ...
    t.registerBinding(e, "touchmove", we = function (P) {
        ...
        if (!(!U && !D(P))) {
            ...
            var le = function (pv) {
                return {originalEvent: P, type: pv, position: {x: j[0], y: j[1]}}
            }, me = t.touchData.startGPosition, Ae;
            if (U && P.touches[0] && me) {
                for (var Ce = [], ce = 0; ce < j.length; ce++) Ce[ce] = j[ce] - oe[ce];
                var Re = P.touches[0].clientX - me[0], Le = Re * Re, je = P.touches[0].clientY - me[1], Xe = je * je,
                    bt = Le + Xe;
                Ae = bt >= t.touchTapThreshold2
            }
            if (U && t.touchData.cxt) {
                P.preventDefault();
                var Ke = P.touches[0].clientX - z, st = P.touches[0].clientY - V, et = P.touches[1].clientX - z,
                    ft = P.touches[1].clientY - V, tr = Ie(Ke, st, et, ft), Ze = tr / ee, Ht = 150, Xt = Ht * Ht,
                    _r = 1.5, Wa = _r * _r;
                if (Ze >= Wa || tr >= Xt) {
            ...
            if (U && t.touchData.cxt) {
            ...
            } else if (U && P.touches[2] && K.boxSelectionEnabled()) P.preventDefault(), t.data.bgActivePosistion = void 0, this.lastThreeTouch = +new Date, t.touchData.selecting || K.emit(le("boxstart")), t.touchData.selecting = !0, t.touchData.didSelect = !0, X[4] = 1, !X || X.length === 0 || X[0] === void 0 ? (X[0] = (j[0] + j[2] + j[4]) / 3, X[1] = (j[1] + j[3] + j[5]) / 3, X[2] = (j[0] + j[2] + j[4]) / 3 + 1, X[3] = (j[1] + j[3] + j[5]) / 3 + 1) : (X[2] = (j[0] + j[2] + j[4]) / 3, X[3] = (j[1] + j[3] + j[5]) / 3), t.redrawHint("select", !0), t.redraw(); else if (U && P.touches[1] && !t.touchData.didSelect && K.zoomingEnabled() && K.panningEnabled() && K.userZoomingEnabled() && K.userPanningEnabled()) {
                ...
                var Rt = t.touchData.start, Ke = P.touches[0].clientX - z, st = P.touches[0].clientY - V,
                    et = P.touches[1].clientX - z, ft = P.touches[1].clientY - V, Po = ve(Ke, st, et, ft), ov = Po / W;
                if (re) {
                    var uv = Ke - G, lv = st - Y, fv = et - $, cv = ft - H, vv = (uv + fv) / 2, hv = (lv + cv) / 2,
                        ca = K.zoom(), ti = ca * ov, Ka = K.pan(), Mo = J[0] * ca + Ka.x, Oo = J[1] * ca + Ka.y,
                        dv = {x: -ti / ca * (Mo - Ka.x - vv) + Mo, y: -ti / ca * (Oo - Ka.y - hv) + Oo};
                    if (Rt && Rt.active()) {
                        var gt = t.dragData.touchDragEles;
                    ...
                    }), K.emit(le("pinchzoom")), W = Po, G = Ke, Y = st, $ = et, H = ft, t.pinching = !0
                }
                if (P.touches[0]) {
                    var fe = t.projectIntoViewport(P.touches[0].clientX, P.touches[0].clientY);
                    j[0] = fe[0], j[1] = fe[1]
                ...
                if (!t.hoverData.draggingEles && !t.swipePanning && (Tt = t.findNearestElement(j[0], j[1], !0, !0)), U && Ot != null && P.preventDefault(), U && Ot != null && t.nodeIsDraggable(Ot)) if (Ae) {
                    var gt = t.dragData.touchDragEles, ko = !t.dragData.didDrag;
                    ko && p(gt, {inDragLayer: !0}), t.dragData.didDrag = !0;
                    var va = {x: 0, y: 0};
                ...
                if (n(Ot || Tt, ["touchmove", "tapdrag", "vmousemove"], P, {
                    x: j[0],
                    y: j[1]
                }), (!Ot || !Ot.grabbed()) && Tt != ri && (ri && ri.emit(le("tapdragout")), Tt && Tt.emit(le("tapdragover"))), t.touchData.last = Tt, U) for (var Ct = 0; Ct < j.length; Ct++) j[Ct] && t.touchData.startPosition[Ct] && Ae && (t.touchData.singleTouchMoved = !0);
    ...
    if (t.registerBinding(e, "touchend", ie = function (P) {
        ...
        if (X) P.touches.length === 0 && (t.touchData.capture = !1), P.preventDefault(); else return;
        var K = t.selection;
        ...
        var me = function (Xt) {
            return {originalEvent: P, type: Xt, position: {x: te[0], y: te[1]}}
        };
        U && U.unactivate();
        var Ae;
        if (t.touchData.cxt) {
        ...
        if (U != null && U.unactivate(), P.touches[2]) t.data.bgActivePosistion = void 0, t.redrawHint("select", !0); else if (!P.touches[1]) {
            if (!P.touches[0]) {
                if (!P.touches[0]) {
                    ...
                    if (U != null) {
                        ...
                        n(Xe, ["touchend", "tapend", "vmouseup", "tapdragout"], P, {x: te[0], y: te[1]})
                    }
                    var bt = t.touchData.startPosition[0] - te[0], Ke = bt * bt,
                        st = t.touchData.startPosition[1] - te[1], et = st * st, ft = Ke + et, tr = ft * oe * oe;
                    t.touchData.singleTouchMoved || (U || j.$(":selected").unselect(["tapunselect"]), n(U, ["tap", "vclick"], P, {
                        ...
                        he || n(U, ["onetap", "voneclick"], P, {x: te[0], y: te[1]})
        ...
        var pe = [], De = function (P) {
            ...
            return {event: P, touch: De(P)}
        }, Ne = function (P) {
            pe.push(Pe(P))
        }, Be = function (P) {
            for (var U = 0; U < pe.length; U++) {
                var X = pe[U];
                if (X.event.pointerId === P.pointerId) {
                    pe.splice(U, 1);
                    return
                }
            }
            ...
            var U = pe.filter(function (X) {
                return X.event.pointerId === P.pointerId
            })[0];
...
jt.generatePolygon = function (t, e) {
    return this.nodeShapes[t] = {
        renderer: this, name: t, points: e, draw: function (a, n, i, s, o, u) {
...
jt.generateEllipse = function () {
    return this.nodeShapes.ellipse = {
        renderer: this, name: "ellipse", draw: function (e, r, a, n, i, s) {
...
jt.generateRoundPolygon = function (t, e) {
    return this.nodeShapes[t] = {
        ...
        getOrCreateCorners: function (a, n, i, s, o, u, l) {
            ...
            var f = i / 2, c = s / 2;
            o = o === "auto" ? Bf(i, s) : o;
            for (var v = new Array(e.length / 2), h = 0; h < e.length / 2; h++) v[h] = {
                x: a + f * e[h * 2],
                y: n + c * e[h * 2 + 1]
            };
...
jt.generateCutRectangle = function () {
    return this.nodeShapes["cut-rectangle"] = this.nodeShapes.cutrectangle = {
        ...
        generateCutTrianglePts: function (e, r, a, n, i) {
            var s = i === "auto" ? this.cornerLength : i, o = r / 2, u = e / 2, l = a - u, f = a + u, c = n - o,
                v = n + o;
            return {
        ...
        intersectLine: function (e, r, a, n, i, s, o, u) {
            var l = this.generateCutTrianglePts(a + 2 * o, n + 2 * o, e, r, u),
                f = [].concat.apply([], [l.topLeft.splice(0, 4), l.topRight.splice(0, 4), l.bottomRight.splice(0, 4), l.bottomLeft.splice(0, 4)]);
            return Ia(i, s, f, e, r)
        },
        checkPoint: function (e, r, a, n, i, s, o, u) {
            var l = u === "auto" ? this.cornerLength : u;
            if (Jt(e, r, this.points, s, o, n, i - 2 * l, [0, -1], a) || Jt(e, r, this.points, s, o, n - 2 * l, i, [0, -1], a)) return !0;
...
jt.generateBarrel = function () {
    return this.nodeShapes.barrel = {
        renderer: this, name: "barrel", points: wt(4, 0), draw: function (e, r, a, n, i, s) {
            this.renderer.nodeShapeImpl(this.name, e, r, a, n, i)
        }, intersectLine: function (e, r, a, n, i, s, o, u) {
            var l = .15, f = .5, c = .85, v = this.generateBarrelBezierPts(a + 2 * o, n + 2 * o, e, r),
                h = function (g) {
                    var y = Qr({x: g[0], y: g[1]}, {x: g[2], y: g[3]}, {x: g[4], y: g[5]}, l),
                        b = Qr({x: g[0], y: g[1]}, {x: g[2], y: g[3]}, {x: g[4], y: g[5]}, f),
                        m = Qr({x: g[0], y: g[1]}, {x: g[2], y: g[3]}, {x: g[4], y: g[5]}, c);
            ...
            var i = r / 2, s = e / 2, o = a - s, u = a + s, l = n - i, f = n + i, c = Fs(e, r), v = c.heightOffset,
                h = c.widthOffset, d = c.ctrlPtOffsetPct * e, p = {
            ...
            if (Jt(e, r, this.points, s, o, n, i - 2 * f, [0, -1], a) || Jt(e, r, this.points, s, o, n - 2 * c, i, [0, -1], a)) return !0;
            for (var v = this.generateBarrelBezierPts(n, i, s, o), h = function (x, C, D) {
                var A = D[4], L = D[2], R = D[0], I = D[5], M = D[1], N = Math.min(A, R), O = Math.max(A, R),
                    k = Math.min(I, M), B = Math.max(I, M);
                if (N <= x && x <= O && k <= C && C <= B) {
                ...
                if (b != null) {
                    ...
                    if (y.isTop && S <= r || y.isBottom && r <= S) return !0
                }
            }
            return !1
        }
...
jt.generateBottomRoundrectangle = function () {
    return this.nodeShapes["bottom-round-rectangle"] = this.nodeShapes.bottomroundrectangle = {
        ...
        intersectLine: function (e, r, a, n, i, s, o, u) {
            var l = e - (a / 2 + o), f = r - (n / 2 + o), c = f, v = e + (a / 2 + o),
                h = or(i, s, e, r, l, f, v, c, !1);
            return h.length > 0 ? h : kf(i, s, e, r, a, n, o, u)
        },
        checkPoint: function (e, r, a, n, i, s, o, u) {
            u = u === "auto" ? vr(n, i) : u;
            var l = 2 * u;
            if (Jt(e, r, this.points, s, o, n, i - l, [0, -1], a) || Jt(e, r, this.points, s, o, n - l, i, [0, -1], a)) return !0;
...
jt.registerNodeShapes = function () {
    ...
    var a = new Array(20);
    {
        var n = Bs(5, 0), i = Bs(5, Math.PI / 5), s = .5 * (3 - Math.sqrt(5));
        s *= 1.57;
    ...
    a = Nf(a), this.generatePolygon("star", a), this.generatePolygon("vee", [-1, -1, 0, -.333, 1, -1, 0, 1]), this.generatePolygon("rhomboid", [-1, -1, .333, -1, 1, 1, -.333, 1]), this.generatePolygon("right-rhomboid", [-.333, -1, 1, -1, .333, 1, -1, 1]), this.nodeShapes.concavehexagon = this.generatePolygon("concave-hexagon", [-1, -.95, -.75, 0, -1, .95, 1, .95, .75, 0, 1, -.95]);
    {
        var u = [-1, -1, .25, -1, 1, 0, .25, 1, -1, 1];
...
la.init = function (t) {
    ...
    if (a) {
        var n = a.document, i = n.head, s = "__________cytoscape_stylesheet", o = "__________cytoscape_container",
...
[Do, kc, Nc, ua, jt, Ha].forEach(function (t) {
    be(la, t)
});
var Ds = 1e3 / 60, Fc = {
            ...
            return function () {
                ...
                if (!a.dequeueingSetup) {
                    ...
                    var i = Va(function () {
                        ...
                        var c = Qt(), v = n.averageRedrawTime, h = n.lastRedrawTime, d = [], p = n.cy.extent(),
                            g = n.getPixelRatio();
                        for (l || n.flushRenderedStyleQueue(); ;) {
                            ...
                            } else if (m >= e.deqNoDrawCost * Ds) break;
                            var T = e.deq(a, g, p);
                            if (T.length > 0) for (var S = 0; S < T.length; S++) d.push(T[S]); else break
                        }
        ...
        return mr(t, [{
            key: "getIdsFor", value: function (r) {
    ...
    }(), Xl = 25, un = 50, bn = -4, Zs = 3, _c = 7.99, Py = 8, My = 1024, Oy = 1024, ky = 1024, Ny = .2, By = .8, Fy = 10,
    _y = .15, Gy = .1, zy = .9, Vy = .9, Uy = 100, qy = 1,
    Zr = {dequeue: "dequeue", downscale: "downscale", highQuality: "highQuality"}, $y = ht({
        getKey: null,
...
it.getElement = function (t, e, r, a, n) {
    ...
    if (a == null && (a = Math.ceil(co(o * r))), a < bn) a = bn; else if (o >= _c || a > Zs) return null;
    ...
    var d;
    if (f <= Xl ? d = Xl : f <= un ? d = un : d = Math.ceil(f / un) * un, f > ky || c > Oy) return null;
    ...
    if (g.context.setTransform(1, 0, 0, 1, 0, 0), g.context.clearRect(g.usedWidth, 0, c, d), b(C)) D(); else if (b(S)) if (E) {
        for (var A = S.level; A > a; A--) C = i.getElement(t, e, r, A, Zr.downscale);
        D()
    } else return i.queueElement(t, S.level - 1), S; else {
        var L;
...
it.recycleTexture = function (t, e) {
    for (var r = this, a = r.getTextureQueue(t), n = r.getRetiredTextureQueue(t), i = 0; i < n.length; i++) {
        var s = n[i];
        if (s.width >= e) return s.retired = !1, s.usedWidth = 0, s.invalidatedWidth = 0, s.fullnessChecks = 0, fo(s.eleCaches), s.context.setTransform(1, 0, 0, 1, 0, 0), s.context.clearRect(0, 0, s.width, s.height), cr(n, s), a.push(s), s
    }
};
it.queueElement = function (t, e) {
    var r = this, a = r.getElementQueue(), n = r.getElementKeyToQueue(), i = this.getKey(t), s = n[i];
    if (s) s.level = Math.max(s.level, e), s.eles.merge(t), s.reqs++, a.updateItem(s); else {
...
var Yy = 1, Ca = -4, kn = 2, Hy = 3.99, Xy = 50, Wy = 50, Ky = .15, Zy = .1, Qy = .9, Jy = .9, jy = 1, Wl = 250,
    em = 4e3 * 4e3, Kl = 32767, tm = !0, Gc = function (e) {
...
dt.makeLayer = function (t, e) {
    var r = Math.pow(2, e), a = Math.ceil(t.w * r), n = Math.ceil(t.h * r), i = this.renderer.makeOffscreenCanvas(a, n),
        s = {
            id: Zl = ++Zl % rm,
            bb: t,
            level: e,
...
dt.getLayers = function (t, e, r) {
    ...
    if (a.firstGet = !1, r == null) {
        if (r = Math.ceil(co(s * e)), r < Ca) r = Ca; else if (s >= Hy || r > kn) return null
    }
    a.validateLayersElesOrdering(r, t);
    var u = a.layersByLevel, l = Math.pow(2, r), f = u[r] = u[r] || [], c, v = a.levelIsComplete(r, t), h,
        d = function () {
            var D = function (M) {
                if (a.validateLayersElesOrdering(M, t), a.levelIsComplete(M, t)) return h = u[M], !0
            }, A = function (M) {
                if (!h) for (var N = r + M; Ca <= N && N <= kn && !D(N); N += M) ;
            };
            A(1), A(-1);
    ...
    if (!v) d(); else return f;
    var p = function () {
        if (!c) {
            c = Et();
            for (var D = 0; D < t.length; D++) jh(c, t[D].boundingBox())
        }
        return c
    }, g = function (D) {
        D = D || {};
...
dt.updateElementsInLayers = function (t, e) {
    for (var r = this, a = Fa(t[0]), n = 0; n < t.length; n++) for (var i = a ? null : t[n], s = a ? t[n] : t[n].ele, o = s._private.rscratch, u = o.imgLayerCaches = o.imgLayerCaches || {}, l = Ca; l <= kn; l++) {
        var f = u[l];
...
Yt.drawCachedElement = function (t, e, r, a, n, i) {
    var s = this, o = s.data, u = o.eleTxrCache, l = o.lblTxrCache, f = o.slbTxrCache, c = o.tlbTxrCache,
        v = e.boundingBox(), h = i === !0 ? u.reasons.highQuality : null;
...
er.drawEdge = function (t, e, r) {
    var a = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !0,
        ...
        i = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : !0, s = this, o = e._private.rscratch;
    if (!(i && !e.visible()) && !(o.badLine || o.allpts == null || isNaN(o.allpts[0]))) {
        var u;
        r && (u = r, t.translate(-u.x1, -u.y1));
        var l = i ? e.pstyle("opacity").value : 1, f = i ? e.pstyle("line-opacity").value : 1,
            c = e.pstyle("curve-style").value, v = e.pstyle("line-style").value, h = e.pstyle("width").pfValue,
            d = e.pstyle("line-cap").value, p = e.pstyle("line-outline-width").value,
            g = e.pstyle("line-outline-color").value, y = l * f, b = l * f, m = function () {
                ...
                var M = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : y;
                if (t.lineWidth = h + p, t.lineCap = d, p > 0) s.colorStrokeStyle(t, g[0], g[1], g[2], M); else {
                    t.lineCap = "butt";
                    return
                }
        ...
        if (C) {
            var D = e.pstyle("ghost-offset-x").pfValue, A = e.pstyle("ghost-offset-y").pfValue,
                L = e.pstyle("ghost-opacity").value, R = y * L;
...
var Vc = function (e) {
    ...
    return function (r, a) {
        if (a.visible()) {
            ...
            if (n !== 0) {
                var i = this, s = i.usePaths(), o = a._private.rscratch, u = a.pstyle("".concat(e, "-padding")).pfValue,
                    l = 2 * u, f = a.pstyle("".concat(e, "-color")).value;
...
er.drawEdgePath = function (t, e, r, a) {
    var n = t._private.rscratch, i = e, s, o = !1, u = this.usePaths(), l = t.pstyle("line-dash-pattern").pfValue,
...
er.drawEdgeTrianglePath = function (t, e, r) {
    ...
    for (var a = t.pstyle("width").pfValue, n = 0; n + 1 < r.length; n += 2) {
        var i = [r[n + 2] - r[n], r[n + 3] - r[n + 1]], s = Math.sqrt(i[0] * i[0] + i[1] * i[1]),
            o = [i[1] / s, -i[0] / s], u = [o[0] * a / 2, o[1] * a / 2];
...
er.drawArrowhead = function (t, e, r, a, n, i, s) {
    if (!(isNaN(a) || a == null || isNaN(n) || n == null || isNaN(i) || i == null)) {
        ...
        if (u !== "none") {
            var l = e.pstyle(r + "-arrow-fill").value === "hollow" ? "both" : "filled",
                f = e.pstyle(r + "-arrow-fill").value, c = e.pstyle("width").pfValue, v = e.pstyle(r + "-arrow-width"),
                h = v.value === "match-line" ? c : v.pfValue;
            v.units === "%" && (h *= c);
...
er.drawArrowShape = function (t, e, r, a, n, i, s, o, u) {
    var l = this, f = this.usePaths() && n !== "triangle-cross", c = !1, v, h = e, d = {x: s, y: o},
...
Lo.drawInscribedImage = function (t, e, r, a, n) {
    var i = this, s = r.position(), o = s.x, u = s.y, l = r.cy().style(), f = l.getIndexedStyle.bind(l),
        c = f(r, "background-fit", "value", a), v = f(r, "background-repeat", "value", a), h = r.width(),
        d = r.height(), p = r.padding() * 2,
        g = h + (f(r, "background-width-relative-to", "value", a) === "inner" ? 0 : p),
        y = d + (f(r, "background-height-relative-to", "value", a) === "inner" ? 0 : p), b = r._private.rscratch,
        m = f(r, "background-clip", "value", a), E = m === "node", T = f(r, "background-image-opacity", "value", a) * n,
        S = f(r, "background-image-smoothing", "value", a), w = r.pstyle("corner-radius").value;
    ...
    if (f(r, "background-width", "value", a) !== "auto" && (f(r, "background-width", "units", a) === "%" ? D = f(r, "background-width", "pfValue", a) * g : D = f(r, "background-width", "pfValue", a)), f(r, "background-height", "value", a) !== "auto" && (f(r, "background-height", "units", a) === "%" ? A = f(r, "background-height", "pfValue", a) * y : A = f(r, "background-height", "pfValue", a)), !(D === 0 || A === 0)) {
        ...
        var R = o - g / 2, I = f(r, "background-position-x", "units", a),
            M = f(r, "background-position-x", "pfValue", a);
        I === "%" ? R += (g - D) * M : R += M;
        var N = f(r, "background-offset-x", "units", a), O = f(r, "background-offset-x", "pfValue", a);
        N === "%" ? R += (g - D) * O : R += O;
        var k = u - y / 2, B = f(r, "background-position-y", "units", a),
            _ = f(r, "background-position-y", "pfValue", a);
        B === "%" ? k += (y - A) * _ : k += _;
        ...
        if (S === "no" && $ ? (i.setImgSmoothing(t, !1), H = !0) : S === "yes" && !$ && (i.setImgSmoothing(t, !0), H = !0), v === "no-repeat") E && (t.save(), b.pathCache ? t.clip(b.pathCache) : (i.nodeShapes[i.getNodeShape(r)].draw(t, o, u, g, y, w, b), t.clip())), i.safeDrawImage(t, e, 0, 0, x, C, R, k, D, A), E && t.restore(); else {
...
Fr.drawElementText = function (t, e, r, a, n) {
    ...
    if (e.isNode()) {
        ...
        var l = e.element()._private.rscratch.badLine, f = e.pstyle("label"), c = e.pstyle("source-label"),
            v = e.pstyle("target-label");
...
Fr.setupTextStyle = function (t, e) {
    var r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !0, a = e.pstyle("font-style").strValue,
        n = e.pstyle("font-size").pfValue + "px", i = e.pstyle("font-family").strValue,
        s = e.pstyle("font-weight").strValue, o = r ? e.effectiveOpacity() * e.pstyle("text-opacity").value : 1,
        u = e.pstyle("text-outline-opacity").value * o, l = e.pstyle("color").value,
...
Fr.drawText = function (t, e, r) {
    var a = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !0,
        n = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : !0, i = e._private, s = i.rscratch,
    ...
    if (!(n && (o === 0 || e.pstyle("text-opacity").value === 0))) {
        ...
        if (v != null && v !== "" && !isNaN(u) && !isNaN(l)) {
            ...
            var h = r ? r + "-" : "", d = Dt(s, "labelWidth", r), p = Dt(s, "labelHeight", r),
                g = e.pstyle(h + "text-margin-x").pfValue, y = e.pstyle(h + "text-margin-y").pfValue, b = e.isEdge(),
                m = e.pstyle("text-halign").value, E = e.pstyle("text-valign").value;
            ...
            var S = e.pstyle("text-background-opacity").value, w = e.pstyle("text-border-opacity").value,
                x = e.pstyle("text-border-width").pfValue, C = e.pstyle("text-background-padding").pfValue,
                D = e.pstyle("text-background-shape").strValue, A = D === "round-rectangle" || D === "roundrectangle",
                L = D === "circle", R = 2;
            if (S > 0 || x > 0 && w > 0) {
                var I = t.fillStyle, M = t.strokeStyle, N = t.lineWidth, O = e.pstyle("text-background-color").value,
                    k = e.pstyle("text-border-color").value, B = e.pstyle("text-border-style").value, _ = S > 0,
                    F = x > 0 && w > 0, G = u - C;
                switch (m) {
                    case"left":
                        G -= d;
            ...
            if (ee > 0 && (t.lineWidth = ee), e.pstyle("text-wrap").value === "wrap") {
                var ae = Dt(s, "labelWrapCachedLines", r), J = Dt(s, "labelLineHeight", r), z = d / 2,
                    V = this.getLabelJustification(e);
...
wr.drawNode = function (t, e, r) {
    var a = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !0,
        n = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : !0,
        i = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : !0, s = this, o, u, l = e._private,
        f = l.rscratch, c = e.position();
    if (!(!ne(c.x) || !ne(c.y)) && !(i && !e.visible())) {
        ...
        var A = e.pstyle("background-blacken").value, L = e.pstyle("border-width").pfValue,
            R = e.pstyle("background-opacity").value * v, I = e.pstyle("border-color").value,
            M = e.pstyle("border-style").value, N = e.pstyle("border-join").value, O = e.pstyle("border-cap").value,
            k = e.pstyle("border-position").value, B = e.pstyle("border-dash-pattern").pfValue,
            _ = e.pstyle("border-dash-offset").pfValue, F = e.pstyle("border-opacity").value * v,
            G = e.pstyle("outline-width").pfValue, Y = e.pstyle("outline-color").value,
            $ = e.pstyle("outline-style").value, H = e.pstyle("outline-opacity").value * v,
            W = e.pstyle("outline-offset").value, ee = e.pstyle("corner-radius").value;
        ...
        var ae = function () {
            ...
            var X = s.nodePathCache = s.nodePathCache || [],
                K = Sf(P === "polygon" ? P + "," + U.join(",") : P, "" + Q, "" + ue, "" + ee), j = X[K], oe, te = !1;
        ...
        var ve = function () {
            ...
            for (var ue = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : v, Q = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !0, P = l.backgrounding, U = 0, X = 0; X < T.length; X++) {
            ...
            var ue = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !1,
                Q = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : v;
            ...
            if (L > 0) {
                ...
                if (k !== "center") {
                    if (t.save(), t.lineWidth *= 2, k === "inside") h ? t.clip(d) : t.clip(); else {
                        var ue = new Path2D;
            ...
            if (G > 0) {
                if (t.lineWidth = G, t.lineCap = "butt", t.setLineDash) switch ($) {
                    case"dotted":
                        t.setLineDash([1, 1]);
                        break;
                    case"dashed":
                ...
                var U = (o + P + (G + W)) / o, X = (u + P + (G + W)) / u, K = o * U, j = u * X,
                    oe = s.nodeShapes[Q].points, te;
                if (h) {
                    var fe = V(K, j, Q, oe);
                    te = fe.path
                }
                if (Q === "ellipse") s.drawEllipsePath(te || t, ue.x, ue.y, K, j); else if (["round-diamond", "round-heptagon", "round-hexagon", "round-octagon", "round-pentagon", "round-polygon", "round-triangle", "round-tag"].includes(Q)) {
                    var le = 0, me = 0, Ae = 0;
                    Q === "round-diamond" ? le = (P + W + G) * 1.4 : Q === "round-heptagon" ? (le = (P + W + G) * 1.075, Ae = -(P / 2 + W + G) / 35) : Q === "round-hexagon" ? le = (P + W + G) * 1.12 : Q === "round-pentagon" ? (le = (P + W + G) * 1.13, Ae = -(P / 2 + W + G) / 15) : Q === "round-tag" ? (le = (P + W + G) * 1.12, me = (P / 2 + G + W) * .07) : Q === "round-triangle" && (le = (P + W + G) * (Math.PI / 2), Ae = -(P + W / 2 + G) / Math.PI), le !== 0 && (U = (o + le) / o, K = o * U, ["round-hexagon", "round-tag"].includes(Q) || (X = (u + le) / u, j = u * X)), ee = ee === "auto" ? Bf(K, j) : ee;
                    for (var Ce = K / 2, ce = j / 2, Re = ee + (P + G + W) / 2, Le = new Array(oe.length / 2), je = new Array(oe.length / 2), Xe = 0; Xe < oe.length / 2; Xe++) Le[Xe] = {
        ...
        if (De) {
            var Pe = e.pstyle("ghost-offset-x").pfValue, Ne = e.pstyle("ghost-offset-y").pfValue,
                Be = e.pstyle("ghost-opacity").value, Fe = Be * v;
...
var Uc = function (e) {
    ...
    return function (r, a, n, i, s) {
        var o = this;
        if (a.visible()) {
            var u = a.pstyle("".concat(e, "-padding")).pfValue, l = a.pstyle("".concat(e, "-opacity")).value,
                f = a.pstyle("".concat(e, "-color")).value, c = a.pstyle("".concat(e, "-shape")).value,
                v = a.pstyle("".concat(e, "-corner-radius")).value;
            if (l > 0) {
...
wr.drawPie = function (t, e, r, a) {
    ...
    var n = e.cy().style(), i = e.pstyle("pie-size"), s = e.pstyle("pie-hole"), o = e.pstyle("pie-start-angle").pfValue,
        u = a.x, l = a.y, f = e.width(), c = e.height(), v = Math.min(f, c) / 2, h, d = 0, p = this.usePaths();
    if (p && (u = 0, l = 0), i.units === "%" ? v = v * i.pfValue : i.pfValue !== void 0 && (v = i.pfValue / 2), s.units === "%" ? h = v * s.pfValue : s.pfValue !== void 0 && (h = s.pfValue / 2), !(h >= v)) for (var g = 1; g <= n.pieBackgroundN; g++) {
        var y = e.pstyle("pie-" + g + "-background-size").value, b = e.pstyle("pie-" + g + "-background-color").value,
            m = e.pstyle("pie-" + g + "-background-opacity").value * r, E = y / 100;
        E + d > 1 && (E = 1 - d);
...
wr.drawStripe = function (t, e, r, a) {
    ...
    for (var p = 1; p <= n.stripeBackgroundN; p++) {
        var g = e.pstyle("stripe-" + p + "-background-size").value,
            y = e.pstyle("stripe-" + p + "-background-color").value,
            b = e.pstyle("stripe-" + p + "-background-opacity").value * r, m = g / 100;
...
xt.getPixelRatio = function () {
    ...
    var e = this.cy.window(),
        r = t.backingStorePixelRatio || t.webkitBackingStorePixelRatio || t.mozBackingStorePixelRatio || t.msBackingStorePixelRatio || t.oBackingStorePixelRatio || t.backingStorePixelRatio || 1;
...
xt.createGradientStyleFor = function (t, e, r, a, n) {
    var i, s = this.usePaths(), o = r.pstyle(e + "-gradient-stop-colors").value,
        u = r.pstyle(e + "-gradient-stop-positions").pfValue;
    if (a === "radial-gradient") if (r.isEdge()) {
        ...
        var m = s ? {x: 0, y: 0} : r.position(), E = r.paddedWidth(), T = r.paddedHeight(), S = E / 2, w = T / 2,
            x = r.pstyle("background-gradient-direction").value;
        switch (x) {
            case"to-bottom":
...
xt.eleFillStyle = function (t, e, r) {
    ...
    if (a === "linear-gradient" || a === "radial-gradient") this.gradientFillStyle(t, e, a, r); else {
...
xt.eleStrokeStyle = function (t, e, r) {
    ...
    if (a === "linear-gradient" || a === "radial-gradient") this.gradientStrokeStyle(t, e, a, r); else {
        var n = e.pstyle("line-color").value;
        this.colorStrokeStyle(t, n[0], n[1], n[2], r)
    }
};
xt.matchCanvasSize = function (t) {
    var e = this, r = e.data, a = e.findContainerClientCoords(), n = a[2], i = a[3], s = e.getPixelRatio(),
...
xt.renderTo = function (t, e, r, a) {
    this.render({forcedContext: t, forcedZoom: e, forcedPan: r, drawAllLayers: !0, forcedPxRatio: a})
};
...
xt.render = function (t) {
    var e = this;
    t = t || If();
    var r = e.cy, a = t.forcedContext, n = t.drawAllLayers, i = t.drawOnlyNodeLayer, s = t.forcedZoom, o = t.forcedPan,
        u = t.forcedPxRatio === void 0 ? this.getPixelRatio() : t.forcedPxRatio, l = e.data, f = l.canvasNeedsRedraw,
        c = e.textureOnViewport && !a && (e.pinching || e.hoverData.dragging || e.swipePanning || e.data.wheelZooming),
        v = t.motionBlur !== void 0 ? t.motionBlur : e.motionBlur, h = e.motionBlurPxRatio, d = r.hasCompoundNodes(),
        p = e.hoverData.draggingEles, g = !!(e.hoverData.selecting || e.touchData.selecting);
    ...
    var b = r.style(), m = r.zoom(), E = s !== void 0 ? s : m, T = r.pan(), S = {x: T.x, y: T.y},
        w = {zoom: m, pan: {x: T.x, y: T.y}}, x = e.prevViewport,
        C = x === void 0 || w.zoom !== x.zoom || w.pan.x !== x.pan.x || w.pan.y !== x.pan.y;
    ...
    var k = r.extent(),
        B = e.pinching || e.hoverData.dragging || e.swipePanning || e.data.wheelZooming || e.hoverData.draggingEles || e.cy.animated(),
        _ = e.hideEdgesOnViewport && B, F = [];
    if (F[e.NODE] = !f[e.NODE] && v && !e.clearedForMotionBlur[e.NODE] || e.clearingMotionBlur, F[e.NODE] && (e.clearedForMotionBlur[e.NODE] = !0), F[e.DRAG] = !f[e.DRAG] && v && !e.clearedForMotionBlur[e.DRAG] || e.clearingMotionBlur, F[e.DRAG] && (e.clearedForMotionBlur[e.DRAG] = !0), f[e.NODE] || n || i || F[e.NODE]) {
        var G = v && !F[e.NODE] && h !== 1,
            I = a || (G ? e.data.bufferContexts[e.MOTIONBLUR_BUFFER_NODE] : l.contexts[e.NODE]),
            Y = v && !G ? "motionBlur" : void 0;
        L(I, Y), _ ? e.drawCachedNodes(I, D.nondrag, u, k) : e.drawLayeredElements(I, D.nondrag, u, k), e.debug && e.drawDebugPoints(I, D.nondrag), !n && !v && (f[e.NODE] = !1)
    }
    if (!i && (f[e.DRAG] || n || F[e.DRAG])) {
        var G = v && !F[e.DRAG] && h !== 1,
            I = a || (G ? e.data.bufferContexts[e.MOTIONBLUR_BUFFER_DRAG] : l.contexts[e.DRAG]);
    ...
    if (this.drawSelectionRectangle(t, L), v && h !== 1) {
        var $ = l.contexts[e.NODE], H = e.data.bufferCanvases[e.MOTIONBLUR_BUFFER_NODE], W = l.contexts[e.DRAG],
            ee = e.data.bufferCanvases[e.MOTIONBLUR_BUFFER_DRAG], ae = function (z, V, q) {
...
xt.drawSelectionRectangle = function (t, e) {
    var r = this, a = r.cy, n = r.data, i = a.style(), s = t.drawOnlyNodeLayer, o = t.drawAllLayers,
        u = n.canvasNeedsRedraw, l = t.forcedContext;
...
function Tm(t, e, r, a) {
    var n = qc(t, e), i = Je(n, 2), s = i[0], o = i[1], u = $c(t, o, a), l = t.createBuffer();
...
function zt(t, e, r, a) {
    var n = qc(t, r), i = Je(n, 3), s = i[0], o = i[1], u = i[2], l = $c(t, o, e * s), f = s * u, c = t.createBuffer();
    ...
    for (var v = new Array(e), h = 0; h < e; h++) v[h] = xm(t, o, l, f, s, h);
...
function Sm(t, e, r) {
    var a = e[0], n = e[1], i = e[2], s = e[3], o = e[4], u = e[5], l = e[6], f = e[7], c = e[8], v = r[0], h = r[1],
        d = r[2], p = r[3], g = r[4], y = r[5], b = r[6], m = r[7], E = r[8];
...
function af(t, e, r) {
    var a = e[0], n = e[1], i = e[2], s = e[3], o = e[4], u = e[5], l = e[6], f = e[7], c = e[8], v = Math.sin(r),
        h = Math.cos(r);
...
var Lm = function () {
    function t(e, r, a, n) {
        yr(this, t), this.debugID = Math.floor(Math.random() * 1e4), this.r = e, this.texSize = r, this.texRows = a, this.texHeight = Math.floor(r / a), this.enableWrapping = !0, this.locked = !1, this.texture = null, this.needsBuffer = !0, this.freePointer = {
            x: 0,
            row: 0
        }, this.keyToLocation = new Map, this.canvas = n(e, r, r), this.scratch = n(e, r, this.texHeight, "scratch")
    }
    ...
    return mr(t, [{
        ...
        key: "draw", value: function (r, a, n) {
            ...
            var s = this.texSize, o = this.texRows, u = this.texHeight, l = this.getScale(a), f = l.scale, c = l.texW,
                v = l.texH, h = function (m, E) {
                    if (n && E) {
            ...
            if (this.freePointer.x + c <= s) p(); else {
    ...
    function t(e, r, a, n) {
        yr(this, t), this.r = e, this.texSize = r, this.texRows = a, this.createTextureCanvas = n, this.atlases = [], this.styleKeyToAtlas = new Map, this.markedKeys = new Set
    }
    ...
    return mr(t, [{
        ...
        key: "gc", value: function () {
            ...
            var n = [], i = new Map, s = null, o = At(this.atlases), u;
            try {
                var l = function () {
...
var Pm = function () {
        function t(e, r) {
            yr(this, t), this.r = e, this.globalOptions = r, this.atlasSize = r.webglTexSize, this.maxAtlasesPerBatch = r.webglTexPerBatch, this.renderTypes = new Map, this.collections = new Map, this.typeAndIdToKey = new Map
        }
        ...
        return mr(t, [{
            ...
            key: "addAtlasCollection", value: function (r, a) {
                var n = this.globalOptions, i = n.webglTexSize, s = n.createTextureCanvas, o = a.texRows,
                    u = this._cacheScratchCanvas(s), l = new Rm(this.r, i, o, u);
            ...
            key: "invalidate", value: function (r) {
                var a = this, n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, i = n.forceRedraw,
                    s = i === void 0 ? !1 : i, o = n.filterEle, u = o === void 0 ? function () {
                        return !0
                        ...
                        if (u(p)) {
                            ...
                            try {
                                var b = function () {
                                    ...
                                    if (f(T)) {
                                        var S = a.collections.get(E.collection), w = E.getKey(p),
                                            x = Array.isArray(w) ? w : [w];
                                        if (s) x.forEach(function (L) {
                                            return S.markKeyForGC(L)
                                        }), v = !0; else {
                                            var C = E.getID ? E.getID(p) : p.id(), D = a._key(T, C),
                                                A = a.typeAndIdToKey.get(D);
            ...
            key: "getOrCreateAtlas", value: function (r, a, n, i) {
                var s = this.renderTypes.get(a), o = this.collections.get(s.collection), u = !1,
                    l = o.draw(i, n, function (v) {
            ...
            key: "getAtlasInfo", value: function (r, a) {
                ...
                return o.map(function (u) {
                    var l = i.getBoundingBox(r, u), f = n.getOrCreateAtlas(r, a, l, u), c = f.getOffsets(u), v = Je(c, 2),
                        h = v[0], d = v[1];
        ...
        return mr(t, [{
            key: "getMaxAtlasesPerBatch", value: function () {
...
`, Da = {SCREEN: {name: "screen", screen: !0}, PICKING: {name: "picking", picking: !0}}, Nn = {IGNORE: 1, USE_BB: 2},
    Ls = 0, nf = 1, sf = 2, Rs = 3, Yr = 4, ln = 5, ma = 6, ba = 7, Fm = function () {
        function t(e, r, a) {
        ...
        return mr(t, [{
            ...
            key: "invalidate", value: function (r) {
                var a = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, n = a.type,
                    i = this.atlasManager;
    ...
    `), o = dm(a, n, s);
            ...
            key: "drawNode", value: function (r, a, n) {
                ...
                if (this._isVisible(r, i)) {
                    ...
                    if (this.vertTypeBuffer.getView(u)[0] = o, o === ln || o === ma) {
                        var l = i.getBoundingBox(r), f = this._getCornerRadius(r, s.radius, l),
                            c = this.cornerRadiusBuffer.getView(u);
                    ...
                    if (g[0] = 0, g[1] = 0, s.border) {
                        ...
                        if (y > 0) {
                            var b = r.pstyle("border-color").value, m = r.pstyle("border-opacity").value,
                                E = this.borderColorBuffer.getView(u);
                            Cr(b, m, E);
                            var T = r.pstyle("border-position").value;
                            if (T === "inside") g[0] = 0, g[1] = -y; else if (T === "outside") g[0] = y, g[1] = 0; else {
                                var S = y / 2;
                                g[0] = S, g[1] = -S
                            }
                        }
            ...
            key: "drawEdgeArrow", value: function (r, a, n) {
                if (r.visible()) {
                    ...
                    if (n === "source" ? (s = i.arrowStartX, o = i.arrowStartY, u = i.srcArrowAngle) : (s = i.arrowEndX, o = i.arrowEndY, u = i.tgtArrowAngle), !(isNaN(s) || s == null || isNaN(o) || o == null || isNaN(u) || u == null)) {
                        ...
                        if (l !== "none") {
                            var f = r.pstyle(n + "-arrow-color").value, c = r.pstyle("opacity").value,
                                v = r.pstyle("line-opacity").value, h = c * v, d = r.pstyle("width").pfValue,
                                p = r.pstyle("arrow-scale").value, g = this.r.getArrowWidth(d, p), y = this.instanceCount,
                                b = this.transformBuffer.getMatrixView(y);
            ...
            key: "drawEdgeLine", value: function (r, a) {
                if (r.visible()) {
                    ...
                    if (n) {
                        var i = r.pstyle("opacity").value, s = r.pstyle("line-opacity").value,
                            o = r.pstyle("width").pfValue, u = r.pstyle("line-color").value, l = i * s;
                        if (n.length / 2 + this.instanceCount > this.maxInstances && this.endBatch(), n.length == 4) {
                            ...
                            m[0] = o;
                            var E = n[p - 2], T = n[p - 1], S = n[p], w = n[p + 1], x = n[p + 2], C = n[p + 3],
                                D = n[p + 4], A = n[p + 5];
                            p == 0 && (E = 2 * S - x + .001, T = 2 * w - C + .001), p == n.length - 4 && (D = 2 * x - S + .001, A = 2 * C - w + .001);
            ...
            key: "_getCurveSegmentPoints", value: function (r, a) {
                ...
                for (var n = Array((a + 1) * 2), i = 0; i <= a; i++) if (i == 0) n[0] = r[0], n[1] = r[1]; else if (i == a) n[i * 2] = r[r.length - 2], n[i * 2 + 1] = r[r.length - 1]; else {
                    var s = i / a;
            ...
            key: "_setCurvePoint", value: function (r, a, n, i) {
                if (r.length <= 2) n[i] = r[0], n[i + 1] = r[1]; else {
...
var Is = function (e, r) {
    ...
    return function (a, n) {
        ...
        if (typeof n == "string") {
            var s = n.indexOf("_");
            if (s > 0) {
                var o = Number(n.substring(s + 1)), u = Hc(a, r), l = i.h / u.length, f = l * o, c = i.y1 + f;
...
function Gm(t) {
    ...
    }
    {
        ...
        t.notify = function (i, s) {
            n.call(t, i, s), i === "viewport" || i === "bounds" ? t.pickingFrameBuffer.needsDraw = !0 : i === "background" && t.drawing.invalidate(s, {type: "node-body"})
        }
    }
}
...
function $m(t) {
    ...
    e.save(), Xc(t, e), e.strokeStyle = "rgba(0, 0, 0, 0.3)", e.beginPath(), e.moveTo(-1e3, 0), e.lineTo(1e3, 0), e.stroke(), e.beginPath(), e.moveTo(0, -1e3), e.lineTo(0, 1e3), e.stroke(), e.restore()
}
...
function Ym(t) {
    var e = function (n, i, s) {
        for (var o = n.atlasManager.getAtlasCollection(i), u = t.data.contexts[t.NODE], l = o.atlases, f = 0; f < l.length; f++) {
            ...
            if (v) {
                var h = v.width, d = v.height, p = h * f, g = v.height * s, y = .4;
...
function Wc(t, e, r) {
    ...
    if (r.screen && t.data.canvasNeedsRedraw[t.SELECT_BOX] && qm(t, e), t.data.canvasNeedsRedraw[t.NODE] || r.picking) {
        ...
        if (i = u.length, n.startFrame(o, r), r.screen) {
            for (var l = 0; l < u.nondrag.length; l++) Ms(t, l, u.nondrag[l]);
            for (var f = 0; f < u.drag.length; f++) Ms(t, f, u.drag[f])
        } else if (r.picking) for (var c = 0; c < u.length; c++) Ms(t, c, u[c]);
        n.endFrame(), r.screen && t.webglDebugShowAtlases && ($m(t), Ym(t)), t.data.canvasNeedsRedraw[t.NODE] = !1, t.data.canvasNeedsRedraw[t.DRAG] = !1
    }
    if (t.webglDebug) {
        var v = performance.now(), h = !1, d = Math.ceil(v - a), p = n.getDebugInfo(),
            g = ["".concat(i, " elements"), "".concat(p.totalInstances, " instances"), "".concat(p.batchCount, " batches"), "".concat(p.totalAtlases, " atlases"), "".concat(p.wrappedCount, " wrapped textures"), "".concat(p.simpleCount, " simple shapes")].join(", ");
        if (h) console.log("WebGL (".concat(r.name, ") - time ").concat(d, "ms, ").concat(g)); else {
...
Er.drawBarrelPath = function (t, e, r, a, n) {
    var i = a / 2, s = n / 2, o = e - i, u = e + i, l = r - s, f = r + s, c = Fs(a, n), v = c.widthOffset,
        h = c.heightOffset, d = c.ctrlPtOffsetPct * v;
...
for (var Hr = 0 * Math.PI; Hr < 2 * Math.PI; Hr += Kc) Js[Hr] = Math.sin(Hr), js[Hr] = Math.cos(Hr);
Er.drawEllipsePath = function (t, e, r, a, n) {
    if (t.beginPath && t.beginPath(), t.ellipse) t.ellipse(e, r, a / 2, n / 2, 0, 0, 2 * Math.PI); else for (var i, s, o = a / 2, u = n / 2, l = 0 * Math.PI; l < 2 * Math.PI; l += Kc) i = e - o * Js[l] * of + o * js[l] * uf, s = r + u * js[l] * of + u * Js[l] * uf, l === 0 ? t.moveTo(i, s) : t.lineTo(i, s);
    t.closePath()
};
var Xa = {};
...
Xa.bufferCanvasImage = function (t) {
    var e = this.cy, r = e.mutableElements(), a = r.boundingBox(), n = this.findContainerClientCoords(),
        i = t.full ? Math.ceil(a.w) : n[2], s = t.full ? Math.ceil(a.h) : n[3], o = ne(t.maxWidth) || ne(t.maxHeight),
        u = this.getPixelRatio(), l = 1;
    if (t.scale !== void 0) i *= t.scale, s *= t.scale, l = t.scale; else if (o) {
        var f = 1 / 0, c = 1 / 0;
    ...
    if (i > 0 && s > 0) {
        ...
        if (t.full) h.translate(-a.x1 * l, -a.y1 * l), h.scale(l, l), this.drawElements(h, d), h.scale(1 / l, 1 / l), h.translate(a.x1 * l, a.y1 * l); else {
...
Se.makeOffscreenCanvas = function (t, e) {
    var r;
    if ((typeof OffscreenCanvas > "u" ? "undefined" : nt(OffscreenCanvas)) !== "undefined") r = new OffscreenCanvas(t, e); else {
        var a = this.cy.window(), n = a.document;
        r = n.createElement("canvas"), r.width = t, r.height = e
    }
    return r
};
[zc, Yt, er, Lo, Fr, wr, xt, Yc, Er, Xa, Qc].forEach(function (t) {
    be(Se, t)
});
var Qm = [{name: "null", impl: Sc}, {name: "base", impl: Bc}, {name: "canvas", impl: Km}],
    Jm = [{type: "layout", extensions: Ty}, {type: "renderer", extensions: Qm}], jc = {}, ev = {};
...
function tv(t, e, r) {
    ...
    if (t === "core") {
        ...
        be(s, {
            createEmitter: function () {
                return this._private.emitter = new Xn(v, this), this
            }, emitter: function () {
                return this._private.emitter
            }, on: function (x, C) {
    ...
    } else if (t === "__proto__" || t === "constructor" || t === "prototype") return Ye(t + " is an illegal type to be registered, possibly lead to prototype pollutions");
    return wf({map: jc, keys: [t, e], value: a})
}

function rv(t, e) {
    return Ef({map: jc, keys: [t, e]})
}

function jm(t, e, r, a, n) {
    return wf({map: ev, keys: [t, e, r, a], value: n})
}

function e0(t, e, r, a) {
    return Ef({map: ev, keys: [t, e, r, a]})
}

var eo = function () {
    if (arguments.length === 2) return rv.apply(null, arguments);
...
var t0 = "3.33.1", pr = function (e) {
    ...
    if (ge(e)) return eo.apply(eo, arguments)
};
pr.use = function (t) {
        ...
        (function (a, n) {
            ...
            return function (r) {
                ...
                return n.m = r, n.c = a, n.i = function (i) {
                    ...
                    n.o(i, s) || Object.defineProperty(i, s, {configurable: !1, enumerable: !0, get: o})
                }, n.n = function (i) {
                ...
                c.prototype.getEdges = function () {
                    ...
                    var h = new Set, d = this;
                    return d.edges.forEach(function (p) {
                        if (p.source == d) h.add(p.target); else {
                    ...
                    var h = 0, d;
                    if (this.child == null) h = 1; else for (var p = this.child.getNodes(), g = 0; g < p.length; g++) d = p[g], h += d.getNoOfChildren();
                    return h == 0 && (h = 1), h
                ...
                d.prototype.getNodes = function () {
                    ...
                    var y = new h, b = new Set, m = this.nodes[0], E, T, S = m.withChildren();
                ...
                o.prototype.addRoot = function () {
                    ...
                    if (f == null && c == null && v == null) {
                        ...
                        if (h == d) return f.isInterGraph = !1, h.add(f, c, v);
                        if (f.isInterGraph = !0, f.source = c, f.target = v, this.edges.indexOf(f) > -1) throw "Edge already in inter-graph edge list!";
                    ...
                    for (var u, l = this.edges.length, f = 0; f < l; f++) if (u = this.edges[f], this.isOneAncestorOfOther(u.source, u.target)) return !0;
                    return !1
                }, r.exports = o
            }, function (r, a, n) {
                var i = n(0);
                ...
                s.calcSeparationAmount = function (o, u, l, f) {
                    ...
                    if (o.intersects(u)) return l[0] = f, l[1] = c, l[2] = v, l[3] = h, !0;
                    var d = o.getX(), p = o.getY(), g = o.getRight(), y = o.getX(), b = o.getBottom(), m = o.getRight(),
                        E = o.getWidthHalf(), T = o.getHeightHalf(), S = u.getX(), w = u.getY(), x = u.getRight(),
                        C = u.getX(), D = u.getBottom(), A = u.getRight(), L = u.getWidthHalf(), R = u.getHeightHalf(),
                        I = !1, M = !1;
                    if (f === v) {
                        if (c > h) return l[0] = f, l[1] = p, l[2] = v, l[3] = D, !1;
                        if (c < h) return l[0] = f, l[1] = b, l[2] = v, l[3] = w, !1
                    } else if (c === h) {
                        if (f > v) return l[0] = d, l[1] = c, l[2] = x, l[3] = h, !1;
                        if (f < v) return l[0] = g, l[1] = c, l[2] = S, l[3] = h, !1
                    } else {
                        var N = o.height / o.width, O = u.height / u.width, k = (h - c) / (v - f), B = void 0,
                            _ = void 0, F = void 0, G = void 0, Y = void 0, $ = void 0;
                        if (-N === k ? f > v ? (l[0] = y, l[1] = b, I = !0) : (l[0] = g, l[1] = p, I = !0) : N === k && (f > v ? (l[0] = d, l[1] = p, I = !0) : (l[0] = m, l[1] = b, I = !0)), -O === k ? v > f ? (l[2] = C, l[3] = D, M = !0) : (l[2] = x, l[3] = w, M = !0) : O === k && (v > f ? (l[2] = S, l[3] = w, M = !0) : (l[2] = A, l[3] = D, M = !0)), I && M) return !1;
                        if (f > v ? c > h ? (B = this.getCardinalDirection(N, k, 4), _ = this.getCardinalDirection(O, k, 2)) : (B = this.getCardinalDirection(-N, k, 3), _ = this.getCardinalDirection(-O, k, 1)) : c > h ? (B = this.getCardinalDirection(-N, k, 1), _ = this.getCardinalDirection(-O, k, 3)) : (B = this.getCardinalDirection(N, k, 2), _ = this.getCardinalDirection(O, k, 4)), !I) switch (B) {
                            case 1:
                    ...
                    var c = o.x, v = o.y, h = u.x, d = u.y, p = l.x, g = l.y, y = f.x, b = f.y, m = void 0, E = void 0,
                        T = void 0, S = void 0, w = void 0, x = void 0, C = void 0, D = void 0, A = void 0;
                    ...
                    var c = o.x, v = o.y, h = u.x, d = u.y, p = l.x, g = l.y, y = f.x, b = f.y,
                        m = (h - c) * (b - g) - (y - p) * (d - v);
                    if (m === 0) return !1;
                    var E = ((b - g) * (y - c) + (p - y) * (b - v)) / m,
                        T = ((v - d) * (y - c) + (h - c) * (b - v)) / m;
                    return 0 < E && E < 1 && 0 < T && T < 1
                }, s.HALF_PI = .5 * Math.PI, s.ONE_AND_HALF_PI = 1.5 * Math.PI, s.TWO_PI = 2 * Math.PI, s.THREE_PI = 3 * Math.PI, r.exports = s
            }, function (r, a, n) {
                function i() {
                }
                ...
                i.prototype.getX = function () {
                    ...
                    s.constructor.name == "Point" && o == null && u == null ? (u = s, this.setLocation(u.x, u.y)) : typeof s == "number" && typeof o == "number" && u == null && (parseInt(s) == s && parseInt(o) == o ? this.move(s, o) : (this.x = Math.floor(s + .5), this.y = Math.floor(o + .5)))
                ...
                d.RANDOM_SEED = 1, d.prototype = Object.create(h.prototype), d.prototype.getGraphManager = function () {
                    ...
                    if (p == null) this.update2(); else if (p instanceof u) {
                        var g = p;
                    ...
                    if (p == null) this.transform(new c(0, 0)); else {
                    ...
                    if (p == null) this.positionNodesRandomly(this.getGraphManager().getRoot()), this.getGraphManager().getRoot().updateBounds(!0); else for (var g, y, b = p.getNodes(), m = 0; m < b.length; m++) g = b[m], y = g.getChild(), y == null || y.getNodes().length == 0 ? g.scatter() : (this.positionNodesRandomly(y), g.updateBounds())
                }, d.prototype.getFlatForest = function () {
                    for (var p = [], g = !0, y = this.graphManager.getRoot().getNodes(), b = !0, m = 0; m < y.length; m++) y[m].getChild() != null && (b = !1);
                    if (!b) return p;
                    var E = new Set, T = [], S = new Map, w = [];
                    for (w = w.concat(y); w.length > 0 && g;) {
                        for (T.push(w[0]); T.length > 0 && g;) {
                            ...
                            for (var C = x.getEdges(), m = 0; m < C.length; m++) {
                                ...
                                if (S.get(x) != D) if (!E.has(D)) T.push(D), S.set(D, x); else {
                                    g = !1;
                                    break
                                }
                            }
                ...
                c.prototype.initParameters = function () {
                    ...
                    var h = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !0,
                        d = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1, p, g, y, b,
                        m = this.getAllNodes(), E;
                    if (this.useFRGridVariant) for (this.totalIterations % o.GRID_CALCULATION_CHECK_PERIOD == 1 && h && this.updateGrid(), E = new Set, p = 0; p < m.length; p++) y = m[p], this.calculateRepulsionForceOfANode(y, E, h, d), E.add(y); else for (p = 0; p < m.length; p++) for (y = m[p], g = p + 1; g < m.length; g++) b = m[g], y.getOwner() == b.getOwner() && this.calcRepulsionForce(y, b)
                    ...
                    if (this.uniformLeafNodeSizes && p.getChild() == null && g.getChild() == null) h.updateLengthSimple(); else if (h.updateLength(), h.isOverlapingSourceAndTarget) return;
                    ...
                    if (this.totalIterations % o.GRID_CALCULATION_CHECK_PERIOD == 1 && p || g) {
                        ...
                        for (var b, m = this.grid, E = h.startX - 1; E < h.finishX + 2; E++) for (var T = h.startY - 1; T < h.finishY + 2; T++) if (!(E < 0 || T < 0 || E >= m.length || T >= m[0].length)) {
                            for (var S = 0; S < m[E][T].length; S++) if (b = m[E][T][S], !(h.getOwner() != b.getOwner() || h == b) && !d.has(b) && !y.has(b)) {
                                var w = Math.abs(h.getCenterX() - b.getCenterX()) - (h.getWidth() / 2 + b.getWidth() / 2),
                                    x = Math.abs(h.getCenterY() - b.getCenterY()) - (h.getHeight() / 2 + b.getHeight() / 2);
                ...
                var o = n(11), u = function () {
                    ...
                    return i(l, [{
                        key: "_quicksort", value: function (c, v, h) {
                            if (v < h) {
                        ...
                        key: "_partition", value: function (c, v, h) {
                            for (var d = this._get(c, v), p = v, g = h; ;) {
                                ...
                                if (p < g) this._swap(c, p, g), p++, g--; else return g
                            }
                        }
                    }, {
                ...
                var o = function () {
                    ...
                    return i(u, [{
                        ...
                        key: "computeGrids", value: function () {
                            for (var f = 1; f < this.jMax; f++) this.grid[0][f] = this.grid[0][f - 1] + this.gap_penalty, this.tracebackGrid[0][f] = [!1, !1, !0];
                            for (var c = 1; c < this.iMax; c++) this.grid[c][0] = this.grid[c - 1][0] + this.gap_penalty, this.tracebackGrid[c][0] = [!1, !0, !1];
                            for (var v = 1; v < this.iMax; v++) for (var h = 1; h < this.jMax; h++) {
                                ...
                                var p = this.grid[v - 1][h] + this.gap_penalty,
                                    g = this.grid[v][h - 1] + this.gap_penalty, y = [d, p, g],
                                    b = this.arrayAllMaxIndexes(y);
        ...
        (function (a, n) {
            ...
            return function (a) {
                ...
                return i.m = a, i.c = n, i.i = function (s) {
                    ...
                    i.o(s, o) || Object.defineProperty(s, o, {configurable: !1, enumerable: !0, get: u})
                }, i.n = function (s) {
                ...
                var s = i(0).FDLayout, o = i(4), u = i(3), l = i(5), f = i(2), c = i(1), v = i(0).FDLayoutConstants,
                    h = i(0).LayoutConstants, d = i(0).Point, p = i(0).PointD, g = i(0).Layout, y = i(0).Integer,
                    b = i(0).IGeometry, m = i(0).LGraph, E = i(0).Transform;
                ...
                T.prototype.newGraphManager = function () {
                    ...
                    if (this.nodesWithGravity = this.calculateNodesToApplyGravitationTo(), this.graphManager.setAllNodesToApplyGravitation(this.nodesWithGravity), this.calcNoOfChildrenForAllNodes(), this.graphManager.calcLowestCommonAncestors(), this.graphManager.calcInclusionTreeDepths(), this.graphManager.getRoot().calcEstimatedSize(), this.calcIdealEdgeLengths(), this.incremental) {
                        ...
                        if (w.length > 0) this.positionNodesRadially(w); else {
                            this.reduceTrees(), this.graphManager.resetAllNodesToApplyGravitation();
                    ...
                    if (this.totalIterations++, this.totalIterations === this.maxIterations && !this.isTreeGrowing && !this.isGrowthFinished) if (this.prunedNodesAll.length > 0) this.isTreeGrowing = !0; else return !0;
                    if (this.totalIterations % v.CONVERGENCE_CHECK_PERIOD == 0 && !this.isTreeGrowing && !this.isGrowthFinished) {
                        if (this.isConverged()) if (this.prunedNodesAll.length > 0) this.isTreeGrowing = !0; else return !0;
                    ...
                    var C = !this.isTreeGrowing && !this.isGrowthFinished,
                        D = this.growTreeIterations % 10 == 1 && this.isTreeGrowing || this.afterGrowthIterations % 10 == 1 && this.isGrowthFinished;
                    ...
                    var w = !1;
                    if (v.ANIMATE === "during") this.emit("layoutstarted"); else {
                        for (; !w;) w = this.tick();
                    ...
                    for (C = 0; C < w.length; C++) {
                        ...
                        if (!x.has(D)) {
                            ...
                            if (A == L) D.getBendpoints().push(new p), D.getBendpoints().push(new p), this.createDummyNodesForBendpoints(D), x.add(D); else {
                                var R = [];
                    ...
                    var C = w.getChild();
                    if (C == null) return this.toBeTiled[x] = !1, !1;
                    ...
                    if (D < 0) return !0;
                    var A = w.rowWidth[D];
                    if (A + w.horizontalPadding + x <= w.width) return !0;
                    var L = 0;
                    ...
                    var x = this.getLongestRowIndex(w), C = w.rowWidth.length - 1, D = w.rows[x], A = D[D.length - 1],
                        L = A.width + w.horizontalPadding;
                    if (w.width - w.rowWidth[C] > L && x != C) {
                        ...
                        for (var R = Number.MIN_VALUE, I = 0; I < D.length; I++) D[I].height > R && (R = D[I].height);
                    ...
                    for (var w = [], x = !0, C; x;) {
                        ...
                        x = !1;
                        for (var L = 0; L < D.length; L++) C = D[L], C.getEdges().length == 1 && !C.getEdges()[0].isInterGraph && C.getChild() == null && (A.push([C, C.getEdges()[0], C.getOwner()]), x = !0);
                        if (x == !0) {
                            for (var R = [], I = 0; I < A.length; I++) A[I][0].getEdges().length == 1 && (R.push(A[I]), A[I][0].getOwner().remove(A[I][0]));
                    ...
                    var A = C.startX, L = C.finishX, R = C.startY, I = C.finishY, M = 0, N = 0, O = 0, k = 0,
                        B = [M, O, N, k];
                    if (R > 0) for (var _ = A; _ <= L; _++) B[0] += this.grid[_][R - 1].length + this.grid[_][R].length - 1;
                    if (L < this.grid.length - 1) for (var _ = R; _ <= I; _++) B[1] += this.grid[L + 1][_].length + this.grid[L][_].length - 1;
                    if (I < this.grid[0].length - 1) for (var _ = A; _ <= L; _++) B[2] += this.grid[_][I + 1].length + this.grid[_][I].length - 1;
                    if (A > 0) for (var _ = R; _ <= I; _++) B[3] += this.grid[A - 1][_].length + this.grid[A][_].length - 1;
                    for (var F = y.MAX_VALUE, G, Y, $ = 0; $ < B.length; $++) B[$] < F ? (F = B[$], G = 1, Y = $) : B[$] == F && G++;
                    if (G == 3 && F == 0) B[0] == 0 && B[1] == 0 && B[2] == 0 ? x = 1 : B[0] == 0 && B[1] == 0 && B[3] == 0 ? x = 0 : B[0] == 0 && B[2] == 0 && B[3] == 0 ? x = 3 : B[1] == 0 && B[2] == 0 && B[3] == 0 && (x = 2); else if (G == 2 && F == 0) {
...
(function (t, e) {
    (function (a, n) {
        ...
        return function (a) {
            ...
            var s = i(0).layoutBase.LayoutConstants, o = i(0).layoutBase.FDLayoutConstants, u = i(0).CoSEConstants,
                l = i(0).CoSELayout, f = i(0).CoSENode, c = i(0).layoutBase.PointD, v = i(0).layoutBase.DimensionD,
                h = {
                    ready: function () {
                    },
                    stop: function () {
            ...
            p.prototype.run = function () {
                ...
                var M = function (k, B) {
                    ...
                    for (var k = function () {
                        E.fit && E.cy.fit(E.eles, E.padding), b || (b = !0, S.cy.one("layoutready", E.ready), S.cy.trigger({
                            type: "layoutready",
                            layout: S
                        }))
                    }, B = S.options.refresh, _, F = 0; F < B && !_; F++) _ = S.stopped || S.layout.tick();
                    if (_) {
                        T.checkLayoutSuccess() && !T.isSubLayout && T.doPostLayout(), T.tilingPostLayout && T.tilingPostLayout(), T.isLayoutFinished = !0, S.options.eles.nodes().positions(M), k(), S.cy.one("layoutstop", S.options.stop), S.cy.trigger({
                            type: "layoutstop",
                            layout: S
                        }), m && cancelAnimationFrame(m), b = !1;
                        return
                    }
                    ...
                    E.eles.nodes().positions(function (Y, $) {
                        if (typeof Y == "number" && (Y = $), !Y.isParent()) {
                            ...
                            return W != null ? {x: W.x, y: W.y} : {x: Y.position("x"), y: Y.position("y")}
                        }
                ...
                for (var m = {}, E = 0; E < b.length; E++) m[b[E].id()] = !0;
                ...
                for (var T = m.length, S = 0; S < T; S++) {
                    var w = m[S], x = w.children(), C,
                        D = w.layoutDimensions({nodeDimensionsIncludeLabels: this.options.nodeDimensionsIncludeLabels});
                    if (w.outerWidth() != null && w.outerHeight() != null ? C = b.add(new f(E.graphManager, new c(w.position("x") - D.w / 2, w.position("y") - D.h / 2), new v(parseFloat(D.w), parseFloat(D.h)))) : C = b.add(new f(this.graphManager)), C.id = w.data("id"), C.paddingLeft = parseInt(w.css("padding")), C.paddingTop = parseInt(w.css("padding")), C.paddingRight = parseInt(w.css("padding")), C.paddingBottom = parseInt(w.css("padding")), this.options.nodeDimensionsIncludeLabels && w.isParent()) {
                        var A = w.boundingBox({includeLabels: !0, includeNodes: !1}).w,
                            L = w.boundingBox({includeLabels: !0, includeNodes: !1}).h, R = w.css("text-halign");
...
var to = function () {
    var t = function (E, T, S, w) {
            ...
            return S
        }, e = [1, 4], r = [1, 13], a = [1, 12], n = [1, 15], i = [1, 16], s = [1, 20], o = [1, 19], u = [6, 7, 8],
        l = [1, 26], f = [1, 24], c = [1, 25], v = [6, 7, 11], h = [1, 6, 13, 15, 16, 19, 22], d = [1, 33], p = [1, 34],
        g = [1, 6, 7, 11, 13, 15, 16, 19, 22], y = {
            trace: function () {
            },
            yy: {},
            symbols_: {
            ...
            performAction: function (T, S, w, x, C, D, A) {
                ...
                switch (C) {
                    ...
                    case 20:
                        ...
                        break;
                    case 25:
                        x.getLogger().trace("node found ..", D[L - 2]), this.$ = {
                            id: D[L - 1],
                            descr: D[L - 1],
                            type: x.getType(D[L - 2], D[L])
                        };
                        break;
                    case 26:
                        ...
                        break;
                    case 27:
                        x.getLogger().trace("node found ..", D[L - 3]), this.$ = {
                            id: D[L - 3],
                            descr: D[L - 1],
                            type: x.getType(D[L - 2], D[L])
                        };
            ...
            table: [{3: 1, 4: 2, 5: 3, 6: [1, 5], 8: e}, {1: [3]}, {1: [2, 1]}, {4: 6, 6: [1, 7], 7: [1, 8], 8: e}, {
                6: r,
                7: [1, 10],
                9: 9,
                12: 11,
                ...
                19: s,
                22: o
            }, {6: r, 9: 22, 12: 11, 13: a, 14: 14, 15: n, 16: i, 17: 17, 18: 18, 19: s, 22: o}, {
                6: l,
                7: f,
                10: 23,
                11: c
                ...
                19: s,
                22: o
            }), t(v, [2, 18]), t(v, [2, 19]), t(v, [2, 20]), t(v, [2, 21]), t(v, [2, 23]), t(v, [2, 24]), t(v, [2, 26], {19: [1, 30]}), {20: [1, 31]}, {
                6: l,
                7: f,
                10: 32,
                11: c
            }, {1: [2, 7], 6: r, 12: 21, 13: a, 14: 14, 15: n, 16: i, 17: 17, 18: 18, 19: s, 22: o}, t(h, [2, 14], {
                7: d,
                11: p
            }), t(g, [2, 8]), t(g, [2, 9]), t(g, [2, 10]), t(v, [2, 15]), t(v, [2, 16]), t(v, [2, 17]), {20: [1, 35]}, {21: [1, 36]}, t(h, [2, 13], {
                7: d,
                11: p
            }), t(g, [2, 11]), t(g, [2, 12]), {21: [1, 37]}, t(v, [2, 25]), t(v, [2, 27])],
            defaultActions: {2: [2, 1], 6: [2, 2]},
            parseError: function (T, S) {
                if (S.recoverable) this.trace(T); else {
                    var w = new Error(T);
                    throw w.hash = S, w
                }
            },
            parse: function (T) {
                var S = this, w = [0], x = [], C = [null], D = [], A = this.table, L = "", R = 0, I = 0, M = 2, N = 1,
                    O = D.slice.call(arguments, 1), k = Object.create(this.lexer), B = {yy: {}};
                ...
                for (var $, H, W, ee, ae = {}, J, z, V, q; ;) {
                    if (H = w[w.length - 1], this.defaultActions[H] ? W = this.defaultActions[H] : (($ === null || typeof $ > "u") && ($ = Y()), W = A[H] && A[H][$]), typeof W > "u" || !W.length || !W[0]) {
                        var Z = "";
                        q = [];
                        for (J in A[H]) this.terminals_[J] && J > M && q.push("'" + this.terminals_[J] + "'");
...
Expecting ` + q.join(", ") + ", got '" + (this.terminals_[$] || $) + "'" : Z = "Parse error on line " + (R + 1) + ": Unexpected " + ($ == N ? "end of input" : "'" + (this.terminals_[$] || $) + "'"), this.parseError(Z, {
                    ...
                    if (W[0] instanceof Array && W.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + H + ", token: " + $);
                    switch (W[0]) {
                        case 1:
                            w.push($), C.push(k.yytext), D.push(k.yylloc), w.push(W[1]), $ = null, I = k.yyleng, L = k.yytext, R = k.yylineno, F = k.yylloc;
                            break;
                        case 2:
                            ...
                            }, G && (ae._$.range = [D[D.length - (z || 1)].range[0], D[D.length - 1].range[1]]), ee = this.performAction.apply(ae, [L, I, R, B.yy, W[1], C, D].concat(O)), typeof ee < "u") return ee;
            ...
            var E = {
                ...
                parseError: function (S, w) {
                    if (this.yy.parser) this.yy.parser.parseError(S, w); else throw new Error(S)
                },
...
` + S + "^"
                ...
                test_match: function (T, S) {
                    ...
                    }, this.yytext += T[0], this.match += T[0], this.matches = T, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = !1, this._backtrack = !1, this._input = this._input.slice(T[0].length), this.matched += T[0], w = this.performAction.call(this, this.yy, this, S, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = !1), w) return w;
                    if (this._backtrack) {
                ...
                next: function () {
                    ...
                    for (var C = this._currentRules(), D = 0; D < C.length; D++) if (w = this._input.match(this.rules[C[D]]), w && (!S || w[0].length > S[0].length)) {
                        if (S = w, x = D, this.options.backtrack_lexer) {
                            if (T = this.test_match(w, C[D]), T !== !1) return T;
                            if (this._backtrack) {
                                S = !1;
                                continue
                            } else return !1
...
const o0 = () => {
    ...
    if (l) l.children.push(u), Ft.push(u); else if (Ft.length === 0) Ft.push(u); else throw new Error('There can be only one root. No parent could be found for ("' + u.descr + '")')
}, rt = {DEFAULT: 0, NO_BORDER: 0, ROUNDED_RECT: 1, RECT: 2, CIRCLE: 3, CLOUD: 4, BANG: 5, HEXAGON: 6}, c0 = (t, e) => {
    ...
    const a = r.width, n = r.height, i = .15 * a, s = .25 * a, o = .35 * a, u = .2 * a;
    ...
    const a = r.width, n = r.height, i = .15 * a;
...
const S0 = function (t, e, r) {
    const a = r.height, i = a / 4, s = r.width - r.padding + 2 * i,
        o = [{x: i, y: 0}, {x: s - i, y: 0}, {x: s, y: -a / 2}, {x: s - i, y: -a}, {x: i, y: -a}, {x: 0, y: -a / 2}];
    D0(e, s, a, o, r)
}, A0 = function (t, e, r) {
...
`);
    ...
    if (r.height = v.height + h * 1.1 * .5 + r.padding, r.width = v.width + 2 * r.padding, r.icon) if (r.type === t.nodeType.CIRCLE) r.height += 50, r.width += 50, o.append("foreignObject").attr("height", "50px").attr("width", r.width).attr("style", "text-align: center;").append("div").attr("class", "icon-container").append("i").attr("class", "node-icon-" + s + " " + r.icon), f.attr("transform", "translate(" + r.width / 2 + ", " + (r.height / 2 - 1.5 * r.padding) + ")"); else {
        r.width += 50;
        const d = r.height;
...
function sv(t, e, r, a) {
    e.add({
        ...
        sv(n, e, r, a + 1), e.add({
            group: "edges",
            data: {id: `${t.id}_${n.id}`, source: t.id, target: n.id, depth: a, section: n.section}
        })
    })
}
...
function P0(t, e) {
    return new Promise(r => {
        const a = Tv("body").append("div").attr("id", "cy").attr("style", "display:none"), n = pr({
        ...
        }), n.layout({name: "cose-bilkent", quality: "proof", styleEnabled: !1, animate: !1}).run(), n.ready(i => {
            Nr.info("Ready", i), r(n)
        })
    })
}
...
` + t);
    ...
    I0(f, v), M0(s, v), xv(void 0, l, ((n = u.mindmap) == null ? void 0 : n.padding) ?? En.mindmap.padding, ((i = u.mindmap) == null ? void 0 : i.useMaxWidth) ?? En.mindmap.useMaxWidth)
}, k0 = {draw: O0}, N0 = t => {
    let e = "";
...
`, F0 = B0, q0 = {db: m0, renderer: k0, parser: s0, styles: F0};
