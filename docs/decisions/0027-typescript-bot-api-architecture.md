--- id: ADR-0027 type: decision status: verified links: [] title: TypeScript Bot API for Web Platform Support accepted-by: Flemming N. Larsen (2026-03-24, pre-Cliewen MADR acceptance) ---
