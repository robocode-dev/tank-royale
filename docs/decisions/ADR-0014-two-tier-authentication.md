...
- [ADR-0016: Session ID for Bot Process Identification](./ADR-0016-session-id-bot-process-identification.md)
- [ADR-0007: Client Role Separation](./ADR-0007-client-role-separation.md)
