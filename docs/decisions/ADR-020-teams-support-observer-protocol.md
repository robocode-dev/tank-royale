...
# ADR-020: Teams Support in Observer Protocol
...
### 3. Use ID sign convention (from ADR-015)

Observers can also use: `id > 0` = real team, `id < 0` = solo bot.

See [ADR-015](./ADR-015-bot-id-team-id-namespace-separation.md) for details.
...
- [ADR-015: Participant ID as Unified Team Identifier](./ADR-015-bot-id-team-id-namespace-separation.md)
