...
# ADR-042: Behavior Version as the Battle Compatibility Contract
...
- [ADR-008 — Server-Authoritative Deterministic Physics](ADR-008-server-authoritative-physics.md)
