...
3. **Bot APIs** — Language bindings for writing competitive bots:
   - **Current:** Java, Python, .NET, TypeScript (Node.js and browser — see [ADR-0027](./ADR-0027-typescript-bot-api-architecture.md))
...
- **TypeScript** (stable, Node.js and browser — see [ADR-0027](./ADR-0027-typescript-bot-api-architecture.md))
...
- [Cross-Platform Bot API Strategy (ADR-0003)](./ADR-0003-cross-platform-bot-api-strategy.md)
