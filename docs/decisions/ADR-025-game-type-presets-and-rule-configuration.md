...
# ADR-025: Game Type Presets and Rule Configuration
...
> **Note:** `DEFAULT_READY_TIMEOUT` was raised from 1 second to 10 seconds. See [ADR-040](./ADR-040-ready-timeout-default.md).
...
- [ADR-008: Server-Authoritative Physics](./ADR-008-server-authoritative-physics.md) — Server owns physics rules
- [ADR-024: Battle Runner API](./ADR-024-battle-runner-api.md) — Consumes presets via programmatic API
