...
- [ADR-0003: Cross-Platform Bot API Strategy](./ADR-0003-cross-platform-bot-api-strategy.md) — requires 1:1 semantic equivalence
- [ADR-0004: Java as Reference Implementation](./ADR-0004-java-reference-implementation.md) — Java is authoritative
- [ADR-0010: Declarative Bot Intent Model](./ADR-0010-declarative-bot-intent-model.md) — intent-based architecture
...
- [ADR-0003: Cross-Platform Bot API Strategy](./ADR-0003-cross-platform-bot-api-strategy.md)
- [ADR-0004: Java as Reference Implementation](./ADR-0004-java-reference-implementation.md)
- [ADR-0010: Declarative Bot Intent Model](./ADR-0010-declarative-bot-intent-model.md)
