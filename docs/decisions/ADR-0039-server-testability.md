...
**References:**
- [ADR-0008: Server-Authoritative Physics](./ADR-0008-server-authoritative-physics.md)
- [ADR-0037: Functional Core Extraction (Bot API)](./ADR-0037-functional-core-bot-api-testability.md)
- [ADR-0012: Turn Timing Semantics](./ADR-0012-turn-timing-semantics.md)
...
- [ADR-0012: Turn Timing Semantics](./ADR-0012-turn-timing-semantics.md)
- [ADR-0037: Functional Core Extraction (Bot API)](./ADR-0037-functional-core-bot-api-testability.md)
- [ADR-0038: Cross-Platform Test Parity](./ADR-0038-shared-cross-platform-test-definitions.md)
