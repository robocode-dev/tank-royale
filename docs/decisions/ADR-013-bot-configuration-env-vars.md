...
# ADR-013: Bot Configuration via Environment Variables
...
- [ADR-005: Independent Deployable Components](./ADR-005-independent-deployable-components.md) (Booter subprocess pattern)
