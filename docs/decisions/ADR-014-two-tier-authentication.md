...
# ADR-014: Two-Tier Shared-Secret Authentication
...
- [ADR-016: Session ID for Bot Process Identification](./ADR-016-session-id-bot-process-identification.md)
- [ADR-007: Client Role Separation](./ADR-007-client-role-separation.md)
