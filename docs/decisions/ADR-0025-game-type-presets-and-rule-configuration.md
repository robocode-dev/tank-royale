...
> **Note:** `DEFAULT_READY_TIMEOUT` was raised from 1 second to 10 seconds. See [ADR-0040](./ADR-0040-ready-timeout-default.md).
...
- [ADR-0008: Server-Authoritative Physics](./ADR-0008-server-authoritative-physics.md) — Server owns physics rules
- [ADR-0024: Battle Runner API](./ADR-0024-battle-runner-api.md) — Consumes presets via programmatic API
