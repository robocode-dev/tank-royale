...
| **Confusable-name check designed**: [UTS #39](https://www.unicode.org/reports/tr39/) skeleton + leetspeak folding + normalization; identical skeleton fails validation, edit distance 1 flags for moderators. | Submission doc |
