...
> - read `.principles-catalog/active.md`; keep if it contains the generated-by marker (`<!-- generated by /dot-scout`)
...
1. Read `.principles-catalog/active.md`; check for the `<!-- generated by /dot-scout` marker
