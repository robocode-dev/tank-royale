...
namespace Robocode.TankRoyale.Schema
{
    ...
    public class HitByBulletEvent : Event 
    {
        ...
        /// <summary>Remaining energy level of the bot after the damage was inflicted</summary>
