...
namespace Robocode.TankRoyale.Schema
{
    ...
    public class GameSetup 
    {
        ...
        /// <summary>Flag specifying if the width of arena is fixed for this game type</summary>
        ...
        /// <summary>Flag specifying if the height of arena is fixed for this game type</summary>
        ...
        /// <summary>Minimum number of bots participating in battle</summary>
        ...
        /// <summary>Flag specifying if the minimum number of bots participating in battle is fixed for this game type</summary>
        ...
        /// <summary>Number of rounds in battle</summary>
        [Newtonsoft.Json.JsonProperty("numberOfRounds", Required = Newtonsoft.Json.Required.Always)]
        public int NumberOfRounds { get; set; }
    
        /// <summary>Flag specifying if the number-of-rounds is fixed for this game type</summary>
        ...
        /// <summary>Gun cooling rate. The gun needs to cool down to a gun heat of zero before the gun is able to fire</summary>
        [Newtonsoft.Json.JsonProperty("gunCoolingRate", Required = Newtonsoft.Json.Required.Always)]
        public double GunCoolingRate { get; set; }
    
        /// <summary>Flag specifying if the gun cooling rate is fixed for this game type</summary>
        ...
        /// <summary>Flag specifying if the turn timeout is fixed for this game type</summary>
        ...
        /// <summary>Time limit in microseconds (1 / 1,000,000 second) for sending ready message after having received 'game started' message</summary>
        [Newtonsoft.Json.JsonProperty("readyTimeout", Required = Newtonsoft.Json.Required.Always)]
        public int ReadyTimeout { get; set; }
    
        /// <summary>Flag specifying if the ready timeout is fixed for this game type</summary>
        ...
        /// <summary>Default number of turns to show per second for an observer/UI</summary>
