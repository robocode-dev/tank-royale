...
| [commands.md](./commands.md) | 9 command types | Controller operations (StartGame, StopGame, PauseGame, ResumeGame, NextTurn, ChangeTps, SetBotPositions, DisableParticipant, EnableParticipant) |
