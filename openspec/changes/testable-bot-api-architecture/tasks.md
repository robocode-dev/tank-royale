...
- [x] **1.1** Create `IntentValidator.java` in Java with extracted pure functions
- [x] **1.2** Update `BaseBotInternals.java` to delegate to `IntentValidator`
- [x] **1.3** Create `IntentValidator.cs` in C# with extracted pure functions
- [x] **1.4** Update `BaseBotInternals.cs` to delegate to `IntentValidator`
- [x] **1.5** Create `intent_validator.py` in Python with extracted pure functions
- [x] **1.6** Update `base_bot_internals.py` to delegate to `intent_validator`
- [x] **1.7** Create `intentValidator.ts` in TypeScript with extracted pure functions
- [x] **1.8** Update `baseBotInternals.ts` to delegate to `intentValidator`
- [x] **1.9** Verify all existing tests pass (Java, C#, Python, TypeScript)
