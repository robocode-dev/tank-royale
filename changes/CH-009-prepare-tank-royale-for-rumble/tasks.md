...
- [x] Create and validate the proposal workspace; commit it before implementation
- [x] Add the inferred behavior-version decision record and new acceptance criteria (`PRO-005`, `BFD-006`, `BR-047`, and `BR-048`) before changing behavior
