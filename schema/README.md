...
provided in the [architecture flow docs](../docs/architecture/models/flows/README.md). They show how each schema-backed message participates in the lifecycle of a battle.
