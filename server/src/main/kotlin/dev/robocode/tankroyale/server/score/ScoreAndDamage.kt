...
class ScoreAndDamage {
    ...
    private val bulletDamage = mutableMapOf<BotOrTeamId, Double>()
    private val ramDamage = mutableMapOf<BotOrTeamId, Double>()
    private val bulletKillEnemyIds = mutableSetOf<BotOrTeamId>()
    private val ramKillEnemyIds = mutableSetOf<BotOrTeamId>()
    ...
    fun getBulletKillEnemyIds(): Set<BotOrTeamId> = bulletKillEnemyIds
     ...
     */
    fun getBulletDamage(enemyId: BotOrTeamId): Double = bulletDamage[enemyId] ?: 0.0
     ...
     */
    fun getRamDamage(enemyId: BotOrTeamId): Double = ramDamage[enemyId] ?: 0.0
     ...
     */
    fun addBulletDamage(enemyId: BotOrTeamId, damage: Double) {
     ...
     * @param enemyId is the identifier of the enemy bot
     */
    fun addRamDamage(enemyId: BotOrTeamId) {
     ...
     */
    fun addBulletKillEnemyId(enemyId: BotOrTeamId) {
     ...
     * @param enemyId is the identifier of the enemy bot that was killed by this bot
     */
    fun addRamKillEnemyId(enemyId: BotOrTeamId) {
