...
public interface IBasicBot {
   ...
   * been fired recently.
   *
   * <p>The gun will only fire when the firepower is at MIN_FIREPOWER or higher. If the firepower
   * is more than MAX_FIREPOWER, the power will be truncated to the max firepower.
   *
