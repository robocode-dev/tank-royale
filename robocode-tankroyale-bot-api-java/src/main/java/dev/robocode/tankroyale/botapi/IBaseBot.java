...
public interface IBaseBot {
  ...
  /**
   * Sets the gun to fire in the direction as the gun is pointing. Note that energy is taken from
   * the bot which is spend on firing the bullet. The amount of energy loss is equal to the
   * firepower. However, if the bullet hits, you will gain energy from the bullet hit.
   *
   ...
   * @return true if the gun could fire; false otherwise
