val version = "0.19.3" // <-- The current version of Robocode Tank Royale
...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("serialization-json", "org.jetbrains.kotlinx:kotlinx-serialization-json:1.5.0")
            ...
            // Kotlin testing
            library("kotest-junit5", "io.kotest:kotest-runner-junit5-jvm:5.5.5")
            ...
            plugin("benmanes-versioning", "com.github.ben-manes.versions").version("0.46.0")
        }
    }
}