...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            alias("jansi").to("org.fusesource.jansi:jansi:2.3.4")
            ...
            alias("kotest-junit5").to("io.kotest:kotest-runner-junit5-jvm:5.0.0.M1")
            ...
            alias("itiviti-dotnet").toPluginId("com.itiviti.dotnet").version("1.8.2")
            alias("node-gradle").toPluginId("com.github.node-gradle.node").version("3.1.0")
        }
    }
}