...
## In progress - 0.14.0 - Adjustments for bot events
...
- Schema:
    - Replaced `$type` with `type` to make it possible to use more code
      generators [#31](https://github.com/robocode-dev/tank-royale/issues/31)
