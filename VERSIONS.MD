## 📦 0.29.0 - All about colors

This version causes a breaking change for the Color class.
...
- Bot API:
    - Breaking change: Replaced using Robocode's Color class with java.awt.Color for Java and System.Drawing.Color for
      C#.
