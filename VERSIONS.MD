...
- GUI:
    - The logo in the server log in now shown with ANSI colors per default. 

#### ⚠️ Disabled functionality

- Bot Console:
    - The Events tab has been disabled as dumping and rendering the event log consumes too much CPU power.
