...
- Server:
    - [#60]: Round ended event was not send, in the round when the game was ended.
- GUI:
    - Joined Bots list was not updated (removing bots), when game is aborted.
    ...
    - Sometimes flag where "empty" when clicking on a joined bot.
- Bot API for .Net:
