...
/// <summary>
/// Represents an ARGB (alpha, red, green, blue) color for use in the Tank Royale game.
...
public readonly struct Color : IEquatable<Color>
{
    ...
    // Convert to int (ARGB)
    /// <summary>
    /// Converts this Color structure to a 32-bit ARGB value.
    /// </summary>
    /// <returns>A 32-bit integer containing the ARGB representation of this color.</returns>
    public int ToArgb() => (int)_value;

    // Common colors
    public static Color Transparent => FromArgb(0, 255, 255, 255);
    ...
    public static Color BlanchedAlmond => FromArgb(255, 235, 205);
    ...
    public static Color DarkSeaGreen => FromArgb(143, 188, 139);
    ...
    public static Color Ivory => FromArgb(255, 255, 240);
    ...
    public static Color MediumVioletRed => FromArgb(199, 21, 133);
    ...
    public static Color OliveDrab => FromArgb(107, 142, 35);
    ...
    public static Color PeachPuff => FromArgb(255, 218, 185);
    ...
    public static Color Tomato => FromArgb(255, 99, 71);
    ...
    /// <returns>A 32-bit integer containing the ARGB values of the Color structure.</returns>
    public static implicit operator int(Color color) => color.ToArgb();
