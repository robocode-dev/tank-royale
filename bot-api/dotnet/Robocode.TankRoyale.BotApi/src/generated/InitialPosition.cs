...
namespace Robocode.TankRoyale.Schema
{
    ...
    ///   and starting angle/heading.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.1.2.0 (Newtonsoft.Json v9.0.0.0)")]
    public class InitialPosition 
    {
        /// <summary>The x coordinate. When it is not set, a random value will be used.</summary>
        ...
        /// <summary>The y coordinate. When it is not set, a random value will be used.</summary>
        ...
        /// <summary>The angle. When it is not set, a random value will be used.</summary>
