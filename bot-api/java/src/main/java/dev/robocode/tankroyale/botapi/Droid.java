 ...
 * A droid has 20 additional energy points (120 in total from the start), but has no scanner!<br>
 * <br>
 * Because the droid has no scanner, it is 100% dependent on other team members to perform the scanning on its behalf
 * and communicate crucial information to the bot, e.g., the coordinates of target enemies.<br>
 * <br>
