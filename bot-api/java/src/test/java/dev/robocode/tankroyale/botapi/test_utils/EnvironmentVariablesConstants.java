...
public class EnvironmentVariablesConstants {
    ...
    public static final String BOT_AUTHORS = "BOT_AUTHORS";
    public static final String BOT_GAME_TYPES = "BOT_GAME_TYPES";
    public static final String BOT_DESCRIPTION = "BOT_DESCRIPTION";
    public static final String BOT_HOMEPAGE = "BOT_HOMEPAGE";
    public static final String BOT_COUNTRY_CODES = "BOT_COUNTRY_CODES";
    public static final String BOT_PLATFORM = "BOT_PLATFORM";
    public static final String BOT_PROG_LANG = "BOT_PROG_LANG";
    public static final String BOT_INITIAL_POS = "BOT_INITIAL_POS";
}
